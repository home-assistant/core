...
[[back to top](#pylint-plugin-for-home-assistant)]
...
To disable this check on a specific line, add
`# pylint: disable=hass-logger-period` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-logger-capital` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-relative-import` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-async-callback-decorator` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-use-runtime-data` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-unique-id-ip-based` at the end of it.
...
To disable this check on a specific line, add
`# pylint: disable=hass-config-flow-polling-field` at the end of it.
