...
DHCP: list[dict[str, str | bool]] = [
    ...
    {'domain': 'broadlinkcustom', 'registered_devices': True},
    {'domain': 'broadlinkcustom', 'macaddress': '34EA34*'},
    {'domain': 'broadlinkcustom', 'macaddress': '24DFA7*'},
    {'domain': 'broadlinkcustom', 'macaddress': 'A043B0*'},
    {'domain': 'broadlinkcustom', 'macaddress': 'B4430D*'},
