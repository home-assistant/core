...
from homeassistant.components.media_player import (
    MEDIA_TYPE_MUSIC, MEDIA_TYPE_URL, SUPPORT_NEXT_TRACK, SUPPORT_PAUSE,
    PLATFORM_SCHEMA, SUPPORT_PREVIOUS_TRACK, SUPPORT_STOP, SUPPORT_PLAY,
...
class MpdDevice(MediaPlayerDevice):
    ...
    def play_media(self, media_type, media_id, **kwargs):
        ...
        # this is a hack for a problem with https playing on termux
        media_id = media_id.replace(
            'https://localhost:8123/api/tts_proxy',
            '///data/data/com.termux/files/home/AIS/tts')
