...
if TYPE_CHECKING:
    ...
    from .helpers.script_variables import ScriptRunVariables
...
class ServiceCall:
    ...
    def __init__(
        ...
        self.script_run_variables = script_run_variables
...
class ServiceRegistry:
    ...
    def template_exclude_keys(
        self, domain: str, service: str
    ) -> template.ExcludeKeys | None:
