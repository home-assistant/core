...
class SpeedConverter(BaseUnitConverter):
    ...
    _UNIT_CONVERSION: dict[str, float] = {
        PRECIPITATION_INCHES_PER_DAY: _DAYS_TO_SECS / _IN_TO_M,
        PRECIPITATION_INCHES_PER_HOUR: _HRS_TO_SECS / _IN_TO_M,
        PRECIPITATION_MILLIMETERS_PER_DAY: _DAYS_TO_SECS / _MM_TO_M,
        PRECIPITATION_MILLIMETERS_PER_HOUR: _HRS_TO_SECS / _MM_TO_M,
