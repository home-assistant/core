...
# import requests
# req = requests.get("https://www.six-group.com/dam/download/financial-information/data-center/iso-currrency/lists/list-one.xml")
# soup = BeautifulSoup(req.content, "xml")
# _ACTIVE_CURRENCIES = sorted(
#     set(
#         [
#             x.Ccy.contents[0]
...
#     )
# )
# Last updated with list-one.xml published 2022-09-23
_ACTIVE_CURRENCIES = {
    "AED",
    "AFN",
    "ALL",
...
# from bs4 import BeautifulSoup
# import requests
# req = requests.get("https://www.six-group.com/dam/download/financial-information/data-center/iso-currrency/lists/list-three.xml")
# soup = BeautifulSoup(req.content, "xml")
# _HISTORIC_CURRENCIES = sorted(
#     set(
#         [
#             x.Ccy.contents[0]
...
#             and x.Ccy
#             and "IsFund" not in x.CcyNm.attrs
#             and x.Ccy.contents[0] not in _ACTIVE_CURRENCIES
#         ]
#     )
# )
# Last updated with list-one.xml published 2022-09-23
...
currency = vol.In(_ACTIVE_CURRENCIES, msg="invalid ISO 4217 formatted currency")

historic_currency = vol.In(
    _HISTORIC_CURRENCIES, msg="invalid ISO 4217 formatted historic currency"
)
