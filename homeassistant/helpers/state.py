...
from homeassistant.components.climate import (
    ATTR_AUX_HEAT, ATTR_AWAY_MODE, ATTR_HOME_MODE, ATTR_FAN_MODE, ATTR_HUMIDITY,
    ATTR_OPERATION_MODE, ATTR_SWING_MODE,
    SERVICE_SET_AUX_HEAT, SERVICE_SET_AWAY_MODE, SERVICE_SET_HOME_MODE, SERVICE_SET_FAN_MODE,
