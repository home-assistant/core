...
from homeassistant.const import (
    ...
    SERVICE_OPEN_COVER_TILT, SERVICE_CLOSE_COVER_TILT, STATE_ALARM_ARMED_AWAY,
    STATE_ALARM_ARMED_HOME, STATE_ALARM_DISARMED, STATE_ALARM_TRIGGERED,
    STATE_CLOSED, STATE_LOCKED, STATE_OFF, STATE_ON, STATE_OPEN, STATE_PAUSED,
    STATE_PLAYING, STATE_UNKNOWN, STATE_UNLOCKED)
...
SERVICE_TO_STATE = {
    ...
    SERVICE_OPEN_COVER_TILT: STATE_OPEN,
    SERVICE_CLOSE_COVER_TILT: STATE_CLOSED
}
