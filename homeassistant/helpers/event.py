...
class _TrackTimeInterval:
    ...
    def _interval_listener(self, now: datetime) -> None:
        ...
        hass.async_run_hass_job(self._run_job, now, eager_start=True)
...
class SunListener:
    ...
    def _handle_sun_event(self, _now: Any) -> None:
        ...
        self._unsub_sun = None
        self._listen_next_sun_event()
        self.hass.async_run_hass_job(self.job, eager_start=True)
...
class _TrackUTCTimeChange:
    ...
    def _pattern_time_change_listener(self, _: datetime) -> None:
        ...
        localized_now = dt_util.as_local(utc_now) if self.local else utc_now
        hass.async_run_hass_job(self.job, localized_now, eager_start=True)
        if TYPE_CHECKING:
