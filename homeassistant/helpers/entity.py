...
class FrozenOrThawed(type):
    """Metaclass which which makes classes behave like a dataclass.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        def __delattr__(self: EntityDescription, name: str) -> None:
            """Delete an attribute.
            ...
            return self._dataclass.__delattr__(self, name)  # type: ignore[unreachable]

        def __setattr__(self: EntityDescription, name: str, value: Any) -> None:
            """Set an attribute.
            ...
            return self._dataclass.__setattr__(self, name, value)  # type: ignore[unreachable]
