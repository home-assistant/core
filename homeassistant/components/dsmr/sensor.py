...
SENSORS: tuple[DSMRSensorEntityDescription, ...] = (
    ...
    DSMRSensorEntityDescription(
        ...
        dsmr_versions={"2.2", "4", "5", "5B", "5L", "5EONHU", "MSn"},
    ...
    DSMRSensorEntityDescription(
        ...
        dsmr_versions={"5L", "5S", "Q3D", "5EONHU", "MSn"},
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ),
    DSMRSensorEntityDescription(
...
async def async_setup_entry(
    ...
    if protocol == RFXTRX_DSMR_PROTOCOL:
        ...
        # tag is not checked; integrity comes from the telegram CRC). An empty
        # encryption key leaves plain telegrams untouched.
        reader_factory = partial(
            create_dsmr_reader,
            port,
            dsmr_version,
