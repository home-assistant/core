"""API for canvas bound to Home Assistant OAuth."""
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    """Provide canvas authentication tied to an OAuth2 based config entry."""
    ...
    def __init__(
        ...
        """Initialize canvas Auth."""
        self.hass = hass
        self.session = oauth_session
        super().__init__(self.session.token)

    def refresh_tokens(self) -> str:
        """Refresh and return new canvas tokens using Home Assistant OAuth2 session."""
