...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/react-code-view-eb5ce0ba2c27.js"></script>
  ...
  <title>core/homeassistant/components/mazda/climate.py at 2023.10.1 · home-assistant/core</title>
  ...
  <meta name="request-id" content="CD9A:2227:14C0DE:1DD0FF:65282A0F" data-turbo-transient="true" /><meta name="html-safe-nonce" content="06e32267733aec8799f3f928dfa1a3d0448a015a0680e54460a8862cc559fc12" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="647cbcfe3206da192e1e1c2d41c2f265c969ff267971cc611a68b770d1dcd4e7" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="106836726" /><meta name="octolytics-actor-login" content="eufysecurity" /><meta name="octolytics-actor-hash" content="28bf03a64dfc1bc176455321ac0b6f9745f58fe67490bd294a4e79641cec5e07" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content=":house_with_garden: Open source home automation that puts local control and privacy first. - core/homeassistant/components/mazda/climate.py at 2023.10.1 · home-assistant/core">
      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/home-assistant/core/blob/2023.10.1/homeassistant/components/mazda/climate.py" />
      <meta name="twitter:image:src" content="https://repository-images.githubusercontent.com/12888993/0f9eb780-655b-11e9-85cb-0d3956096fe5" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="core/homeassistant/components/mazda/climate.py at 2023.10.1 · home-assistant/core" /><meta name="twitter:description" content=":house_with_garden: Open source home automation that puts local control and privacy first. - home-assistant/core" />
      <meta property="og:image" content="https://repository-images.githubusercontent.com/12888993/0f9eb780-655b-11e9-85cb-0d3956096fe5" /><meta property="og:image:alt" content=":house_with_garden: Open source home automation that puts local control and privacy first. - home-assistant/core" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="core/homeassistant/components/mazda/climate.py at 2023.10.1 · home-assistant/core" /><meta property="og:url" content="https://github.com/home-assistant/core/blob/2023.10.1/homeassistant/components/mazda/climate.py" /><meta property="og:description" content=":house_with_garden: Open source home automation that puts local control and privacy first. - home-assistant/core" />
      

      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/106836726/ws?session=eyJ2IjoiVjMiLCJ1IjoxMDY4MzY3MjYsInMiOjEyMjE3MDU5NzUsImMiOjU3Mjg5MTg5OCwidCI6MTY5NzEzMTAyOH0=--0f9052b577f7bf7f391d5f497f195e66e0a80d962a856650a4e532c85490bbae" data-refresh-url="/_alive" data-session-id="56073fd770b4a139a47820b7d307e41314d47ba86f52e9538796a795f6a86dc4">
...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/command-palette-46bb1d1be80b.js"></script>
  ...
  <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1" id="dialog-show-dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>  

<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-left" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1-title" aria-describedby="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-8ca74c0a-1950-4ede-b6d3-bc8d855d8dd1" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-980e8a37-d71f-47bd-8401-32e57879c6e2" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-361ace67-c307-4603-8ed4-7c8dc99c1562" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-ca0b9ea4-00ee-4aa6-b7af-e7dfcaba578b" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-4ee5c345-a404-45d9-a6e4-bcf5fa5371dc" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-aea7793d-883f-41db-8385-0f9adb95cd74" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-33b859fe-191e-4b50-9206-e64a390c18c3" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-557e7016-48c8-4adb-8e95-3d34a4094fa1" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;FEEDBACK&quot;,&quot;label&quot;:null}" id="item-b99495a5-c615-4fc7-8d71-29d61202ed9d" href="https://gh.io/navigation-update" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-comment-discussion">
    <path d="M1.75 1h8.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0 1 10.25 10H7.061l-2.574 2.573A1.458 1.458 0 0 1 2 11.543V10h-.25A1.75 1.75 0 0 1 0 8.25v-5.5C0 1.784.784 1 1.75 1ZM1.5 2.75v5.5c0 .138.112.25.25.25h1a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h3.5a.25.25 0 0 0 .25-.25v-5.5a.25.25 0 0 0-.25-.25h-8.5a.25.25 0 0 0-.25.25Zm13 2a.25.25 0 0 0-.25-.25h-.5a.75.75 0 0 1 0-1.5h.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0 1 14.25 12H14v1.543a1.458 1.458 0 0 1-2.487 1.03L9.22 12.28a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215l2.22 2.22v-2.19a.75.75 0 0 1 .75-.75h1a.25.25 0 0 0 .25-.25Z"></path>
</svg>
...
<qbsearch-input class="search-input" data-scope="repo:home-assistant/core" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="-NiDT42Nqe8fj_zeg3x4OIApW3NYmCizqenBu8Oj24p0r3RG_S8PTlc7zdEsWrshNqlQB0EO2GblrdrQaaNm0w" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="home-assistant/core" data-current-org="home-assistant" data-current-owner="" data-logged-in="true">
  <div
...
<div class="AppHeader-search-whenRegular">
  <div class="AppHeader-search-wrap AppHeader-search-wrap--hasTrailing">
    ...
    <path d="m6.354 8.04-4.773 4.773a.75.75 0 1 0 1.061 1.06L7.945 8.57a.75.75 0 0 0 0-1.06L2.642 2.206a.75.75 0 0 0-1.06 1.061L6.353 8.04ZM8.75 11.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5h-5.5Z"></path>
      ...
      <tool-tip id="tooltip-a2c0114e-c849-463e-a122-2af2d4a49a39" for="AppHeader-commandPalette-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Command palette</tool-tip>
  </div>
</div>
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-f37c0516-00a5-41ea-8aeb-73284faaf67b" data-target="query-builder.input" data-action="
...
<template id="pencil-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-pencil">
    <path d="M11.013 1.427a1.75 1.75 0 0 1 2.474 0l1.086 1.086a1.75 1.75 0 0 1 0 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 0 1-.927-.928l.929-3.25c.081-.286.235-.547.445-.758l8.61-8.61Zm.176 4.823L9.75 4.81l-6.286 6.287a.253.253 0 0 0-.064.108l-.558 1.953 1.953-.558a.253.253 0 0 0 .108-.064Zm1.238-3.763a.25.25 0 0 0-.354 0L10.811 3.75l1.439 1.44 1.263-1.263a.25.25 0 0 0 0-.354Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-f37c0516-00a5-41ea-8aeb-73284faaf67b" hidden="hidden">
...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="QmqipKlQ6wAwK_oChOV16o74C8uWkEJT6fSb1U9Oi4SOR2yU0VvTqVyQMoP9zynXgwEeRxsOjBuJWLvw9qNz5A" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <div data-view-component="true" class="Overlay-body">        <div data-target="custom-scopes.customScopesModalDialogFlash"></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="CcNTcqsND617G-g1egGRvc6cdXcE4LXc6LqL8C-PPWaaGieLBaQrGX_igR0kt7xZ01OdjZFOmnTrsX-y4KJm2Q" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="Q1gGkvqzmqPDb48UAHxJv_zkEvL1n7KDD4Yz07qi1uxy85TuBKREnXLGGs5Gc1ypDvThnBBDVOCaiALinx5Y5Q" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="cBhYFwiEwxGSPHjziVlaNQW2jaeQO8E9GrUU1tUsIdFsNxigBBoI3AnwmgL_XT1ZkWLIiiFYw6rzItfXl_SpCg" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button>  <tool-tip id="tooltip-046f9a8c-d69a-497b-ad23-24dc8afd065c" for="global-create-menu-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
</div>
...
<anchored-position id="global-create-menu-overlay" anchor="global-create-menu-button" align="end" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  ...
  <ul aria-labelledby="global-create-menu-button" id="global-create-menu-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
    ...
    <a href="/new" tabindex="-1" id="item-bd7e2d44-93ee-4d3d-ada7-f4347a44bc36" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
    ...
    <a href="/new/import" tabindex="-1" id="item-4a0ef992-d1eb-40e8-8caf-2c777ab15608" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a href="/codespaces/new" tabindex="-1" id="item-7c6d3b90-1b18-45de-8211-36e1b59627db" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-codespaces">
    <path d="M0 11.25c0-.966.784-1.75 1.75-1.75h12.5c.966 0 1.75.784 1.75 1.75v3A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm2-9.5C2 .784 2.784 0 3.75 0h8.5C13.216 0 14 .784 14 1.75v5a1.75 1.75 0 0 1-1.75 1.75h-8.5A1.75 1.75 0 0 1 2 6.75Zm1.75-.25a.25.25 0 0 0-.25.25v5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-5a.25.25 0 0 0-.25-.25Zm-2 9.5a.25.25 0 0 0-.25.25v3c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-3a.25.25 0 0 0-.25-.25Z"></path><path d="M7 12.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75Zm-4 0a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75Z"></path>
</svg>
    ...
    <a href="https://gist.github.com/" tabindex="-1" id="item-be4c0ed0-74ea-4759-ac86-08c08c0b082f" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a href="/account/organizations/new" tabindex="-1" id="item-73f7e689-6cdd-4dbf-940d-dac8c7b86b71" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
  ...
  <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-5a0d6358-0ddb-432e-8cce-9994c3b80e70" aria-labelledby="tooltip-90ce2860-8bf7-4a1d-9fec-a8bdf6424125" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a>  <tool-tip id="tooltip-90ce2860-8bf7-4a1d-9fec-a8bdf6424125" for="icon-button-5a0d6358-0ddb-432e-8cce-9994c3b80e70" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>
</div>
          <div data-view-component="true" class="Button-withTooltip">
  <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-ffaa30e2-8f6f-4cfe-a264-777f512bd9a5" aria-labelledby="tooltip-c2eecaea-a0cc-4135-bf2f-9f15ed8e1dda" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a>  <tool-tip id="tooltip-c2eecaea-a0cc-4135-bf2f-9f15ed8e1dda" for="icon-button-ffaa30e2-8f6f-4cfe-a264-777f512bd9a5" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>
</div>
...
<notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTA2ODM2NzI2IiwidCI6MTY5NzEzMTAyOH0=--2e4158cac42a62fdc5fc874d4dc5fc7ca29c1d008f69c366f83ac873e405a31f" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
  ...
  >
    ...
    <tool-tip data-target="notification-indicator.tooltip" id="tooltip-fcc30bc5-c01a-4347-9761-30a365f850f9" for="AppHeader-notifications-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Notifications</tool-tip>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      ...
      <button aria-label="Open user account menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf" id="dialog-show-dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf" type="button" data-view-component="true" class="AppHeader-logo Button--invisible Button--medium Button Button--invisible-noVisuals color-bg-transparent p-0">    <span class="Button-content">
...
<div class="Overlay--hidden Overlay-backdrop--side Overlay-backdrop--placement-right" data-modal-dialog-overlay>
  <modal-dialog data-target="deferred-side-panel.panel" role="dialog" id="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf" aria-modal="true" aria-disabled="true" aria-labelledby="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf-title" aria-describedby="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf-title">
        Account menu
      </h1>
            <div data-view-component="true" class="d-flex">
      <div data-view-component="true" class="AppHeader-logo position-relative">
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-e8498c38-697d-4db7-964c-9f8e32bcd4bf" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg></button>
    </div>
  </div>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-5adbd540-4d3f-4c89-9e0c-f70e95b4d2d3" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROFILE&quot;,&quot;label&quot;:null}" id="item-434d4435-9af9-4da3-8ff0-2fdd2737deea" href="https://github.com/eufysecurity" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-667f7d2f-8436-4c42-af11-ee6f47ad6b30" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_REPOSITORIES&quot;,&quot;label&quot;:null}" id="item-a0cb4c5b-fa75-4136-a183-1c9736277c93" href="/eufysecurity?tab=repositories" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo">
    <path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8ZM5 12.25a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v3.25a.25.25 0 0 1-.4.2l-1.45-1.087a.249.249 0 0 0-.3 0L5.4 15.7a.25.25 0 0 1-.4-.2Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_PROJECTS&quot;,&quot;label&quot;:null}" id="item-2b0483a9-d103-4be3-a330-cf7c8bd36a80" href="/eufysecurity?tab=projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-project">
    <path d="M1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0ZM1.5 1.75v12.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25H1.75a.25.25 0 0 0-.25.25ZM11.75 3a.75.75 0 0 1 .75.75v7.5a.75.75 0 0 1-1.5 0v-7.5a.75.75 0 0 1 .75-.75Zm-8.25.75a.75.75 0 0 1 1.5 0v5.5a.75.75 0 0 1-1.5 0ZM8 3a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 3Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-1748c267-9ac5-4217-8260-5db28ff49b2d" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_STARS&quot;,&quot;label&quot;:null}" id="item-207fa478-1fcc-4570-8ee2-51b45fbe68fe" href="/eufysecurity?tab=stars" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SPONSORS&quot;,&quot;label&quot;:null}" id="item-c13748c4-d378-4aa2-a9de-cec197d9863b" href="/sponsors/accounts" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;YOUR_GISTS&quot;,&quot;label&quot;:null}" id="item-760287bd-af6b-4d9b-b5f3-5f4ad794cb10" href="https://gist.github.com/mine" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-105f854a-8765-4651-9595-726ec07ff209" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-88778893-7e59-4fd6-9e40-d683ae932408" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <button id="item-40135799-1479-4a42-bbd3-ed796a1a080a" type="button" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <span data-view-component="true" class="d-flex flex-items-center">    <svg style="box-sizing: content-box; color: var(--color-icon-primary);" width="16" height="16" viewBox="0 0 16 16" fill="none" data-view-component="true" class="anim-rotate">
  <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-opacity="0.25" stroke-width="2" vector-effect="non-scaling-stroke" fill="none" />
  <path d="M15 8a7.002 7.002 0 00-7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SETTINGS&quot;,&quot;label&quot;:null}" id="item-059b08b7-c16d-41e3-9782-188feb137beb" href="/settings/profile" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DOCS&quot;,&quot;label&quot;:null}" id="item-2f50ae52-2a2d-4af8-a75e-cc0be00caac8" href="https://docs.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;SUPPORT&quot;,&quot;label&quot;:null}" id="item-ee511f51-aed9-4374-a598-7dc5b6e51fc2" href="https://support.github.com" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-people">
    <path d="M2 5.5a3.5 3.5 0 1 1 5.898 2.549 5.508 5.508 0 0 1 3.034 4.084.75.75 0 1 1-1.482.235 4 4 0 0 0-7.9 0 .75.75 0 0 1-1.482-.236A5.507 5.507 0 0 1 3.102 8.05 3.493 3.493 0 0 1 2 5.5ZM11 4a3.001 3.001 0 0 1 2.22 5.018 5.01 5.01 0 0 1 2.56 3.012.749.749 0 0 1-.885.954.752.752 0 0 1-.549-.514 3.507 3.507 0 0 0-2.522-2.372.75.75 0 0 1-.574-.73v-.352a.75.75 0 0 1 .416-.672A1.5 1.5 0 0 0 11 5.5.75.75 0 0 1 11 4Zm-5.5-.5a2 2 0 1 0-.001 3.999A2 2 0 0 0 5.5 3.5Z"></path>
</svg>
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;LOGOUT&quot;,&quot;label&quot;:null}" id="item-691a3455-249d-4df8-aea4-6d4e11f94be0" href="/logout" data-view-component="true" class="ActionListContent">
...
<site-header-logged-in-user-menu>
  ...
  <button id="icon-button-d11ad37a-337f-40f9-82a1-26d5a269eacf" aria-labelledby="tooltip-1a6a75e2-5102-4656-8eb9-7cd662aa14e3" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium js-flash-close">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button>  <tool-tip id="tooltip-1a6a75e2-5102-4656-8eb9-7cd662aa14e3" for="icon-button-d11ad37a-337f-40f9-82a1-26d5a269eacf" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
</div>
...
<div class="flash flash-full   {{ className }}">
  <div class="px-2" >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTA2ODM2NzI2IiwidCI6MTY5NzEzMTAyOH0=--2e4158cac42a62fdc5fc874d4dc5fc7ca29c1d008f69c366f83ac873e405a31f" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
>
  ...
  <details-dialog class="command-palette-details-dialog d-flex flex-column flex-justify-center height-fit" aria-label="Command palette">
    <command-palette
      ...
      return-to=/home-assistant/core/blob/2023.10.1/homeassistant/components/mazda/climate.py
      user-id="106836726"
...
</button>    <tool-tip id="tooltip-f82ae1e8-9d8b-46b6-b863-6a43e004a94d" for="command-palette-clear-button" popover="manual" data-direction="w" data-type="label" data-view-component="true" class="sr-only position-absolute">Clear Command Palette</tool-tip>
</div>
...
<react-app
  ...
  initial-path="/home-assistant/core/blob/2023.10.1/homeassistant/components/mazda/climate.py"
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC6" class="react-file-line html-div" data-testid="code-cell" data-line-number="6" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">pymazda</span> <span class="pl-k">import</span> <span class="pl-v">Client</span> <span class="pl-k">as</span> <span class="pl-v">MazdaAPIClient</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC7" class="react-file-line html-div" data-testid="code-cell" data-line-number="7" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC8" class="react-file-line html-div" data-testid="code-cell" data-line-number="8" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">components</span>.<span class="pl-s1">climate</span> <span class="pl-k">import</span> (</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC9" class="react-file-line html-div" data-testid="code-cell" data-line-number="9" style="position:relative">    <span class="pl-v">ClimateEntity</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative">    <span class="pl-v">ClimateEntityFeature</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative">    <span class="pl-v">HVACMode</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative">)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">config_entries</span> <span class="pl-k">import</span> <span class="pl-v">ConfigEntry</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">const</span> <span class="pl-k">import</span> (</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative">    <span class="pl-v">ATTR_TEMPERATURE</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">    <span class="pl-v">PRECISION_HALVES</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">    <span class="pl-v">PRECISION_WHOLE</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative">    <span class="pl-v">UnitOfTemperature</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative">)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">core</span> <span class="pl-k">import</span> <span class="pl-v">HomeAssistant</span>, <span class="pl-s1">callback</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">helpers</span>.<span class="pl-s1">entity_platform</span> <span class="pl-k">import</span> <span class="pl-v">AddEntitiesCallback</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">helpers</span>.<span class="pl-s1">update_coordinator</span> <span class="pl-k">import</span> <span class="pl-v">DataUpdateCoordinator</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative"><span class="pl-k">from</span> <span class="pl-s1">homeassistant</span>.<span class="pl-s1">util</span>.<span class="pl-s1">unit_conversion</span> <span class="pl-k">import</span> <span class="pl-v">TemperatureConverter</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative"><span class="pl-k">from</span> . <span class="pl-k">import</span> <span class="pl-v">MazdaEntity</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative"><span class="pl-k">from</span> .<span class="pl-s1">const</span> <span class="pl-k">import</span> <span class="pl-v">DATA_CLIENT</span>, <span class="pl-v">DATA_COORDINATOR</span>, <span class="pl-v">DATA_REGION</span>, <span class="pl-v">DOMAIN</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative"><span class="pl-v">PRESET_DEFROSTER_OFF</span> <span class="pl-c1">=</span> <span class="pl-s">&quot;Defroster Off&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative"><span class="pl-v">PRESET_DEFROSTER_FRONT</span> <span class="pl-c1">=</span> <span class="pl-s">&quot;Front Defroster&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative"><span class="pl-v">PRESET_DEFROSTER_REAR</span> <span class="pl-c1">=</span> <span class="pl-s">&quot;Rear Defroster&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative"><span class="pl-v">PRESET_DEFROSTER_FRONT_AND_REAR</span> <span class="pl-c1">=</span> <span class="pl-s">&quot;Front and Rear Defroster&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">_front_defroster_enabled</span>(<span class="pl-s1">preset_mode</span>: <span class="pl-s1">str</span> <span class="pl-c1">|</span> <span class="pl-c1">None</span>) <span class="pl-c1">-&gt;</span> <span class="pl-s1">bool</span>:</div></div></div><div class="child-of-line-34  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-k">return</span> <span class="pl-s1">preset_mode</span> <span class="pl-c1">in</span> [</div></div></div><div class="child-of-line-34  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_FRONT_AND_REAR</span>,</div></div></div><div class="child-of-line-34  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_FRONT</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative">    ]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">_rear_defroster_enabled</span>(<span class="pl-s1">preset_mode</span>: <span class="pl-s1">str</span> <span class="pl-c1">|</span> <span class="pl-c1">None</span>) <span class="pl-c1">-&gt;</span> <span class="pl-s1">bool</span>:</div></div></div><div class="child-of-line-41  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative">    <span class="pl-k">return</span> <span class="pl-s1">preset_mode</span> <span class="pl-c1">in</span> [</div></div></div><div class="child-of-line-41  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_FRONT_AND_REAR</span>,</div></div></div><div class="child-of-line-41  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_REAR</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">    ]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative"><span class="pl-k">async</span> <span class="pl-k">def</span> <span class="pl-en">async_setup_entry</span>(</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">    <span class="pl-s1">hass</span>: <span class="pl-v">HomeAssistant</span>,</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">    <span class="pl-s1">config_entry</span>: <span class="pl-v">ConfigEntry</span>,</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">    <span class="pl-s1">async_add_entities</span>: <span class="pl-v">AddEntitiesCallback</span>,</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Set up the climate platform.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">    <span class="pl-s1">entry_data</span> <span class="pl-c1">=</span> <span class="pl-s1">hass</span>.<span class="pl-s1">data</span>[<span class="pl-v">DOMAIN</span>][<span class="pl-s1">config_entry</span>.<span class="pl-s1">entry_id</span>]</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">    <span class="pl-s1">client</span> <span class="pl-c1">=</span> <span class="pl-s1">entry_data</span>[<span class="pl-v">DATA_CLIENT</span>]</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">    <span class="pl-s1">coordinator</span> <span class="pl-c1">=</span> <span class="pl-s1">entry_data</span>[<span class="pl-v">DATA_COORDINATOR</span>]</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative">    <span class="pl-s1">region</span> <span class="pl-c1">=</span> <span class="pl-s1">entry_data</span>[<span class="pl-v">DATA_REGION</span>]</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative">
</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative">    <span class="pl-en">async_add_entities</span>(</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative">        <span class="pl-v">MazdaClimateEntity</span>(<span class="pl-s1">client</span>, <span class="pl-s1">coordinator</span>, <span class="pl-s1">index</span>, <span class="pl-s1">region</span>)</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative">        <span class="pl-k">for</span> <span class="pl-s1">index</span>, <span class="pl-s1">data</span> <span class="pl-c1">in</span> <span class="pl-en">enumerate</span>(<span class="pl-s1">coordinator</span>.<span class="pl-s1">data</span>)</div></div></div><div class="child-of-line-48  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">data</span>[<span class="pl-s">&quot;isElectric&quot;</span>]</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">    )</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative"><span class="pl-k">class</span> <span class="pl-v">MazdaClimateEntity</span>(<span class="pl-v">MazdaEntity</span>, <span class="pl-v">ClimateEntity</span>):</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Class for a Mazda climate entity.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative">    <span class="pl-s1">_attr_translation_key</span> <span class="pl-c1">=</span> <span class="pl-s">&quot;climate&quot;</span></div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative">    <span class="pl-s1">_attr_supported_features</span> <span class="pl-c1">=</span> (</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative">        <span class="pl-v">ClimateEntityFeature</span>.<span class="pl-v">TARGET_TEMPERATURE</span> <span class="pl-c1">|</span> <span class="pl-v">ClimateEntityFeature</span>.<span class="pl-v">PRESET_MODE</span></div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative">    )</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative">    <span class="pl-s1">_attr_hvac_modes</span> <span class="pl-c1">=</span> [<span class="pl-v">HVACMode</span>.<span class="pl-v">HEAT_COOL</span>, <span class="pl-v">HVACMode</span>.<span class="pl-v">OFF</span>]</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC74" class="react-file-line html-div" data-testid="code-cell" data-line-number="74" style="position:relative">    <span class="pl-s1">_attr_preset_modes</span> <span class="pl-c1">=</span> [</div></div></div><div class="child-of-line-66 child-of-line-74  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC75" class="react-file-line html-div" data-testid="code-cell" data-line-number="75" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_OFF</span>,</div></div></div><div class="child-of-line-66 child-of-line-74  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC76" class="react-file-line html-div" data-testid="code-cell" data-line-number="76" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_FRONT</span>,</div></div></div><div class="child-of-line-66 child-of-line-74  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC77" class="react-file-line html-div" data-testid="code-cell" data-line-number="77" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_REAR</span>,</div></div></div><div class="child-of-line-66 child-of-line-74  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC78" class="react-file-line html-div" data-testid="code-cell" data-line-number="78" style="position:relative">        <span class="pl-v">PRESET_DEFROSTER_FRONT_AND_REAR</span>,</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC79" class="react-file-line html-div" data-testid="code-cell" data-line-number="79" style="position:relative">    ]</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC80" class="react-file-line html-div" data-testid="code-cell" data-line-number="80" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC81" class="react-file-line html-div" data-testid="code-cell" data-line-number="81" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">__init__</span>(</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC82" class="react-file-line html-div" data-testid="code-cell" data-line-number="82" style="position:relative">        <span class="pl-s1">self</span>,</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC83" class="react-file-line html-div" data-testid="code-cell" data-line-number="83" style="position:relative">        <span class="pl-s1">client</span>: <span class="pl-v">MazdaAPIClient</span>,</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC84" class="react-file-line html-div" data-testid="code-cell" data-line-number="84" style="position:relative">        <span class="pl-s1">coordinator</span>: <span class="pl-v">DataUpdateCoordinator</span>,</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC85" class="react-file-line html-div" data-testid="code-cell" data-line-number="85" style="position:relative">        <span class="pl-s1">index</span>: <span class="pl-s1">int</span>,</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC86" class="react-file-line html-div" data-testid="code-cell" data-line-number="86" style="position:relative">        <span class="pl-s1">region</span>: <span class="pl-s1">str</span>,</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC87" class="react-file-line html-div" data-testid="code-cell" data-line-number="87" style="position:relative">    ) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC88" class="react-file-line html-div" data-testid="code-cell" data-line-number="88" style="position:relative">        <span class="pl-s">&quot;&quot;&quot;Initialize Mazda climate entity.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC89" class="react-file-line html-div" data-testid="code-cell" data-line-number="89" style="position:relative">        <span class="pl-en">super</span>().<span class="pl-en">__init__</span>(<span class="pl-s1">client</span>, <span class="pl-s1">coordinator</span>, <span class="pl-s1">index</span>)</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC90" class="react-file-line html-div" data-testid="code-cell" data-line-number="90" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC91" class="react-file-line html-div" data-testid="code-cell" data-line-number="91" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">region</span> <span class="pl-c1">=</span> <span class="pl-s1">region</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC92" class="react-file-line html-div" data-testid="code-cell" data-line-number="92" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_attr_unique_id</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">vin</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC93" class="react-file-line html-div" data-testid="code-cell" data-line-number="93" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC94" class="react-file-line html-div" data-testid="code-cell" data-line-number="94" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">self</span>.<span class="pl-s1">data</span>[<span class="pl-s">&quot;hvacSetting&quot;</span>][<span class="pl-s">&quot;temperatureUnit&quot;</span>] <span class="pl-c1">==</span> <span class="pl-s">&quot;F&quot;</span>:</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC95" class="react-file-line html-div" data-testid="code-cell" data-line-number="95" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_precision</span> <span class="pl-c1">=</span> <span class="pl-v">PRECISION_WHOLE</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC96" class="react-file-line html-div" data-testid="code-cell" data-line-number="96" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_temperature_unit</span> <span class="pl-c1">=</span> <span class="pl-v">UnitOfTemperature</span>.<span class="pl-v">FAHRENHEIT</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC97" class="react-file-line html-div" data-testid="code-cell" data-line-number="97" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_min_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">61.0</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC98" class="react-file-line html-div" data-testid="code-cell" data-line-number="98" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_max_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">83.0</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC99" class="react-file-line html-div" data-testid="code-cell" data-line-number="99" style="position:relative">        <span class="pl-k">else</span>:</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC100" class="react-file-line html-div" data-testid="code-cell" data-line-number="100" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_precision</span> <span class="pl-c1">=</span> <span class="pl-v">PRECISION_HALVES</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC101" class="react-file-line html-div" data-testid="code-cell" data-line-number="101" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_temperature_unit</span> <span class="pl-c1">=</span> <span class="pl-v">UnitOfTemperature</span>.<span class="pl-v">CELSIUS</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC102" class="react-file-line html-div" data-testid="code-cell" data-line-number="102" style="position:relative">            <span class="pl-k">if</span> <span class="pl-s1">region</span> <span class="pl-c1">==</span> <span class="pl-s">&quot;MJO&quot;</span>:</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC103" class="react-file-line html-div" data-testid="code-cell" data-line-number="103" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">_attr_min_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">18.5</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC104" class="react-file-line html-div" data-testid="code-cell" data-line-number="104" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">_attr_max_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">31.5</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC105" class="react-file-line html-div" data-testid="code-cell" data-line-number="105" style="position:relative">            <span class="pl-k">else</span>:</div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC106" class="react-file-line html-div" data-testid="code-cell" data-line-number="106" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">_attr_min_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">15.5</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC107" class="react-file-line html-div" data-testid="code-cell" data-line-number="107" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">_attr_max_temp</span> <span class="pl-c1">=</span> <span class="pl-c1">28.5</span></div></div></div><div class="child-of-line-66 child-of-line-81  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC108" class="react-file-line html-div" data-testid="code-cell" data-line-number="108" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC109" class="react-file-line html-div" data-testid="code-cell" data-line-number="109" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-en">_update_state_attributes</span>()</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC110" class="react-file-line html-div" data-testid="code-cell" data-line-number="110" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC111" class="react-file-line html-div" data-testid="code-cell" data-line-number="111" style="position:relative">    <span class="pl-en">@<span class="pl-s1">callback</span></span></div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC112" class="react-file-line html-div" data-testid="code-cell" data-line-number="112" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">_handle_coordinator_update</span>(<span class="pl-s1">self</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-112  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC113" class="react-file-line html-div" data-testid="code-cell" data-line-number="113" style="position:relative">        <span class="pl-s">&quot;&quot;&quot;Update attributes when the coordinator data updates.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-112  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC114" class="react-file-line html-div" data-testid="code-cell" data-line-number="114" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-en">_update_state_attributes</span>()</div></div></div><div class="child-of-line-66 child-of-line-112  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC115" class="react-file-line html-div" data-testid="code-cell" data-line-number="115" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC116" class="react-file-line html-div" data-testid="code-cell" data-line-number="116" style="position:relative">        <span class="pl-en">super</span>().<span class="pl-en">_handle_coordinator_update</span>()</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC117" class="react-file-line html-div" data-testid="code-cell" data-line-number="117" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC118" class="react-file-line html-div" data-testid="code-cell" data-line-number="118" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">_update_state_attributes</span>(<span class="pl-s1">self</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC119" class="react-file-line html-div" data-testid="code-cell" data-line-number="119" style="position:relative">        <span class="pl-c"># Update the HVAC mode</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC120" class="react-file-line html-div" data-testid="code-cell" data-line-number="120" style="position:relative">        <span class="pl-s1">hvac_on</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">get_assumed_hvac_mode</span>(<span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>)</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC121" class="react-file-line html-div" data-testid="code-cell" data-line-number="121" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_attr_hvac_mode</span> <span class="pl-c1">=</span> <span class="pl-v">HVACMode</span>.<span class="pl-v">HEAT_COOL</span> <span class="pl-k">if</span> <span class="pl-s1">hvac_on</span> <span class="pl-k">else</span> <span class="pl-v">HVACMode</span>.<span class="pl-v">OFF</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC122" class="react-file-line html-div" data-testid="code-cell" data-line-number="122" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC123" class="react-file-line html-div" data-testid="code-cell" data-line-number="123" style="position:relative">        <span class="pl-c"># Update the target temperature</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC124" class="react-file-line html-div" data-testid="code-cell" data-line-number="124" style="position:relative">        <span class="pl-s1">hvac_setting</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">get_assumed_hvac_setting</span>(<span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>)</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC125" class="react-file-line html-div" data-testid="code-cell" data-line-number="125" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_attr_target_temperature</span> <span class="pl-c1">=</span> <span class="pl-s1">hvac_setting</span>.<span class="pl-en">get</span>(<span class="pl-s">&quot;temperature&quot;</span>)</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC126" class="react-file-line html-div" data-testid="code-cell" data-line-number="126" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC127" class="react-file-line html-div" data-testid="code-cell" data-line-number="127" style="position:relative">        <span class="pl-c"># Update the current temperature</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC128" class="react-file-line html-div" data-testid="code-cell" data-line-number="128" style="position:relative">        <span class="pl-s1">current_temperature_celsius</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">data</span>[<span class="pl-s">&quot;evStatus&quot;</span>][<span class="pl-s">&quot;hvacInfo&quot;</span>][</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC129" class="react-file-line html-div" data-testid="code-cell" data-line-number="129" style="position:relative">            <span class="pl-s">&quot;interiorTemperatureCelsius&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC130" class="react-file-line html-div" data-testid="code-cell" data-line-number="130" style="position:relative">        ]</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC131" class="react-file-line html-div" data-testid="code-cell" data-line-number="131" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">self</span>.<span class="pl-s1">data</span>[<span class="pl-s">&quot;hvacSetting&quot;</span>][<span class="pl-s">&quot;temperatureUnit&quot;</span>] <span class="pl-c1">==</span> <span class="pl-s">&quot;F&quot;</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC132" class="react-file-line html-div" data-testid="code-cell" data-line-number="132" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_current_temperature</span> <span class="pl-c1">=</span> <span class="pl-v">TemperatureConverter</span>.<span class="pl-en">convert</span>(</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC133" class="react-file-line html-div" data-testid="code-cell" data-line-number="133" style="position:relative">                <span class="pl-s1">current_temperature_celsius</span>,</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC134" class="react-file-line html-div" data-testid="code-cell" data-line-number="134" style="position:relative">                <span class="pl-v">UnitOfTemperature</span>.<span class="pl-v">CELSIUS</span>,</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC135" class="react-file-line html-div" data-testid="code-cell" data-line-number="135" style="position:relative">                <span class="pl-v">UnitOfTemperature</span>.<span class="pl-v">FAHRENHEIT</span>,</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC136" class="react-file-line html-div" data-testid="code-cell" data-line-number="136" style="position:relative">            )</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC137" class="react-file-line html-div" data-testid="code-cell" data-line-number="137" style="position:relative">        <span class="pl-k">else</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC138" class="react-file-line html-div" data-testid="code-cell" data-line-number="138" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_current_temperature</span> <span class="pl-c1">=</span> <span class="pl-s1">current_temperature_celsius</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC139" class="react-file-line html-div" data-testid="code-cell" data-line-number="139" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC140" class="react-file-line html-div" data-testid="code-cell" data-line-number="140" style="position:relative">        <span class="pl-c"># Update the preset mode based on the state of the front and rear defrosters</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC141" class="react-file-line html-div" data-testid="code-cell" data-line-number="141" style="position:relative">        <span class="pl-s1">front_defroster</span> <span class="pl-c1">=</span> <span class="pl-s1">hvac_setting</span>.<span class="pl-en">get</span>(<span class="pl-s">&quot;frontDefroster&quot;</span>)</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC142" class="react-file-line html-div" data-testid="code-cell" data-line-number="142" style="position:relative">        <span class="pl-s1">rear_defroster</span> <span class="pl-c1">=</span> <span class="pl-s1">hvac_setting</span>.<span class="pl-en">get</span>(<span class="pl-s">&quot;rearDefroster&quot;</span>)</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC143" class="react-file-line html-div" data-testid="code-cell" data-line-number="143" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">front_defroster</span> <span class="pl-c1">and</span> <span class="pl-s1">rear_defroster</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC144" class="react-file-line html-div" data-testid="code-cell" data-line-number="144" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span> <span class="pl-c1">=</span> <span class="pl-v">PRESET_DEFROSTER_FRONT_AND_REAR</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC145" class="react-file-line html-div" data-testid="code-cell" data-line-number="145" style="position:relative">        <span class="pl-k">elif</span> <span class="pl-s1">front_defroster</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC146" class="react-file-line html-div" data-testid="code-cell" data-line-number="146" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span> <span class="pl-c1">=</span> <span class="pl-v">PRESET_DEFROSTER_FRONT</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC147" class="react-file-line html-div" data-testid="code-cell" data-line-number="147" style="position:relative">        <span class="pl-k">elif</span> <span class="pl-s1">rear_defroster</span>:</div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC148" class="react-file-line html-div" data-testid="code-cell" data-line-number="148" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span> <span class="pl-c1">=</span> <span class="pl-v">PRESET_DEFROSTER_REAR</span></div></div></div><div class="child-of-line-66 child-of-line-118  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC149" class="react-file-line html-div" data-testid="code-cell" data-line-number="149" style="position:relative">        <span class="pl-k">else</span>:</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC150" class="react-file-line html-div" data-testid="code-cell" data-line-number="150" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span> <span class="pl-c1">=</span> <span class="pl-v">PRESET_DEFROSTER_OFF</span></div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC151" class="react-file-line html-div" data-testid="code-cell" data-line-number="151" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC152" class="react-file-line html-div" data-testid="code-cell" data-line-number="152" style="position:relative">    <span class="pl-k">async</span> <span class="pl-k">def</span> <span class="pl-en">async_set_hvac_mode</span>(<span class="pl-s1">self</span>, <span class="pl-s1">hvac_mode</span>: <span class="pl-v">HVACMode</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC153" class="react-file-line html-div" data-testid="code-cell" data-line-number="153" style="position:relative">        <span class="pl-s">&quot;&quot;&quot;Set a new HVAC mode.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC154" class="react-file-line html-div" data-testid="code-cell" data-line-number="154" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">hvac_mode</span> <span class="pl-c1">==</span> <span class="pl-v">HVACMode</span>.<span class="pl-v">HEAT_COOL</span>:</div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC155" class="react-file-line html-div" data-testid="code-cell" data-line-number="155" style="position:relative">            <span class="pl-k">await</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">turn_on_hvac</span>(<span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>)</div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC156" class="react-file-line html-div" data-testid="code-cell" data-line-number="156" style="position:relative">        <span class="pl-k">elif</span> <span class="pl-s1">hvac_mode</span> <span class="pl-c1">==</span> <span class="pl-v">HVACMode</span>.<span class="pl-v">OFF</span>:</div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC157" class="react-file-line html-div" data-testid="code-cell" data-line-number="157" style="position:relative">            <span class="pl-k">await</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">turn_off_hvac</span>(<span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>)</div></div></div><div class="child-of-line-66 child-of-line-152  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC158" class="react-file-line html-div" data-testid="code-cell" data-line-number="158" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC159" class="react-file-line html-div" data-testid="code-cell" data-line-number="159" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-en">_handle_coordinator_update</span>()</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC160" class="react-file-line html-div" data-testid="code-cell" data-line-number="160" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC161" class="react-file-line html-div" data-testid="code-cell" data-line-number="161" style="position:relative">    <span class="pl-k">async</span> <span class="pl-k">def</span> <span class="pl-en">async_set_temperature</span>(<span class="pl-s1">self</span>, <span class="pl-c1">**</span><span class="pl-s1">kwargs</span>: <span class="pl-v">Any</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC162" class="react-file-line html-div" data-testid="code-cell" data-line-number="162" style="position:relative">        <span class="pl-s">&quot;&quot;&quot;Set a new target temperature.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC163" class="react-file-line html-div" data-testid="code-cell" data-line-number="163" style="position:relative">        <span class="pl-k">if</span> (<span class="pl-s1">temperature</span> <span class="pl-c1">:=</span> <span class="pl-s1">kwargs</span>.<span class="pl-en">get</span>(<span class="pl-v">ATTR_TEMPERATURE</span>)) <span class="pl-c1">is</span> <span class="pl-c1">not</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC164" class="react-file-line html-div" data-testid="code-cell" data-line-number="164" style="position:relative">            <span class="pl-s1">precision</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">precision</span></div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC165" class="react-file-line html-div" data-testid="code-cell" data-line-number="165" style="position:relative">            <span class="pl-s1">rounded_temperature</span> <span class="pl-c1">=</span> <span class="pl-en">round</span>(<span class="pl-s1">temperature</span> <span class="pl-c1">/</span> <span class="pl-s1">precision</span>) <span class="pl-c1">*</span> <span class="pl-s1">precision</span></div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC166" class="react-file-line html-div" data-testid="code-cell" data-line-number="166" style="position:relative">
</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC167" class="react-file-line html-div" data-testid="code-cell" data-line-number="167" style="position:relative">            <span class="pl-k">await</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">set_hvac_setting</span>(</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC168" class="react-file-line html-div" data-testid="code-cell" data-line-number="168" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>,</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC169" class="react-file-line html-div" data-testid="code-cell" data-line-number="169" style="position:relative">                <span class="pl-s1">rounded_temperature</span>,</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC170" class="react-file-line html-div" data-testid="code-cell" data-line-number="170" style="position:relative">                <span class="pl-s1">self</span>.<span class="pl-s1">data</span>[<span class="pl-s">&quot;hvacSetting&quot;</span>][<span class="pl-s">&quot;temperatureUnit&quot;</span>],</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC171" class="react-file-line html-div" data-testid="code-cell" data-line-number="171" style="position:relative">                <span class="pl-en">_front_defroster_enabled</span>(<span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span>),</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC172" class="react-file-line html-div" data-testid="code-cell" data-line-number="172" style="position:relative">                <span class="pl-en">_rear_defroster_enabled</span>(<span class="pl-s1">self</span>.<span class="pl-s1">_attr_preset_mode</span>),</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC173" class="react-file-line html-div" data-testid="code-cell" data-line-number="173" style="position:relative">            )</div></div></div><div class="child-of-line-66 child-of-line-161  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC174" class="react-file-line html-div" data-testid="code-cell" data-line-number="174" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC175" class="react-file-line html-div" data-testid="code-cell" data-line-number="175" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-en">_handle_coordinator_update</span>()</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC176" class="react-file-line html-div" data-testid="code-cell" data-line-number="176" style="position:relative">
</div></div></div><div class="child-of-line-66  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC177" class="react-file-line html-div" data-testid="code-cell" data-line-number="177" style="position:relative">    <span class="pl-k">async</span> <span class="pl-k">def</span> <span class="pl-en">async_set_preset_mode</span>(<span class="pl-s1">self</span>, <span class="pl-s1">preset_mode</span>: <span class="pl-s1">str</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC178" class="react-file-line html-div" data-testid="code-cell" data-line-number="178" style="position:relative">        <span class="pl-s">&quot;&quot;&quot;Turn on/off the front/rear defrosters according to the chosen preset mode.&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC179" class="react-file-line html-div" data-testid="code-cell" data-line-number="179" style="position:relative">        <span class="pl-k">await</span> <span class="pl-s1">self</span>.<span class="pl-s1">client</span>.<span class="pl-en">set_hvac_setting</span>(</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC180" class="react-file-line html-div" data-testid="code-cell" data-line-number="180" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">vehicle_id</span>,</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC181" class="react-file-line html-div" data-testid="code-cell" data-line-number="181" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">_attr_target_temperature</span>,</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC182" class="react-file-line html-div" data-testid="code-cell" data-line-number="182" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">data</span>[<span class="pl-s">&quot;hvacSetting&quot;</span>][<span class="pl-s">&quot;temperatureUnit&quot;</span>],</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC183" class="react-file-line html-div" data-testid="code-cell" data-line-number="183" style="position:relative">            <span class="pl-en">_front_defroster_enabled</span>(<span class="pl-s1">preset_mode</span>),</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC184" class="react-file-line html-div" data-testid="code-cell" data-line-number="184" style="position:relative">            <span class="pl-en">_rear_defroster_enabled</span>(<span class="pl-s1">preset_mode</span>),</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC185" class="react-file-line html-div" data-testid="code-cell" data-line-number="185" style="position:relative">        )</div></div></div><div class="child-of-line-66 child-of-line-177  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC186" class="react-file-line html-div" data-testid="code-cell" data-line-number="186" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC187" class="react-file-line html-div" data-testid="code-cell" data-line-number="187" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-en">_handle_coordinator_update</span>()</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></main></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA__">{"resolvedServerColorMode":"night"}</script></div>
</react-app>
</turbo-frame>
