...
SENSORS: Final[tuple[HomeWizardSensorEntityDescription, ...]] = (
    HomeWizardSensorEntityDescription(
        ...
        has_fn=lambda x: x.protocol_version is not None,
        value_fn=lambda x: x.protocol_version,
    ),
    HomeWizardSensorEntityDescription(
        key="meter_model",
        translation_key="meter_model",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.meter_model is not None,
        value_fn=lambda x: x.meter_model,
    ),
    HomeWizardSensorEntityDescription(
        key="unique_meter_id",
        translation_key="unique_meter_id",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.unique_id is not None,
        value_fn=lambda x: x.unique_id,
    ),
    HomeWizardSensorEntityDescription(
        key="wifi_ssid",
        translation_key="wifi_ssid",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.wifi_ssid is not None,
        value_fn=lambda x: x.wifi_ssid,
    ),
    HomeWizardSensorEntityDescription(
        key="active_tariff",
        translation_key="active_tariff",
        has_fn=lambda x: x.tariff is not None,
        value_fn=lambda x: (None if x.tariff is None else str(x.tariff)),
    ...
    HomeWizardSensorEntityDescription(
        ...
        has_fn=lambda x: x.wifi_strength is not None,
        value_fn=lambda x: x.wifi_strength,
    ),
    HomeWizardSensorEntityDescription(
        ...
        has_fn=lambda x: x.energy_import_kwh is not None,
        value_fn=lambda x: x.energy_import_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        has_fn=lambda x: (
            ...
            x.energy_import_t1_kwh is not None and x.energy_export_t2_kwh is not None
        ),
        value_fn=lambda x: x.energy_import_t1_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_import_t2_kwh is not None,
        value_fn=lambda x: x.energy_import_t2_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_import_t3_kwh is not None,
        value_fn=lambda x: x.energy_import_t3_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_import_t4_kwh is not None,
        value_fn=lambda x: x.energy_import_t4_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_export_kwh is not None,
        enabled_fn=lambda x: x.energy_export_kwh != 0,
        value_fn=lambda x: x.energy_export_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        has_fn=lambda x: (
            # SKT/SDM230/630 provides both total and tariff 1: duplicate.
            x.energy_export_t1_kwh is not None and x.energy_export_t2_kwh is not None
        ),
        enabled_fn=lambda x: x.energy_export_t1_kwh != 0,
        value_fn=lambda x: x.energy_export_t1_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_export_t2_kwh is not None,
        enabled_fn=lambda x: x.energy_export_t2_kwh != 0,
        value_fn=lambda x: x.energy_export_t2_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_export_t3_kwh is not None,
        enabled_fn=lambda x: x.energy_export_t3_kwh != 0,
        value_fn=lambda x: x.energy_export_t3_kwh,
    ),
    HomeWizardSensorEntityDescription(
        ...
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.energy_export_t4_kwh is not None,
        enabled_fn=lambda x: x.energy_export_t4_kwh != 0,
        value_fn=lambda x: x.energy_export_t4_kwh,
    ),
    HomeWizardSensorEntityDescription(
        key="active_power_w",
        ...
        has_fn=lambda x: x.power_w is not None,
        value_fn=lambda x: x.power_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        has_fn=lambda x: x.power_l1_w is not None,
        value_fn=lambda x: x.power_l1_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        has_fn=lambda x: x.power_l2_w is not None,
        value_fn=lambda x: x.power_l2_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        has_fn=lambda x: x.power_l3_w is not None,
        value_fn=lambda x: x.power_l3_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.voltage_v is not None,
        value_fn=lambda x: x.voltage_v,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.voltage_l1_v is not None,
        value_fn=lambda x: x.voltage_l1_v,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.voltage_l2_v is not None,
        value_fn=lambda x: x.voltage_l2_v,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.voltage_l3_v is not None,
        value_fn=lambda x: x.voltage_l3_v,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.current_a is not None,
        value_fn=lambda x: x.current_a,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.current_l1_a is not None,
        value_fn=lambda x: x.current_l1_a,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.current_l2_a is not None,
        value_fn=lambda x: x.current_l2_a,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.current_l3_a is not None,
        value_fn=lambda x: x.current_l3_a,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.frequency_hz is not None,
        value_fn=lambda x: x.frequency_hz,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.apparent_power_va is not None,
        value_fn=lambda x: x.apparent_power_va,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.apparent_power_l1_va is not None,
        value_fn=lambda x: x.apparent_power_l1_va,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.apparent_power_l2_va is not None,
        value_fn=lambda x: x.apparent_power_l2_va,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.apparent_power_l3_va is not None,
        value_fn=lambda x: x.apparent_power_l3_va,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.reactive_power_var is not None,
        value_fn=lambda x: x.reactive_power_var,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.reactive_power_l1_var is not None,
        value_fn=lambda x: x.reactive_power_l1_var,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.reactive_power_l2_var is not None,
        value_fn=lambda x: x.reactive_power_l2_var,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.reactive_power_l3_var is not None,
        value_fn=lambda x: x.reactive_power_l3_var,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.power_factor is not None,
        value_fn=lambda x: to_percentage(x.power_factor),
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.power_factor_l1 is not None,
        value_fn=lambda x: to_percentage(x.power_factor_l1),
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.power_factor_l2 is not None,
        value_fn=lambda x: to_percentage(x.power_factor_l2),
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
        has_fn=lambda x: x.power_factor_l3 is not None,
        value_fn=lambda x: to_percentage(x.power_factor_l3),
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "1"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_sag_l1_count is not None,
        value_fn=lambda x: x.voltage_sag_l1_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "2"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_sag_l2_count is not None,
        value_fn=lambda x: x.voltage_sag_l2_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "3"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_sag_l3_count is not None,
        value_fn=lambda x: x.voltage_sag_l3_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "1"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_swell_l1_count is not None,
        value_fn=lambda x: x.voltage_swell_l1_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "2"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_swell_l2_count is not None,
        value_fn=lambda x: x.voltage_swell_l2_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        translation_placeholders={"phase": "3"},
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.voltage_swell_l3_count is not None,
        value_fn=lambda x: x.voltage_swell_l3_count,
    ),
    HomeWizardSensorEntityDescription(
        key="any_power_fail_count",
        translation_key="any_power_fail_count",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.any_power_fail_count is not None,
        value_fn=lambda x: x.any_power_fail_count,
    ),
    HomeWizardSensorEntityDescription(
        key="long_power_fail_count",
        translation_key="long_power_fail_count",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda x: x.long_power_fail_count is not None,
        value_fn=lambda x: x.long_power_fail_count,
    ),
    HomeWizardSensorEntityDescription(
        ...
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        has_fn=lambda x: x.average_power_15m_w is not None,
        value_fn=lambda x: x.average_power_15m_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        has_fn=lambda x: x.monthly_power_peak_w is not None,
        value_fn=lambda x: x.monthly_power_peak_w,
    ),
    HomeWizardSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        has_fn=lambda x: x.active_liter_lpm is not None,
        value_fn=lambda x: x.active_liter_lpm,
    ),
    HomeWizardSensorEntityDescription(
        key="total_liter_m3",
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda x: x.total_liter_m3 is not None,
        value_fn=lambda x: x.total_liter_m3,
    ),
)
