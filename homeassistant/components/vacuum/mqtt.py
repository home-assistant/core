...
def async_setup_platform(hass, config, async_add_devices, discovery_info=None):
    ...
    async_add_devices([
        MqttVacuum(name, supported_features, qos, retain, command_topic,
                   ...
                   cleaning_topic, cleaning_template, docked_topic,
                   docked_template, fan_speed_topic, fan_speed_template,
                   set_fan_speed_topic, fan_speed_list, send_command_topic),
    ])
...
class MqttVacuum(VacuumDevice):
    ...
    def async_added_to_hass(self):
        ...
        topics_list = [
            topic
            for topic in (self._battery_level_topic, self._charging_topic,
                          self._cleaning_topic, self._docked_topic,
    ...
    def async_set_fan_speed(self, fan_speed, **kwargs):
        ...
        mqtt.async_publish(self.hass, self._set_fan_speed_topic, fan_speed,
                           self._qos, self._retain)
    ...
    def async_send_command(self, command, params=None, **kwargs):
        ...
        mqtt.async_publish(self.hass, self._send_command_topic, command,
                           self._qos, self._retain)
