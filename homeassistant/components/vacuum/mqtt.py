...
class MqttVacuum(MqttAvailability, MqttDiscoveryUpdate, MqttEntityDeviceInfo, VacuumDevice):
    ...
    async def _subscribe_topics(self):
        ...
        def message_received(topic, payload, qos):
            ...
            if topic == self._topics[CONF_BATTERY_LEVEL_TOPIC] and \
            ...
            if topic == self._topics[CONF_CHARGING_TOPIC] and \
            ...
            if topic == self._topics[CONF_CLEANING_TOPIC] and \
            ...
            if topic == self._topics[CONF_DOCKED_TOPIC] and \
            ...
            if topic == self._topics[CONF_ERROR_TOPIC] and \
            ...
            if topic == self._topics[CONF_FAN_SPEED_TOPIC] and \
