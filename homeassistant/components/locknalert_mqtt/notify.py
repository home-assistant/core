"""Support for LocknAlertLocknAlertMQTT notify."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT notify"
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT notify through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttNotify(MqttEntity, NotifyEntity):
    """Representation of a notification entity service that can send messages using LocknAlertMQTT."""
