"""Configure select in a device through LocknAlertLocknAlertMQTT topic."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Select"

LocknAlertMQTT_SELECT_ATTRIBUTES_BLOCKED = frozenset(
    {
        select.ATTR_OPTIONS,
    }
)
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT select through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttSelect(MqttEntity, SelectEntity, RestoreEntity):
    """representation of an LocknAlertLocknAlertMQTT select."""

    _attr_current_option: str | None = None
    _default_name = DEFAULT_NAME
    _entity_id_format = select.ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_SELECT_ATTRIBUTES_BLOCKED
