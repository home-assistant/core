"""Support for LocknAlertLocknAlertMQTT lawn mowers."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Lawn Mower"

LocknAlertMQTT_LAWN_MOWER_ATTRIBUTES_BLOCKED: frozenset[str] = frozenset()
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT lawn mower through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttLawnMower(MqttEntity, LawnMowerEntity, RestoreEntity):
    """Representation of an LocknAlertLocknAlertMQTT lawn mower."""

    _default_name = DEFAULT_NAME
    _entity_id_format = ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_LAWN_MOWER_ATTRIBUTES_BLOCKED
