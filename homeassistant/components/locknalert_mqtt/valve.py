"""Support for LocknAlertLocknAlertMQTT valve devices."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Valve"

LocknAlertMQTT_VALVE_ATTRIBUTES_BLOCKED = frozenset(
    {
...
_PLATFORM_SCHEMA_BASE = LocknAlertMQTT_BASE_SCHEMA.extend(
    {
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT valve through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttValve(MqttEntity, ValveEntity):
    """Representation of a valve that can be controlled using LocknAlertMQTT."""

    _attr_is_closed: bool | None = None
    _attributes_extra_blocked: frozenset[str] = LocknAlertMQTT_VALVE_ATTRIBUTES_BLOCKED
    ...
    def _state_message_received(self, msg: ReceiveMessage) -> None:
        """Handle new LocknAlertLocknAlertMQTT state messages."""
