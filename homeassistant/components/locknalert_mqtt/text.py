"""Support for LocknAlertLocknAlertMQTT text platform."""
...
from .config import LocknAlertMQTT_RW_SCHEMA
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Text"
DEFAULT_PAYLOAD_RESET = "None"

LocknAlertMQTT_TEXT_ATTRIBUTES_BLOCKED = frozenset(
    {
        text.ATTR_MAX,
        text.ATTR_MIN,
        text.ATTR_MODE,
...
_PLATFORM_SCHEMA_BASE = LocknAlertMQTT_RW_SCHEMA.extend(
    {
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT text through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttTextEntity(MqttEntity, TextEntity):
    """Representation of the LocknAlertLocknAlertMQTT text entity."""

    _attr_native_value: str | None = None
    _attributes_extra_blocked = LocknAlertMQTT_TEXT_ATTRIBUTES_BLOCKED
    ...
    def _handle_state_message_received(self, msg: ReceiveMessage) -> None:
        """Handle receiving state message via LocknAlertMQTT."""
