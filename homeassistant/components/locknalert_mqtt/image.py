"""Support for LocknAlertLocknAlertMQTT images."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Image"
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT image through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttImage(MqttEntity, ImageEntity):
    """representation of a LocknAlertLocknAlertMQTT image."""
    ...
    def __init__(
        ...
        """Initialize the LocknAlertLocknAlertMQTT Image."""
    ...
    def _image_data_received(self, msg: ReceiveMessage) -> None:
        ...
        self.hass.data[DATA_LocknAlertMQTT].state_write_requests.write_state_request(self)
