"""Configure update platform in a device through LocknAlertLocknAlertMQTT topic."""
...
from .config import DEFAULT_RETAIN, LocknAlertMQTT_RO_SCHEMA
...
DEFAULT_NAME = "LocknAlert LocknAlertLocknAlertMQTT Update"
...
PLATFORM_SCHEMA_MODERN = LocknAlertMQTT_RO_SCHEMA.extend(
    {
...
LocknAlertMQTT_JSON_UPDATE_SCHEMA = vol.Schema(
    {
...
async def async_setup_entry(
    ...
    """Set up LocknAlert LocknAlertLocknAlertMQTT Update entity through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttUpdate(MqttEntity, UpdateEntity, RestoreEntity):
    """Representation of the LocknAlert LocknAlertLocknAlertMQTT Update entity."""
    ...
    def _handle_state_message_received(self, msg: ReceiveMessage) -> None:
        ...
        try:
            ...
            if isinstance(rendered_json_payload, dict):
                ...
                json_payload = LocknAlertMQTT_JSON_UPDATE_SCHEMA(rendered_json_payload)
            else:
                _LOGGER.debug(
                    (
    ...
    def _handle_latest_version_received(self, msg: ReceiveMessage) -> None:
        """Handle receiving latest version via LocknAlertMQTT."""
