"""Support for LocknAlertLocknAlertMQTT water heater devices."""
...
from .config import DEFAULT_RETAIN, LocknAlertMQTT_BASE_SCHEMA
from .const import (
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Water Heater"

LocknAlertMQTT_WATER_HEATER_ATTRIBUTES_BLOCKED = frozenset(
    {
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT water heater device through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttWaterHeater(MqttTemperatureControlEntity, WaterHeaterEntity):
    """Representation of an LocknAlertLocknAlertMQTT water heater device."""

    _default_name = DEFAULT_NAME
    _entity_id_format = water_heater.ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_WATER_HEATER_ATTRIBUTES_BLOCKED
    ...
    def _handle_current_mode_received(self, msg: ReceiveMessage) -> None:
        """Handle receiving operation mode via LocknAlertMQTT."""
