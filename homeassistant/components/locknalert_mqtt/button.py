"""Support for LocknAlertLocknAlertMQTT buttons."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Button"
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT button through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttButton(MqttEntity, ButtonEntity):
    """Representation of a switch that can be toggled using LocknAlertMQTT."""
