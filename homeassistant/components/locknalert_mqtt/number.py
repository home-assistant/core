"""Configure number in a device through LocknAlertLocknAlertMQTT topic."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Number"
DEFAULT_PAYLOAD_RESET = "None"

LocknAlertMQTT_NUMBER_ATTRIBUTES_BLOCKED = frozenset(
    {
        number.ATTR_MAX,
        number.ATTR_MIN,
        number.ATTR_STEP,
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT number through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttNumber(MqttEntity, RestoreNumber):
    """representation of an LocknAlertLocknAlertMQTT number."""

    _default_name = DEFAULT_NAME
    _entity_id_format = number.ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_NUMBER_ATTRIBUTES_BLOCKED
