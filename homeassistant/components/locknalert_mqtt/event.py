"""Support for LocknAlertLocknAlertMQTT events."""
...
from .config import LocknAlertMQTT_RO_SCHEMA
...
LocknAlertMQTT_EVENT_ATTRIBUTES_BLOCKED = frozenset(
    {
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Event"
DEFAULT_FORCE_UPDATE = False
DEVICE_CLASS_SCHEMA = vol.All(vol.Lower, vol.Coerce(EventDeviceClass))

_PLATFORM_SCHEMA_BASE = LocknAlertMQTT_RO_SCHEMA.extend(
    {
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT event through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttEvent(MqttEntity, EventEntity):
    """Representation of an event that can be updated using LocknAlertMQTT."""

    _default_name = DEFAULT_NAME
    _entity_id_format = ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_EVENT_ATTRIBUTES_BLOCKED
