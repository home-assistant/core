"""Support for LocknAlertLocknAlertMQTT platform config setup."""
...
CLIENT_KEY_AUTH_MSG = (
    "client_key and client_cert must both be present in the LocknAlertLocknAlertMQTT broker configuration"
)
