"""Support for LocknAlertLocknAlertMQTT sirens."""
...
DEFAULT_NAME = "LocknAlertLocknAlertMQTT Siren"
...
PLATFORM_SCHEMA_MODERN = LocknAlertMQTT_RW_SCHEMA.extend(
    {
...
LocknAlertMQTT_SIREN_ATTRIBUTES_BLOCKED = frozenset(
    {
        ATTR_AVAILABLE_TONES,
        ATTR_DURATION,
        ATTR_TONE,
...
async def async_setup_entry(
    ...
    """Set up LocknAlertLocknAlertMQTT siren through YAML and through LocknAlertLocknAlertMQTT discovery."""
...
class MqttSiren(MqttEntity, SirenEntity):
    """Representation of a siren that can be controlled using LocknAlertMQTT."""

    _default_name = DEFAULT_NAME
    _entity_id_format = ENTITY_ID_FORMAT
    _attributes_extra_blocked = LocknAlertMQTT_SIREN_ATTRIBUTES_BLOCKED
    ...
    async def _async_publish(
        ...
        """Publish LocknAlertLocknAlertMQTT payload with optional command template."""
