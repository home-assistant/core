...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    for thermostat_id in thermostat.get_thermostat_ids():
        ...
        for zone in thermostat.get_zone_ids(thermostat_id):
            ...
            sensors.append(NexiaZoneSensor(thermostat, scan_interval, thermostat_id, zone, "get_zone_temperature",
                                           f"{name} Temperature", DEVICE_CLASS_TEMPERATURE, unit, None))
            sensors.append(NexiaZoneSensor(thermostat, scan_interval, thermostat_id, zone, "get_zone_status",
