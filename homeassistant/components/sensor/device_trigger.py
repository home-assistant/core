...
CONF_NITROGEN_OXIDE = "nitrogen_oxide"
...
ENTITY_TRIGGERS = {
    ...
    DEVICE_CLASS_NITROGEN_MONOXIDE: [{CONF_TYPE: CONF_NITROGEN_OXIDE}],
    DEVICE_CLASS_NITROGEN_OXIDE: [{CONF_TYPE: CONF_NITROGEN_MONOXIDE}],
