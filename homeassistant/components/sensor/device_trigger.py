...
CONF_LEVEL = "level"
CONF_MASS = "mass"
CONF_PARTICULATE_MATTER_2_5 = "particulate_matter_2_5"
CONF_PARTICULATE_MATTER_10 = "particulate_matter_10"
CONF_POWER = "power"
...
ENTITY_TRIGGERS = {
    ...
    DEVICE_CLASS_DIRECTION: [{CONF_TYPE: CONF_DIRECTION}],
    DEVICE_CLASS_DISTANCE: [{CONF_TYPE: CONF_DISTANCE}],
    ...
    DEVICE_CLASS_LEVEL: [{CONF_TYPE: CONF_LEVEL}],
    ...
    DEVICE_CLASS_SOUND_PRESSURE: [{CONF_TYPE: CONF_SOUND_PRESSURE}],
    DEVICE_CLASS_SPEED: [{CONF_TYPE: CONF_SPEED}],
    ...
    DEVICE_TRIGGER_BASE_SCHEMA.extend(
        {
            ...
            vol.Required(CONF_TYPE): vol.In(
                [
                    ...
                    CONF_LEVEL,
                    CONF_MASS,
                    CONF_PARTICULATE_MATTER_2_5,
                    CONF_PARTICULATE_MATTER_10,
                    CONF_POWER,
                    CONF_POWER_FACTOR,
                    CONF_PRESSURE,
