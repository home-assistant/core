...
CONF_IS_DIRECTION = "is_direction"
CONF_IS_DISTANCE = "is distance"
CONF_IS_ENERGY = "is_energy"
CONF_IS_FREQUENCY = "is_frequency"
CONF_IS_HUMIDITY = "is_humidity"
CONF_IS_GAS = "is_gas"
CONF_IS_ILLUMINANCE = "is_illuminance"
CONF_IS_LEVEL = "is_level"
CONF_IS_MASS = "is_mass"
CONF_IS_PARTICULATE_MATTER_2_5 = "is_particulate_matter_2_5"
CONF_IS_PARTICULATE_MATTER_10 = "is_particulate_matter_10"
...
ENTITY_CONDITIONS = {
    ...
    DEVICE_CLASS_DIRECTION: [{CONF_TYPE: CONF_IS_DIRECTION}],
    DEVICE_CLASS_DISTANCE: [{CONF_TYPE: CONF_IS_DISTANCE}],
    ...
    DEVICE_CLASS_LEVEL: [{CONF_TYPE: CONF_IS_LEVEL}],
    DEVICE_CLASS_MASS: [{CONF_TYPE: CONF_IS_MASS}],
    DEVICE_CLASS_PARTICULATE_MATTER_2_5: [{CONF_TYPE: CONF_IS_PARTICULATE_MATTER_2_5}],
    DEVICE_CLASS_PARTICULATE_MATTER_10: [{CONF_TYPE: CONF_IS_PARTICULATE_MATTER_10}],
    ...
    DEVICE_CLASS_SOUND_PRESSURE: [{CONF_TYPE: CONF_IS_SOUND_PRESSURE}],
    DEVICE_CLASS_SPEED: [{CONF_TYPE: CONF_IS_SPEED}],
    ...
    cv.DEVICE_CONDITION_BASE_SCHEMA.extend(
        {
            ...
            vol.Required(CONF_TYPE): vol.In(
                [
                    ...
                    CONF_IS_LEVEL,
                    CONF_IS_MASS,
                    CONF_IS_PARTICULATE_MATTER_2_5,
                    CONF_IS_PARTICULATE_MATTER_10,
                    CONF_IS_POWER,
