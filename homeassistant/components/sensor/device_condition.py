...
CONF_IS_TEMPERATURE_INTERVAL = "is_temperature_interval"
...
ENTITY_CONDITIONS = {
    ...
    SensorDeviceClass.TEMPERATURE_INTERVAL: [{CONF_TYPE: CONF_IS_TEMPERATURE_INTERVAL}],
