...
class NSDepartureSensor(Entity):
    ...
    def device_state_attributes(self):
        ...
        return {
            ...
            'departure_platform_changed': self._trips[0].trip_parts[0].stops[0].platform_changed,
            ...
            'arrival_platform_changed': self._trips[0].trip_parts[0].stops[-1].platform_changed,
            'next':
