...
ICON_DESCRIPTION = "mdi:card-text"
ICON_LATENCY_TIME = "mdi:signal"
ICON_PLAYERS_LIST = "mdi:account-multiple"
...
NAME_PLAYERS_LIST = "Players List"
...
UNIT_PLAYERS_LIST = None
UNIT_PLAYERS_MAX = None
UNIT_PLAYERS_ONLINE = None
