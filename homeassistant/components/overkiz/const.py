...
OVERKIZ_UNIT_TO_HA: dict[str, str] = {
    ...
    MeasuredValueType.FLOW_IN_LITRE_PER_SECOND: UnitOfVolumeFlowRate.LITERS_PER_SECOND,
    MeasuredValueType.FLOW_IN_METER_CUBE_PER_HOUR: UnitOfVolumeFlowRate.CUBIC_METERS_PER_HOUR,
    MeasuredValueType.FLOW_IN_METER_CUBE_PER_SECOND: UnitOfVolumeFlowRate.CUBIC_METERS_PER_SECOND,
