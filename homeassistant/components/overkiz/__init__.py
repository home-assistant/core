...
from pyoverkiz.models import Command, Device, OverkizServer, Scenario
...
async def async_setup_entry(hass: HomeAssistant, entry: OverkizDataConfigEntry) -> bool:
    ...
    async def handle_execute_command(service: ServiceCall) -> ServiceResponse:
        ...
        vol.Schema(
            {
                ...
                vol.Optional(ATTR_ARGS, default=[]): vol.All(
