...
NUMBER_DESCRIPTIONS: list[OverkizNumberDescription] = [
    ...
    OverkizNumberDescription(
        ...
        command=OverkizCommand.SET_COMFORT_COOLING_TARGET_TEMPERATURE,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_min_value=18,
        native_max_value=30,
        min_value_state_name=OverkizState.CORE_MINIMUM_COOLING_TARGET_TEMPERATURE,
        max_value_state_name=OverkizState.CORE_MAXIMUM_COOLING_TARGET_TEMPERATURE,
        native_step=0.5,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        entity_category=EntityCategory.CONFIG,
    ),
    OverkizNumberDescription(
        key=OverkizState.CORE_ECO_COOLING_TARGET_TEMPERATURE,
        name="Eco cooling target temperature",
        icon="mdi:snowflake-thermometer",
        command=OverkizCommand.SET_ECO_COOLING_TARGET_TEMPERATURE,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_min_value=18,
        native_max_value=30,
        min_value_state_name=OverkizState.CORE_MINIMUM_COOLING_TARGET_TEMPERATURE,
    ...
    OverkizNumberDescription(
        key=OverkizState.CORE_COMFORT_HEATING_TARGET_TEMPERATURE,
        name="Comfort heating target temperature",
        icon="mdi:home-thermometer-outline",
        command=OverkizCommand.SET_COMFORT_HEATING_TARGET_TEMPERATURE,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_min_value=16,
        native_max_value=30,
        min_value_state_name=OverkizState.CORE_MINIMUM_HEATING_TARGET_TEMPERATURE,
        max_value_state_name=OverkizState.CORE_MAXIMUM_HEATING_TARGET_TEMPERATURE,
        native_step=0.5,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        entity_category=EntityCategory.CONFIG,
    ),
    OverkizNumberDescription(
        key=OverkizState.CORE_ECO_HEATING_TARGET_TEMPERATURE,
        name="Eco heating target temperature",
        icon="mdi:home-thermometer-outline",
        command=OverkizCommand.SET_ECO_HEATING_TARGET_TEMPERATURE,
        device_class=NumberDeviceClass.TEMPERATURE,
        native_min_value=16,
        native_max_value=30,
        min_value_state_name=OverkizState.CORE_MINIMUM_HEATING_TARGET_TEMPERATURE,
