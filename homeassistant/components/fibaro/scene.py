...
from . import FIBARO_CONTROLLER, FibaroController
...
async def async_setup_entry(
    ...
    controller: FibaroController = hass.data[DOMAIN][entry.entry_id][FIBARO_CONTROLLER]
    async_add_entities(
        [FibaroScene(scene, controller) for scene in controller.get_scenes()],
        True,
    )
