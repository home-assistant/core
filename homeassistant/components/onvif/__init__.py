...
class ONVIFHassCamera(Camera):
    ...
    async def async_initialize(self):
        ...
        self._supports_motion_detection = False
    ...
    @property
    def supports_motion_detection(self):
        """Return whether this camera supports motion detection."""
        return self._imaging_service is not None
