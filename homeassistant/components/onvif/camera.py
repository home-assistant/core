...
SERVICE_PTZ_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(ATTR_PAN): vol.In([DIR_LEFT, DIR_RIGHT, None]),
        vol.Optional(ATTR_TILT): vol.In([DIR_UP, DIR_DOWN, None]),
        vol.Optional(ATTR_ZOOM): vol.In([ZOOM_OUT, ZOOM_IN, None]),
