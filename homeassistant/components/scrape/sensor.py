...
from homeassistant.components.rest import DEFAULT_VERIFY_SSL, RESOURCE_SCHEMA, create_rest_data_from_config
...
from .const import CONF_INDEX, CONF_SELECT, DEFAULT_NAME
