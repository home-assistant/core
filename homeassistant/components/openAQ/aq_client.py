...
class AQClient:
    ...
    def get_metrices(self, prev_fetch_date, num_parameters):
        """Get latest measurements"""

        response = self.client.measurements.list(locations_id=self.location_id, page=1, limit=num_parameters, date_from=prev_fetch_date)
        return response
