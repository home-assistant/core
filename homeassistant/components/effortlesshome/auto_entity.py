...
DeviceClassT = TypeVar(
    "DeviceClassT", BinarySensorDeviceClass, SensorDeviceClass, CoverDeviceClass
)

_LOGGER: logging.Logger = logging.getLogger(__package__)


class AutoEntity(Entity, Generic[EntityT, DeviceClassT]):
    ...
    def __init__(
        ...
        self._device_class: DeviceClassT = device_class
    ...
    @cached_property
    def device_class(self) -> DeviceClassT:
        """Return device class."""
