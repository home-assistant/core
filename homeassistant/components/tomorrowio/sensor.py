...
SENSOR_TYPES = (
    ...
    # Precipitation intensity sensors - data comes in as mm/hr
    TomorrowioSensorEntityDescription(
        key="rain_intensity",
        translation_key="rain_intensity",
        attribute=TMRW_ATTR_RAIN_INTENSITY,
    ...
    TomorrowioSensorEntityDescription(
        key="snow_intensity",
        translation_key="snow_intensity",
        attribute=TMRW_ATTR_SNOW_INTENSITY,
        native_unit_of_measurement=UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR,
        device_class=SensorDeviceClass.PRECIPITATION_INTENSITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    TomorrowioSensorEntityDescription(
        key="sleet_intensity",
        translation_key="sleet_intensity",
        attribute=TMRW_ATTR_SLEET_INTENSITY,
        native_unit_of_measurement=UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR,
        device_class=SensorDeviceClass.PRECIPITATION_INTENSITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    TomorrowioSensorEntityDescription(
        key="freezing_rain_intensity",
        translation_key="freezing_rain_intensity",
        attribute=TMRW_ATTR_FREEZING_RAIN_INTENSITY,
        native_unit_of_measurement=UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR,
        device_class=SensorDeviceClass.PRECIPITATION_INTENSITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    # Standalone sensors for fields otherwise only available on the weather entity
    TomorrowioSensorEntityDescription(
        key="temperature",
