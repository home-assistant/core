        ...
        def load():
            ...
            try:
                ...
                self.hass.states.set(
                    "sensor.dyski", len(self.folders), {
                        0: {"name": "Dysk wewnętrzny", "icon": "harddisk", "url": "/sdcard/dom", "info": "8 GB"},
                        1: {"name": "Dyski zewnętrzne", "icon": "sd", "url": "xxx", "info": "0"},
                        2: {"name": "Dyski zdalne", "icon": "folder-google-drive", "url": "xxx", "info": " - "},
                    })
            except Exception as e:
