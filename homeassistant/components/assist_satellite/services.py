"""Services for the Assist satellite integration."""
...
from .const import DATA_COMPONENT, DOMAIN, AssistSatelliteEntityFeature
...
def async_setup_services(hass: HomeAssistant) -> None:
    """Register the Assist satellite services."""
