"""The Home Assistant Connect ZBT-1 integration."""
...
async def _async_usb_scan_done(hass: HomeAssistant, entry: ConfigEntry) -> None:
    """Finish Home Assistant Connect ZBT-1 config entry setup."""
    ...
    hw_discovery_data = {
        "name": "Connect ZBT-1 Multiprotocol",
        "port": {
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up a Home Assistant Connect ZBT-1 config entry."""
