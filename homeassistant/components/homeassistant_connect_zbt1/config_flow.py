"""Config flow for the Home Assistant Connect ZBT-1 integration."""
...
class HomeAssistantSkyConnectConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Home Assistant Connect ZBT-1."""
...
class HomeAssistantSkyConnectOptionsFlow(silabs_multiprotocol_addon.OptionsFlowHandler):
    """Handle an option flow for Home Assistant Connect ZBT-1."""
    ...
    def _zha_name(self) -> str:
        """Return the ZHA name."""
        return "Connect ZBT-1 Multiprotocol"

    def _hardware_name(self) -> str:
        """Return the name of the hardware."""
        return "Home Assistant Connect ZBT-1"
