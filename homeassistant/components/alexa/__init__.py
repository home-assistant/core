...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    flash_briefings_config = alexa_config.get(CONF_FLASH_BRIEFINGS)
    if flash_briefings_config is not None:
    ...
    if CONF_SMART_HOME in alexa_config:
        smart_home_config: dict[str, Any] | None = alexa_config.get(CONF_SMART_HOME)
