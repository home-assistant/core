...
VENTILATION_TO_PRESET_MODE_MAP = {
    VENTILATION_MODES[VENTILATION_MODE_STOP]: PRESET_NONE,
    VENTILATION_MODES[VENTILATION_MODE_AWAY]: PRESET_AWAY,
    VENTILATION_MODES[VENTILATION_MODE_HOME]: PRESET_HOME,
    VENTILATION_MODES[VENTILATION_MODE_HIGH]: PRESET_BOOST,
}
