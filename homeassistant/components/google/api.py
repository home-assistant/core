...
from .const import DOMAIN, GOOGLE_CALENDAR_API, GOOGLE_PEOPLE_API, SCOPES
...
class GoogleCalendarAPI(GoogleAPI):
    ...
    def list_calendars(self) -> List:
        ...
        """
        calendars = self._api.calendarList().list().execute()
    ...
    def list_events(self, calendar_id="primary", count=None) -> List:
        ...
        """
        # TODO: List events for this calendar month
        # TODO: List events for the next 7 days
        # TODO: List events for today
        # TODO: List x scheduled/upcoming events
        date_start = (
