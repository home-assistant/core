...
from .const import DOMAIN, GOOGLE_APIS, OAUTH2_AUTHORIZE, OAUTH2_TOKEN, SCOPES
...
class GoogleOAuth2ConfigFlow(AbstractOAuth2FlowHandler, domain=DOMAIN):
    ...
    VERSION = 1
    DOMAIN = DOMAIN
    # TODO: Update this to CONN_CLASS_CLOUD_PUSH # pylint: disable=fixme
    ...
    async def async_step_api(
        ...
        if user_input is not None:
            ...
            if self.flow_impl.scopes:
                self.flow_impl.name = ", ".join(names)
