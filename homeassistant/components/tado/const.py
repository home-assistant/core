...
CONDITIONS_MAP = {
    ...
    ATTR_CONDITION_FOG: {"FOGGY"},
    ATTR_CONDITION_HAIL: {"HAIL", "RAIN_HAIL"},
    ATTR_CONDITION_LIGHTNING: {"THUNDERSTORM"},
    ATTR_CONDITION_PARTLYCLOUDY: {"CLOUDY_PARTLY"},
    ATTR_CONDITION_RAINY: {"DRIZZLE", "RAIN", "SCATTERED_RAIN"},
    ATTR_CONDITION_SNOWY: {"FREEZING", "SCATTERED_SNOW", "SNOW"},
    ATTR_CONDITION_SNOWY_RAINY: {"RAIN_SNOW", "SCATTERED_RAIN_SNOW"},
