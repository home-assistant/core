...
CONST_FAN_OFF = "OFF"
CONST_FAN_AUTO = "AUTO"
CONST_FAN_LOW = "LEVEL1"
CONST_FAN_MIDDLE = "LEVEL2"
CONST_FAN_HIGH = "LEVEL3"
...
HA_TO_TADO_SWING_MODE_MAP = {
    SWING_VERTICAL: { CONST_SWING_MODE_VERTICAL: TADO_SWING_ON, CONST_SWING_MODE_HORIZONTAL: TADO_SWING_OFF, },
    SWING_HORIZONTAL: { CONST_SWING_MODE_VERTICAL: TADO_SWING_OFF, CONST_SWING_MODE_HORIZONTAL: TADO_SWING_ON },
    SWING_OFF: { CONST_SWING_MODE_HORIZONTAL: TADO_SWING_OFF, CONST_SWING_MODE_VERTICAL: TADO_SWING_OFF },
    SWING_BOTH: { CONST_SWING_MODE_HORIZONTAL: TADO_SWING_ON, CONST_SWING_MODE_VERTICAL: TADO_SWING_ON },
}
