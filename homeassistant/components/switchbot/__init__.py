...
PLATFORMS_BY_TYPE = {
    ...
    SupportedModels.RGBICWW_CEILING_LIGHT.value: [Platform.LIGHT, Platform.SENSOR],
...
CLASS_BY_DEVICE = {
    ...
    SupportedModels.RGBICWW_CEILING_LIGHT.value: switchbot.SwitchbotRgbicwwCeilingLight,
