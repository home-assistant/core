"""Config flow for the Novy Hood integration."""
...
from .commands import NovyHoodPlus
from .const import CONF_TRANSMITTER, DOMAIN


class NovyHoodConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Novy Hood."""
