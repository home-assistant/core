...
class TeslemetryEntity(CoordinatorEntity[TeslemetryStateUpdateCoordinator]):
    ...
    def __init__(
        ...
        self._attr_device_info = DeviceInfo(
            ...
            manufacturer="Tesla",
            configuration_url="https://my.teslemetry.com/",
    ...
    async def run(
        ...
        """Run a teslemetry_api function and handle exceptions."""
        try:
            response = await func(
