...
class TedeeLockEntityDescription(
        ...
        TedeeLockEntityDescriptionMixin
    ):
    ...
    for lock in coordinator.data.values():
        for entity_description in ENTITIES:
            if lock.is_enabled_pullspring:
                entities.append(TedeeLockWithLatchEntity(lock, coordinator, entity_description, entry))
            else:
                entities.append(TedeeLockEntity(lock, coordinator, entity_description, entry))
