...
def is_sensor_continuous(
    ...
    already by the SQL query generated by _get_events, but we still check the state
    machine since this function is called from live mode as well which is
    not filtered by the SQL query.
    """
