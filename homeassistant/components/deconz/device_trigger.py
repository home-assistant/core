...
LIGHTIFY_FOUR_BUTTON_REMOTE_MODEL = "Switch-LIGHTIFY"
LIGHTIFY_FOUR_BUTTON_REMOTE_4X_MODEL = "Switch 4x-LIGHTIFY"
LIGHTIFY_FOUR_BUTTON_REMOTE_4X_EU_MODEL = "Switch 4x EU-LIGHTIFY"
LIGHTIFY_FOUR_BUTTON_REMOTE = {
    (CONF_SHORT_RELEASE, CONF_TURN_ON): {CONF_EVENT: 1002},
    (CONF_LONG_PRESS, CONF_TURN_ON): {CONF_EVENT: 1001},
    (CONF_LONG_RELEASE, CONF_TURN_ON): {CONF_EVENT: 1003},
    (CONF_SHORT_RELEASE, CONF_DIM_UP): {CONF_EVENT: 2002},
...
REMOTES = {
    ...
    LIGHTIFY_FOUR_BUTTON_REMOTE_MODEL: LIGHTIFY_FOUR_BUTTON_REMOTE,
    LIGHTIFY_FOUR_BUTTON_REMOTE_4X_MODEL: LIGHTIFY_FOUR_BUTTON_REMOTE,
    LIGHTIFY_FOUR_BUTTON_REMOTE_4X_EU_MODEL: LIGHTIFY_FOUR_BUTTON_REMOTE,
