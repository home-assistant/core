...
LEGRAND_ZGP_TOGGLE_SWITCH = {
    (CONF_SHORT_PRESS, CONF_TURN_ON): {CONF_EVENT: 34},
    (CONF_DOUBLE_PRESS, CONF_TURN_ON): {CONF_EVENT: 32},
}
...
LEGRAND_ZGP_SCENE_SWITCH = {
    ...
    (CONF_SHORT_PRESS, CONF_BUTTON_3): {CONF_EVENT: 22},
    (CONF_SHORT_PRESS, CONF_BUTTON_4): {CONF_EVENT: 23},
}
