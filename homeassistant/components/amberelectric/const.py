...
REQUEST_TIMEOUT = 15
MINUTE_ALIGNED_REFRESH_DELAY = 10
MINUTE_ALIGNED_REFRESH_JITTER = 5
ESTIMATE_REFRESH_DELAY = 10
ESTIMATE_REFRESH_JITTER = 2
API_ERROR_REFRESH_DELAY = 25
API_ERROR_REFRESH_JITTER = 5
