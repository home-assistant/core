...
SENSOR_TYPES = {
    ...
    "ups.model": ["Model", "", "mdi:information-outline", None],
    "ups.mfr": ["Manufacturer", "", "mdi:information-outline", None],
    "ups.mfr.date": ["Manufacture Date", "", "mdi:calendar", None],
    "ups.serial": ["Serial Number", "", "mdi:information-outline", None],
    "ups.vendorid": ["Vendor ID", "", "mdi:information-outline", None],
    "ups.productid": ["Product ID", "", "mdi:information-outline", None],
    "ups.firmware": ["Firmware Version", "", "mdi:information-outline", None],
    "ups.firmware.aux": ["Firmware Version 2", "", "mdi:information-outline", None],
    "ups.temperature": [
        "UPS Temperature",
        TEMP_CELSIUS,
        "mdi:thermometer",
