...
COMMAND_OUTLET_1_OFF = "outlet.1.load.off"
COMMAND_OUTLET_1_ON = "outlet.1.load.on"
COMMAND_OUTLET_2_OFF = "outlet.2.load.off"
COMMAND_OUTLET_2_ON = "outlet.2.load.on"
...
INTEGRATION_SUPPORTED_COMMANDS = {
    ...
    COMMAND_OUTLET_1_OFF,
    COMMAND_OUTLET_1_ON,
    COMMAND_OUTLET_2_OFF,
    COMMAND_OUTLET_2_ON,
}
