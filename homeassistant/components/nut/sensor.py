...
class NUTSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(
        ...
        self.DEVICE_CLASS = SENSOR_TYPES[self._type][SENSOR_DEVICE_CLASS]
        self.ICON = SENSOR_TYPES[self._type][SENSOR_ICON]
        self.UNIT_OF_MEASUREMENT = SENSOR_TYPES[sensor_type][SENSOR_UNIT]
