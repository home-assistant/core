...
class FlapBattery(Entity):
    ...
    def state(self):
        ...
        try:
            ...
            battery_percent = int(voltage_diff_low / SURE_BATT_VOLTAGE_DIFF * 100)
    ...
    def device_info(self):
        ...
        try:
            ...
            device_info = None
            _LOGGER.debug("error while getting device info from %s: %s", self._name, error)
    ...
    async def async_update(self):
        ...
        try:
            if self._data[self._id]:
                ...
                _LOGGER.debug("async_update from %s got no new data: %s", self._name, pprint.pformat(self._data))
