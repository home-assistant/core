...
class SwitchBotAutoMode(StrEnum):
    """SwitchBot Auto mode."""
...
_SWITCHBOT_AUTO_MODES: dict[SwitchBotAutoMode, int] = {
    SwitchBotAutoMode.AUTO_0: 0,
    SwitchBotAutoMode.AUTO_1: 1,
}

_DEFAULT_PRESET_MODE = SwitchBotAutoMode.AUTO_1
_DEFAULT_SWITCHBOT_AUTO_MODE = _SWITCHBOT_AUTO_MODES[_DEFAULT_PRESET_MODE]
...
class SwitchBotCloudAirConditioner(SwitchBotCloudEntity, ClimateEntity, RestoreEntity):
    ...
    _attr_preset_modes = [SwitchBotAutoMode.AUTO_0, SwitchBotAutoMode.AUTO_1]
    _attr_preset_mode = _DEFAULT_PRESET_MODE
    _attr_fan_modes = [
        FanState.FAN_AUTO,
        FanState.FAN_LOW,
        FanState.FAN_MEDIUM,
    ...
    async def async_set_preset_mode(self, preset_mode: str) -> None:
        """Set new preset mode."""
        self._attr_preset_mode = SwitchBotAutoMode(preset_mode)
    ...
    def _get_mode(self, hvac_mode: HVACMode | None = None) -> int:
        ...
        if new_hvac_mode == HVACMode.AUTO:
            return _SWITCHBOT_AUTO_MODES.get(
                self._attr_preset_mode, _DEFAULT_SWITCHBOT_AUTO_MODE
            )
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        ):  # Cannot set temperature in FAN_ONLY mode
