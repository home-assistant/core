...
BATTERY_LEVELS_DESCRIPTION = SwitchbotCloudSensorEntityDescription(
    key=SENSOR_TYPE_BATTERY,
...
class SwitchBotCloudSensor(SwitchBotCloudEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = (
            f"{device.device_id}_{description.translation_key}_{description.key}"
        )
