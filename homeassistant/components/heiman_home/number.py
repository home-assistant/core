"""Number entities for Heiman Home Integration."""
...
async def async_setup_entry(
    ...
    for device in devices:
        ...
        number_entities = heiman_device.get_number_entities(
...
class HeimanNumberEntity(CoordinatorEntity, NumberEntity):
    ...
    def __init__(
        ...
        self._attr_native_min_value = property_info.get("min", 0)
        self._attr_native_max_value = property_info.get("max", 100)
        self._attr_native_step = property_info.get("step", 1)
        self._attr_native_unit_of_measurement = property_info.get("unit")
        ...
        if sw_version:
            ...
            _LOGGER.debug(
                "Added firmware version %s to number device info for %s",
                sw_version,
                device_id,
            )
