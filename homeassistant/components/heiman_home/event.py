"""Event entities for Heiman Home Integration."""
...
async def async_setup_entry(
    ...
    for device in devices:
        ...
        event_entities = heiman_device.get_event_entities(devices_config=devices_config)
...
class HeimanEventEntity(CoordinatorEntity, EventEntity):
    """Representation of a Heiman event entity."""
    ...
    def __init__(
        ...
        # Event types
        self._attr_event_types = property_info.get("event_types", [])
        ...
        if sw_version:
            ...
            _LOGGER.debug(
                "Added firmware version %s to event device info for %s",
                sw_version,
                device_id,
            )
