...
class TuyaVacuumEntity(TuyaEntity, StateVacuumEntity):
    ...
    async def async_return_to_base(self, **kwargs: Any) -> None:
        ...
        if self._charge_wrapper:
            await self._async_send_wrapper_update(self._charge_wrapper, True)
        else:
    ...
    async def async_locate(self, **kwargs: Any) -> None:
        """Locate the device."""
        await self._async_send_wrapper_update(self._locate_wrapper, True)

    async def async_set_fan_speed(self, fan_speed: str, **kwargs: Any) -> None:
        """Set fan speed."""
        await self._async_send_wrapper_update(self._fan_speed_wrapper, fan_speed)
