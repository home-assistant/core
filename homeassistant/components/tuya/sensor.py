...
SENSORS: dict[DeviceCategory, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    DeviceCategory.QN: (
        ...
        # Pool heat pump - power consumption
        TuyaSensorEntityDescription(
            key=DPCode.POWER,
        ...
        # Pool heat pump - diagnostic temperature sensors
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            key=DPCode.TEMP_COILER_INSIDE,
            translation_key="inner_coil_temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
            entity_registry_enabled_default=False,
        ...
        # Pool heat pump - operational metrics
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            key=DPCode.EXPANSION_VALVE,
            translation_key="expansion_valve_opening",
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
            entity_registry_enabled_default=False,
        ),
