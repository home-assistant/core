...
SENSORS: dict[str, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    "dgnbj": (
        ...
        TuyaSensorEntityDescription(
            ...
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="volatile_organic_compound",
        ),
        TuyaSensorEntityDescription(
            ...
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="particulate_matter_2_5_um",
        ),
        TuyaSensorEntityDescription(
            key=DPCode.CO_VALUE,
    ...
    "pm2.5": (
        ...
        TuyaSensorEntityDescription(
            ...
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="particulate_matter_1_0_um",
        ),
        TuyaSensorEntityDescription(
            key=DPCode.PM10,
            ...
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="particulate_matter_10_0_um",
        ),
        *BATTERY_SENSORS,
    ),
    # Heater
    ...
    "sd": (
        ...
        TuyaSensorEntityDescription(
            ...
            icon="mdi:history",
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="cleaning_time_total",
        ),
        TuyaSensorEntityDescription(
            ...
            icon="mdi:counter",
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="cleaning_times_total",
        ),
        TuyaSensorEntityDescription(
    ...
    "cl": (
        TuyaSensorEntityDescription(
            ...
            entity_category=EntityCategory.DIAGNOSTIC,
            icon="mdi:progress-clock",
            translation_key="last_operartion_duration",
        ),
    ),
    # Humidifier
    ...
    "kj": (
        ...
        TuyaSensorEntityDescription(
            ...
            device_class=SensorDeviceClass.VOLATILE_ORGANIC_COMPOUNDS,
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="volatile_organic_compound_total",
        ),
        TuyaSensorEntityDescription(
            key=DPCode.ECO2,
            ...
            device_class=SensorDeviceClass.CO2,
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="carbon_dioxide_concentration",
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            ...
            state_class=SensorStateClass.TOTAL_INCREASING,
            entity_category=EntityCategory.DIAGNOSTIC,
            translation_key="total_absortion_particules",
        ),
        TuyaSensorEntityDescription(
