...
def _indexed_phase_sensors(
    dpcode: DPCode, index: int
) -> tuple[TuyaSensorEntityDescription, ...]:
    """Build sensors for an indexed electricity meter channel."""
...
SENSORS: dict[DeviceCategory, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    DeviceCategory.ZNDB: (
        ...
        *_additional_phase_sensors(DPCode.PHASE_B, "b"),
        *_additional_phase_sensors(DPCode.PHASE_C, "c"),
        *_indexed_phase_sensors(DPCode.PHASE_S1, 1),
        *_indexed_phase_sensors(DPCode.PHASE_S2, 2),
        *_indexed_phase_sensors(DPCode.PHASE_S3, 3),
        *_indexed_phase_sensors(DPCode.PHASE_S4, 4),
        *_indexed_phase_sensors(DPCode.PHASE_S5, 5),
        *_indexed_phase_sensors(DPCode.PHASE_S6, 6),
        *_indexed_phase_sensors(DPCode.PHASE_S7, 7),
        *_indexed_phase_sensors(DPCode.PHASE_S8, 8),
        *_indexed_phase_sensors(DPCode.PHASE_S9, 9),
        *_indexed_phase_sensors(DPCode.PHASE_S10, 10),
        *_indexed_phase_sensors(DPCode.PHASE_S11, 11),
        *_indexed_phase_sensors(DPCode.PHASE_S12, 12),
        *_indexed_phase_sensors(DPCode.PHASE_S13, 13),
        *_indexed_phase_sensors(DPCode.PHASE_S14, 14),
        *_indexed_phase_sensors(DPCode.PHASE_S15, 15),
        *_indexed_phase_sensors(DPCode.PHASE_S16, 16),
        *_indexed_phase_sensors(DPCode.PHASE_S17, 17),
        *_indexed_phase_sensors(DPCode.PHASE_S18, 18),
        *_indexed_phase_sensors(DPCode.PHASE_S19, 19),
        *_indexed_phase_sensors(DPCode.PHASE_S20, 20),
        TuyaSensorEntityDescription(
            key=f"{DPCode.PHASE_A}electriccurrent",
            dpcode=DPCode.PHASE_A,
            translation_key="phase_a_current",
