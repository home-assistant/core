...
class DPCode(StrEnum):
    ...
    COUNTDOWN_7 = "countdown_7"  # Countdown 7
    COUNTDOWN_8 = "countdown_8"  # Countdown 8
    ...
    CUMULATIVE_ENERGY_CHARGED = "cumulative_energy_charged"  # Cumulative energy charged
    CUMULATIVE_ENERGY_DISCHARGED = (
        "cumulative_energy_discharged"  # Cumulative energy discharged
    )
    CUMULATIVE_ENERGY_GENERATED_PV = (
        "cumulative_energy_generated_pv"  # Cumulative energy generated by PV
    )
    CUMULATIVE_ENERGY_OUTPUT_INV = (
        "cumulative_energy_output_inv"  # Cumulative energy output inverter
    )
    CUML_E_EXPORT_OFFGRID1 = (
        "cuml_e_export_offgrid1"  # Cumulative energy export off-grid 1
    )
    CURRENT_SOC = "current_soc"  # State of charge
