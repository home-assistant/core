...
class DPCode(StrEnum):
    ...
    COUNTDOWN_USB1 = "countdown_usb1"  # Countdown USB1
    COUNTDOWN_USB2 = "countdown_usb2"  # Countdown USB2
    COUNTDOWN_USB3 = "countdown_usb3"  # Countdown USB3
    COUNTDOWN_USB4 = "countdown_usb4"  # Countdown USB4
    COUNTDOWN_USB5 = "countdown_usb5"  # Countdown USB5
    COUNTDOWN_USB6 = "countdown_usb6"  # Countdown USB6
