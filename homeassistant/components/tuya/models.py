...
class DPCodeTypeInformationWrapper[T: TypeInformation](DPCodeWrapper):
    ...
    def find_dpcode(
        ...
        *,
        ...
        dptypes = cls.DPTYPE if isinstance(cls.DPTYPE, tuple) else (cls.DPTYPE,)
        for dptype in dptypes:
...
class DPCodeBase64StringWrapper(DPCodeTypeInformationWrapper[TypeInformation]):
    ...
    DPTYPE = (DPType.STRING, DPType.RAW)
...
def find_dpcode(
    ...
    *,
    prefer_function: bool = False,
    dptype: Literal[DPType.BOOLEAN, DPType.JSON, DPType.RAW, DPType.STRING],
