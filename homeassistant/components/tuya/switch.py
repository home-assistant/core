...
SWITCHES: dict[str, tuple[SwitchEntityDescription, ...]] = {
    ...
    "cwysj": (
        ...
        SwitchEntityDescription(
            ...
            icon="mdi:water-sync",
            entity_category=EntityCategory.CONFIG,
            translation_key="water_reset_days_usage",
        ),
        SwitchEntityDescription(
            key=DPCode.UV,
    ...
    "wkcz": (
        SwitchEntityDescription(
            ...
            translation_key="swtich_1",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_2,
            name="Switch 2",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_2",
        ),
    ),
    # Switch
    ...
    "kg": (
        ...
        SwitchEntityDescription(
            ...
            name="Switch 3",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_3",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_4,
            name="Switch 4",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_4",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_5,
            name="Switch 5",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_5",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_6,
            name="Switch 6",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_6",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_7,
            name="Switch 7",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_7",
        ),
        SwitchEntityDescription(
            key=DPCode.SWITCH_8,
            name="Switch 8",
            device_class=SwitchDeviceClass.OUTLET,
            translation_key="swtich_8",
        ),
        SwitchEntityDescription(
    ...
    "sp": (
        ...
        SwitchEntityDescription(
            ...
            entity_category=EntityCategory.CONFIG,
            translation_key="soud_detection",
        ),
        SwitchEntityDescription(
