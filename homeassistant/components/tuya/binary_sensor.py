...
BINARY_SENSORS: dict[DeviceCategory, tuple[TuyaBinarySensorEntityDescription, ...]] = {
    ...
    DeviceCategory.ZNDB: (
        ...
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_unbalance_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="unbalance_alarm",
            translation_key="unbalance",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_ov_vol",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="ov_vol",
        ...
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_undervoltage_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="undervoltage_alarm",
            translation_key="undervoltage",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_miss_phase_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="miss_phase_alarm",
            translation_key="phase_loss",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_outage_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="outage_alarm",
            translation_key="power_outage",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_magnetism_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="magnetism_alarm",
            translation_key="magnetic_interference",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_terminal_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="terminal_alarm",
            translation_key="terminal",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_cover_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.TAMPER,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="cover_alarm",
            translation_key="cover",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_credit_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="credit_alarm",
            translation_key="credit",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_no_balance_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="no_balance_alarm",
            translation_key="no_balance",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_battery_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="battery_alarm",
            translation_key="battery_alarm",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_meter_hardware_alarm",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="meter_hardware_alarm",
            translation_key="meter_hardware",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_overdraft_unlim",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="overdraft_unlim",
            translation_key="overdraft_unlimited",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_arrear_outage",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="arrear_outage",
            translation_key="arrears_outage",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_overdraft_use",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="overdraft_use",
            translation_key="overdraft",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_pf_abnormal",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="pf_abnormal",
            translation_key="power_factor_abnormal",
        ),
        TuyaBinarySensorEntityDescription(
            key=f"{DPCode.FAULT}_ov_pwr",
            dpcode=DPCode.FAULT,
            device_class=BinarySensorDeviceClass.PROBLEM,
            entity_category=EntityCategory.DIAGNOSTIC,
            bitmap_key="ov_pwr",
