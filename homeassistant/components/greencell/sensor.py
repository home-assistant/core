...
async def setup_sensors(hass: HomeAssistant, serial_number: str, async_add_entities: AddEntitiesCallback):
    ...
    current_sensors = [
        HabuCurrentSensor(current_data_obj, phase='l1', sensor_name='Current phase L1', serial_number=serial_number, access=access),
        HabuCurrentSensor(current_data_obj, phase='l2', sensor_name='Current phase L2', serial_number=serial_number, access=access),
        HabuCurrentSensor(current_data_obj, phase='l3', sensor_name='Current phase L3', serial_number=serial_number, access=access),
    ]

    voltage_sensors = [
        HabuVoltageSensor(voltage_data_obj, phase='l1', sensor_name='Voltage phase L1', serial_number=serial_number, access=access),
        HabuVoltageSensor(voltage_data_obj, phase='l2', sensor_name='Voltage phase L2', serial_number=serial_number, access=access),
        HabuVoltageSensor(voltage_data_obj, phase='l3', sensor_name='Voltage phase L3', serial_number=serial_number, access=access),
    ]
