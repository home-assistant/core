...
class MatterFan(MatterEntity, FanEntity):
    ...
    # FanControl.Attributes.PercentSetting
    # (ClusterType=<class 'chip.clusters.Objects.FanControl'>, AttributeType=<class 'chip.clusters.Objects.FanControl.Attributes.PercentSetting'>, AttributeName='percentSetting', Path=AttributePath(EndpointId=1, ClusterId=514, AttributeId=2))
