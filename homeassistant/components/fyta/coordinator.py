...
class FytaCoordinator(DataUpdateCoordinator[dict[int | str, int | str | bool, dict[str, Any]]]):
    ...
    async def _async_update_data(self) -> dict[int | str, int | str | bool, dict[str, Any]]:
