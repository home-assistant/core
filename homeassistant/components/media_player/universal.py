...
from homeassistant.components.media_player import (
    ...
    ATTR_MEDIA_REPEAT, ATTR_MEDIA_TITLE, ATTR_MEDIA_TRACK,
    ATTR_MEDIA_VOLUME_LEVEL, ATTR_MEDIA_VOLUME_MUTED, DOMAIN,
    MediaPlayerDevice, PLATFORM_SCHEMA, SERVICE_CLEAR_PLAYLIST,
    SERVICE_PLAY_MEDIA, SERVICE_SELECT_SOURCE, SUPPORT_CLEAR_PLAYLIST,
    SUPPORT_SELECT_SOURCE, SUPPORT_REPEAT_SET, SUPPORT_SHUFFLE_SET,
...
from homeassistant.const import (
    ...
    SERVICE_REPEAT_SET, SERVICE_SHUFFLE_SET, STATE_IDLE, STATE_OFF,
    STATE_ON, SERVICE_MEDIA_STOP)
