...
DATA: HassKey[EntityComponent[MediaPlayerEntity]] = HassKey(DOMAIN)
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    component = hass.data[DATA] = EntityComponent[MediaPlayerEntity](
...
async def websocket_browse_media(
    ...
    """
    player = hass.data[DATA].get_entity(msg["entity_id"])
