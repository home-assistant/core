...
async def async_setup_entry(
    ...
    coordinator: SeventeenTrackDataCoordinator = hass.data[DOMAIN][
...
class SeventeenTrackBaseSensor(
    CoordinatorEntity[SeventeenTrackDataCoordinator], SensorEntity
):
    ...
    def __init__(self, coordinator: SeventeenTrackDataCoordinator) -> None:
        ...
        self._attr_device_info = DeviceInfo(
            identifiers={(DOMAIN, self.coordinator.config_entry.data[CONF_USERNAME])},
