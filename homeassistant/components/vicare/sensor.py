...
GLOBAL_SENSORS: tuple[ViCareSensorEntityDescription, ...] = (
    ...
    ViCareSensorEntityDescription(
        key="energy_consumption_cooling_currentday",
        translation_key="energy_consumption_cooling_currentday",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
    ...
    ViCareSensorEntityDescription(
        key="energy_consumption_cooling_currentmonth",
        translation_key="energy_consumption_cooling_currentmonth",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
    ...
    ViCareSensorEntityDescription(
        key="energy_consumption_cooling_currentyear",
        translation_key="energy_consumption_cooling_currentyear",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
