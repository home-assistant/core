...
GLOBAL_SENSORS: tuple[ViCareSensorEntityDescription, ...] = (
    ...
    ViCareSensorEntityDescription(
        key="ess_charge_today",
        translation_key="ess_charge_today",
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedCurrentDay(),
        unit_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedUnit(),
    ),
    ViCareSensorEntityDescription(
        key="ess_charge_this_week",
        translation_key="ess_charge_this_week",
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedCurrentWeek(),
        unit_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedUnit(),
        entity_registry_enabled_default=False,
    ),
    ViCareSensorEntityDescription(
        key="ess_charge_this_month",
        translation_key="ess_charge_this_month",
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedCurrentMonth(),
        unit_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedUnit(),
        entity_registry_enabled_default=False,
    ),
    ViCareSensorEntityDescription(
        key="ess_charge_this_year",
        translation_key="ess_charge_this_year",
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedCurrentYear(),
        unit_getter=lambda api: api.getElectricalEnergySystemTransferChargeCumulatedUnit(),
        entity_registry_enabled_default=False,
    ),
    ViCareSensorEntityDescription(
