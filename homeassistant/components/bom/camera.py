...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    args = [config.get(x) for x in (CONF_LOCATION, CONF_ID, CONF_OUTFILE)]
...
class BOMRadarCam(Camera):
    ...
    def __init__(self, name, location, radar_id, outfile):
        """Initialize the component."""

        super().__init__()
        self._name = name
        self._cam = BOMRadarLoop(location, radar_id, outfile)
