    ...
    def _handle_device_tracker(self, state: State):
        ...
        well_known_attributes = {
            ATTR_LATITUDE: (
                ...
                "Latitude of the device tracker measured in decimal degrees",
            ),
            ATTR_LONGITUDE: (
                "device_tracker_longitude_degrees",
                "Longitude of the device tracker measured in decimal degrees",
            ),
            ATTR_GPS_ACCURACY: (
                "device_tracker_gps_accuracy",
                "GPS accuracy of the device tracker location",
            ),
        }
        for attr, (metric_name, description) in well_known_attributes.items():
