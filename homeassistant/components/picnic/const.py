...
SENSOR_TYPES = {
    ...
    SENSOR_LAST_ORDER_SLOT_START: {
        ...
        "state": lambda last_order: last_order["slot"].get("window_start"),
    },
    SENSOR_LAST_ORDER_SLOT_END: {
        "class": DEVICE_CLASS_TIMESTAMP,
        "icon": "mdi:calendar-end",
        "data_type": LAST_ORDER_DATA,
        "state": lambda last_order: last_order["slot"].get("window_end"),
    },
    ...
    SENSOR_LAST_ORDER_ETA_START: {
        ...
        "default_enabled": True,
        "data_type": LAST_ORDER_DATA,
        "state": lambda last_order: last_order["eta"].get("start"),
    },
    SENSOR_LAST_ORDER_ETA_END: {
        ...
        "default_enabled": True,
        "data_type": LAST_ORDER_DATA,
        "state": lambda last_order: last_order["eta"].get("end"),
    },
    SENSOR_LAST_ORDER_DELIVERY_TIME: {
        ...
        "default_enabled": True,
        "data_type": LAST_ORDER_DATA,
        "state": lambda last_order: last_order["delivery_time"].get("start"),
    },
