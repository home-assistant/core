...
class HomeAssistantHTTP:
    ...
    def register_redirect(
        ...
        *,
        ...
        self.app["add_cors"](self.app.router.add_route("GET", url, redirect))
    ...
    def register_static_path(
        ...
        self.app["add_cors"](self.app.router.add_route("GET", url_path, serve_file))
