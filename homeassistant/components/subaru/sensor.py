...
from homeassistant.util.unit_system import BaseUnitSystem, LENGTH_UNITS, PRESSURE_UNITS
...
class SubaruSensor(
    ...
    def native_value(self) -> None | int | float:
        ...
        if (
            unit in PRESSURE_UNITS
            and unit_system.base_unit_system == BaseUnitSystem.US_CUSTOMARY
        ):
            return round(
