...
SENSOR_TYPES_BASE: tuple[SolvisMaxSensorEntityDescription, ...] = (
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_buffer_top",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_buffer_reference",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_buffer_heating_top",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_buffer_heating_bottom",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_heating_circuit_1_flow",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_heating_circuit_2_flow",
...
SENSOR_TYPES_WARMWATER: tuple[SolvisMaxSensorEntityDescription, ...] = (
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_warm_water_station",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_circulation",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="volume_stream_warm_water",
...
SENSOR_TYPES_SOLAR: tuple[SolvisMaxSensorEntityDescription, ...] = (
    SolvisMaxSensorEntityDescription(
        key="temperature_solar_flow",
        translation_key="temperature_solar_flow",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_solar_panel",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_solar_return",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="temperature_solar_diff_flow_return",
    ...
    SolvisMaxSensorEntityDescription(
        key="solar_pressure",
        translation_key="solar_pressure",
        name="solar pressure",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="volume_stream_solar",
    ...
    SolvisMaxSensorEntityDescription(
        ...
        translation_key="runtime_solar_pump",
...
SENSOR_TYPES_SOLAR_EAST_WEST = SolvisMaxSensorEntityDescription(
    key="temperature_solar_panel2",
    translation_key="temperature_solar_panel2",
    name="temperature solar panel2",
    native_unit_of_measurement=UnitOfTemperature.CELSIUS,
    device_class=SensorDeviceClass.TEMPERATURE,
    state_class=SensorStateClass.MEASUREMENT,
)

SENSOR_TYPES_OVEN = SolvisMaxSensorEntityDescription(
    key="temperature_oven",
    translation_key="temperature_oven",
    name="temperature oven",
    native_unit_of_measurement=UnitOfTemperature.CELSIUS,
    device_class=SensorDeviceClass.TEMPERATURE,
    state_class=SensorStateClass.MEASUREMENT,
)
