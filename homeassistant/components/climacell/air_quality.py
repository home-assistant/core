...
class ClimaCellAirQualityEntity(ClimaCellEntity, AirQualityEntity):
    ...
    def particulate_matter_2_5(self):
        ...
        return self._get_cc_value(self.coordinator.data[CURRENT], CC_ATTR_PM_2_5)

    @property
    def particulate_matter_10(self):
        """Return the particulate matter 10 level."""
        return self._get_cc_value(self.coordinator.data[CURRENT], CC_ATTR_PM_10)
    ...
    def carbon_monoxide(self):
        ...
        return self._get_cc_value(
            self.coordinator.data[CURRENT], CC_ATTR_CARBON_MONOXIDE
        )
    ...
    def sulphur_dioxide(self):
        ...
        return self._get_cc_value(
            self.coordinator.data[CURRENT], CC_ATTR_SULPHUR_DIOXIDE
        )
    ...
    def nitrogen_dioxide(self):
        ...
        return self._get_cc_value(
            self.coordinator.data[CURRENT], CC_ATTR_NITROGEN_DIOXIDE
        )
