"""Configurations Flow for Click Send TTS."""
...
from homeassistant.const import CONF_API_KEY, CONF_RECIPIENT, CONF_USERNAME
...
class ClickSendConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Clicksend TTS Custom config flow."""
    ...
    async def async_step_user(
        ...
        """Clicksend TTS User Config Flow Step Handler."""
        errors: dict[str, str] = {}
