...
# from roborock.exceptions import SnooException
...
# from .const import
# from . import DOMAIN, SnooConfigEntry
# from .coordinator import SnooDataUpdateCoordinator
# from .entity import SnooEntityV1

# _LOGGER = logging.getLogger(__name__)


# @dataclass(frozen=True, kw_only=True)
# class SnooSwitchDescription(SwitchEntityDescription):
#     """Class to describe a Snoo switch entity."""
...
# SWITCH_DESCRIPTIONS: list[SnooSwitchDescription] = [
#     SnooSwitchDescription(
...
# ) -> None:
#     """Set up Snoo switch platform."""
#     possible_entities: list[
#         tuple[SnooDataUpdateCoordinator, SnooSwitchDescription]
#     ] = [
...
#     )
#     valid_entities: list[SnooSwitch] = []
...
# class SnooSwitch(SnooEntityV1, SwitchEntity):
#     """A class to let you turn functionality on Snoo devices on and off that does need a coordinator."""

#     entity_description: SnooSwitchDescription

#     def __init__(
#         self,
#         unique_id: str,
#         coordinator: SnooDataUpdateCoordinator,
#         entity_description: SnooSwitchDescription,
#     ) -> None:
