...
LOG_DIAPER_CHANGE_SCHEMA = vol.Schema(
    {
        ...
        vol.Required("diaper_types"): vol.All(cv.ensure_list, [vol.In(["pee", "poo"])]),
...
async def _async_log_diaper_change(call: ServiceCall) -> None:
    ...
    await baby.log_diaper_change(
        call.data["diaper_types"],
