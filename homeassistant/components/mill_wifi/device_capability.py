...
DEVICE_CAPABILITY_MAP: dict[EDeviceType, set[EDeviceCapability]] = {
    ...
    EDeviceType.SOCKET_GEN3: {
        ...
        EDeviceCapability.TARGET_TEMPERATURE,
        EDeviceCapability.MEASURE_TEMPERATURE,
        EDeviceCapability.MEASURE_HUMIDITY,
        EDeviceCapability.INDIVIDUAL_CONTROL,
        EDeviceCapability.CHILD_LOCK,
        EDeviceCapability.OPEN_WINDOW,
        EDeviceCapability.PREDICTIVE_HEATING,
    ...
    EDeviceType.SOCKET_GEN4: {
        ...
        EDeviceCapability.OPEN_WINDOW,
        EDeviceCapability.PREDICTIVE_HEATING,
        EDeviceCapability.COOLING_MODE,
        EDeviceCapability.MEASURE_DAILY_POWER,
        EDeviceCapability.MEASURE_POWER,
        EDeviceCapability.MEASURE_TEMPERATURE_VIRTUAL,
    },
    EDeviceType.SENSE: {
        EDeviceCapability.MEASURE_TEMPERATURE,
        EDeviceCapability.MEASURE_HUMIDITY,
        EDeviceCapability.MEASURE_CO2,
        EDeviceCapability.MEASURE_TVOC,
        EDeviceCapability.MEASURE_BATTERY,
    },
    ...
    EDeviceType.PANEL_HEATER_GEN3: {
        ...
        EDeviceCapability.INDIVIDUAL_CONTROL,
        EDeviceCapability.CHILD_LOCK,
        EDeviceCapability.COMMERCIAL_LOCK,
        EDeviceCapability.OPEN_WINDOW,
        EDeviceCapability.PREDICTIVE_HEATING,
        EDeviceCapability.ADJUST_WATTAGE,
        EDeviceCapability.PID_CONTROLLER,
        EDeviceCapability.SLOW_PID,
        EDeviceCapability.MEASURE_DAILY_POWER,
        EDeviceCapability.MEASURE_POWER,
    },
    ...
    EDeviceType.OIL_HEATER_GEN3: {
        ...
        EDeviceCapability.OPEN_WINDOW,
        EDeviceCapability.PREDICTIVE_HEATING,
        EDeviceCapability.MEASURE_WATTAGE,
        EDeviceCapability.MEASURE_DAILY_POWER,
        EDeviceCapability.MEASURE_POWER,
    },
    ...
    EDeviceType.AIR_PURIFIER_M: {
        ...
        EDeviceCapability.MEASURE_HUMIDITY,
        EDeviceCapability.CHILD_LOCK,
        EDeviceCapability.MEASURE_PM1,
        EDeviceCapability.MEASURE_PM25,
        EDeviceCapability.MEASURE_PM10,
        EDeviceCapability.MEASURE_DAILY_POWER,
        EDeviceCapability.MEASURE_POWER,
    ...
    EDeviceType.HEATPUMP: {
        ...
        EDeviceCapability.TARGET_TEMPERATURE,
        EDeviceCapability.MEASURE_DAILY_POWER,
        EDeviceCapability.GREE_MODE,
        EDeviceCapability.GREE_FAN_SPEED_MODE,
        EDeviceCapability.GREE_FAN_SPEED,
        EDeviceCapability.GREE_SWEEPING_ANGLE_VERTICAL,
        EDeviceCapability.GREE_SWEEPING_ANGLE_HORIZONTAL,
        EDeviceCapability.GREE_DISPLAY_LIGHT,
    },
