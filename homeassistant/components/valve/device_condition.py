"""Provides device automations for Valve."""
...
POSITION_CONDITION_TYPES = {"is_position"}
...
async def async_get_conditions(
    ...
    """List device conditions for Valve devices."""
...
async def async_get_condition_capabilities(
    ...
    if config[CONF_TYPE] not in ["is_position"]:
        return {}
