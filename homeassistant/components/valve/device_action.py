...
CMD_ACTION_TYPES = {"open", "close", "stop"}
POSITION_ACTION_TYPES = {"set_position"}
...
async def async_get_actions(
    ...
    """List device actions for Valve devices."""
...
async def async_call_action_from_config(
    ...
    if config[CONF_TYPE] == "open":
        ...
        service = SERVICE_STOP_VALVE
    elif config[CONF_TYPE] == "set_position":
        service = SERVICE_SET_VALVE_POSITION
