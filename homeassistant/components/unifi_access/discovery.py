"""The UniFi Access integration discovery."""
...
def async_start_discovery(hass: HomeAssistant) -> None:
    ...
    def _async_start_background_discovery(*_: Any) -> None:
        ...
        hass.async_create_background_task(_async_discovery(), "unifi_access-discovery")
...
def async_trigger_discovery(
    ...
    for device in discovered_devices:
        if device.services[UnifiService.Access] and device.hw_addr:
