...
OWM_MODES = {
    OWM_MODE_V30: "One Call API 3.0",
    OWM_MODE_FREE_CURRENT: "Current Weather API",
    OWM_MODE_FREE_FORECAST: "Hourly Forecast Weather API",
    OWM_MODE_AIRPOLLUTION: "Air Pollution API",
}
