...
from .const import CONFIG_FLOW_VERSION, OWM_MODE_AIRPOLLUTION, OWM_MODE_V25, PLATFORMS
from .coordinator import AirPollutionUpdateCoordinator, WeatherUpdateCoordinator
...
async def async_setup_entry(
    ...
    owm_coordinator: DataUpdateCoordinator
    if mode == OWM_MODE_AIRPOLLUTION:
        owm_coordinator = AirPollutionUpdateCoordinator(hass, entry, owm_client)
    else:
        owm_coordinator = WeatherUpdateCoordinator(hass, entry, owm_client)
