    ...
    for sensor_type in MONITORED_CONDITIONS:
        ...
        entities.append(
            OpenWeatherMapSensor(
                name, unique_id, sensor_type, sensor_types, weather_coordinator,
            )
        )

    for sensor_type in FORECAST_MONITORED_CONDITIONS:
        unique_id = f"{config_entry.unique_id}-forecast-{sensor_type.lower()}"
        entities.append(
...
class OpenWeatherMapForecastSensor(AbstractOpenWeatherMapSensor):
    ...
    def __init__(
        ...
        """Initialize the sensor."""
        super().__init__(
            name, unique_id, sensor_type, sensor_types, forecast_coordinator
        )
