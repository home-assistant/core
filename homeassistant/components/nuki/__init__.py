...
NUKI_COMPONENTS = ["lock", "binary_sensor"]
...
CONFIG_SCHEMA = vol.Schema(
    {DOMAIN: vol.Schema(vol.All(cv.ensure_list, [NUKI_SCHEMA]))},
...
async def async_setup_entry(hass, entry):
    ...
    try:
        ...
        locks = await hass.async_add_executor_job(bridge._get_devices, 0)
        openers = await hass.async_add_executor_job(bridge._get_devices, 2)
    ...
    for component in NUKI_COMPONENTS:
        hass.async_create_task(
