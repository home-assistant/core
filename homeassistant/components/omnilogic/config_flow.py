...
from .const import CONF_SCAN_INTERVAL, DEFAULT_SCAN_INTERVAL, DEFAULT_PH_OFFSET, DOMAIN  # pylint:disable=unused-import
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        "ph_offset",
                        default=self.config_entry.options.get("ph_offset", DEFAULT_PH_OFFSET),
