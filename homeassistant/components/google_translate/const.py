...
# 
# Removal:
# Removal is as simple as deleting the line containing the language code no longer supported. 
# 
# Addition:
# In order to add to this list, follow the below steps:
# 1. Find out if the language is supported: Go to Google Translate website and try translating any word from English into your desired language. 
#     If the "speech" icon is grayed out or no speech is generated, the language is not supported and cannot be added. Otherwise, proceed:
# 2. Grab the language code from https://cloud.google.com/translate/docs/languages
# 3. Add the language code in SUPPORT_LANGUAGES, making sure to not disturb the alphabetical nature of the list.  
