...
class PowersensorConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_reconfigure(
        ...
        for sensor_mac in dispatcher.sensors:
            ...
            descrption_placeholders[sensor_name] = sensor_name

        descrption_placeholders["device_count"] = str(len(sensor_roles))
        descrption_placeholders["docs_url"] = (
