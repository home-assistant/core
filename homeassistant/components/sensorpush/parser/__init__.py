...
def parse_sensorpush_from_discovery_data(
    local_name: str, manufacturer_data: dict[int, bytes]
) -> dict[str, Any] | None:
    """Parse SensorPush BLE advertisement data."""
    _LOGGER.debug("Parsing SensorPush BLE advertisement data: %s", manufacturer_data)
