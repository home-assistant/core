...
from homeassistant.components.sensor import DEVICE_CLASS_POWER, DEVICE_CLASS_TEMPERATURE, SensorEntity
...
class ScreenLogicSensor(SensorEntity, ScreenlogicEntity):
...
class ScreenLogicPumpSensor(SensorEntity, ScreenlogicEntity):
