...
MODEL_AIRPURIFIER_ELITE/Y600 = "zhimi.airp.meb1"
...
FEATURE_FLAGS_MODEL_AIRPURIFIER_ELITE/Y600 = ( #I guessed this entries. How to find out?
    FEATURE_SET_FAN_LEVEL
    | FEATURE_SET_LED_BRIGHTNESS
    | FEATURE_SET_ANION
    | FEATURE_RESET_FILTER
