...
SENSOR_TYPES: tuple[YoLinkSensorEntityDescription, ...] = (
    ...
    YoLinkSensorEntityDescription(
        ...
        value=lambda value: value.get("humidity") if value is not None else None,
        should_update_entity=lambda value: value is not None,
    ),
    YoLinkSensorEntityDescription(
        key="temperature",
