"""Config flow to configure the Meppel Afvalkalender integration."""
...
class MeppelAfvalkalenderFlowHandler(ConfigFlow):
    """Handle a Meppel Afvalkalender config flow."""
    ...
    async def async_step_user(self, user_input=None):
        ...
        try:
            unique_id = await meppel_afvalkalender.unique_id()
        except MeppelAfvalkalenderConnectionError:
            errors["base"] = "cannot_connect"
            return await self._show_setup_form(errors)
        except MeppelAfvalkalenderAddressError:
