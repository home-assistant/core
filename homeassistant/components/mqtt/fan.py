...
PLATFORM_SCHEMA = vol.All(
    ...
    cv.deprecated(CONF_PAYLOAD_HIGH_SPEED, fail=True),
    cv.deprecated(CONF_PAYLOAD_LOW_SPEED, fail=True),
    cv.deprecated(CONF_PAYLOAD_MEDIUM_SPEED, fail=True),
    cv.deprecated(CONF_SPEED_COMMAND_TOPIC, fail=True),
    cv.deprecated(CONF_SPEED_LIST, fail=True),
    cv.deprecated(CONF_SPEED_STATE_TOPIC, fail=True),
    cv.deprecated(CONF_SPEED_VALUE_TEMPLATE, fail=True),
