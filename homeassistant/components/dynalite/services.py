...
_SERVICES = {
    SERVICE_REQUEST_AREA_PRESET: vol.Schema(
        {
    ...
    SERVICE_REQUEST_CHANNEL_LEVEL: vol.Schema(
        {
            vol.Optional(ATTR_HOST): cv.string,
            vol.Required(ATTR_AREA): int,
...
def setup_services(hass: HomeAssistant) -> None:
    ...
    for service_name, service_schema in _SERVICES.items():
        hass.services.async_register(
            DOMAIN, service_name, _run_dynalite_service_call, service_schema
        )
