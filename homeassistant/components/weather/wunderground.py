...
CONDITION_CLASSES = {
    ...
    'fog': [
        ...
        'Shallow Fog',
        'Partial Fog',
        'Fog', 'Light Fog', 'Heavy Fog',
        'Fog Patches', 'Light Fog Patches', 'Heavy Fog Patches',
        'Mist', 'Light Mist', 'Heavy Mist',
        'Rain Mist', 'Light Rain Mist', 'Heavy Rain Mist'
        'Freezing Fog', 'Light Freezing Fog', 'Heavy Freezing Fog',
    ],
    'hail': [
        'Hail', 'Light Hail', 'Heavy Hail',
        'Small Hail',
        'Hail Showers', 'Light Hail Showers', 'Heavy Hail Showers',
        'Small Hail Showers', 'Light Small Hail Showers', 'Heavy Small Hail Showers'
    ],
    'lightning': [
    ...
    'lightning-rainy': [
        ...
        'Thunderstorms and Snow', 'Light Thunderstorms and Snow', 'Heavy Thunderstorms and Snow',
        'Thunderstorms and Ice Pellets', 'Light Thunderstorms and Ice Pellets', 'Heavy Thunderstorms and Ice Pellets',
        'Thunderstorms with Hail', 'Light Thunderstorms with Hail', 'Heavy Thunderstorms with Hail',
        'Thunderstorms with Small Hail', 'Light Thunderstorms with Small Hail', 'Heavy Thunderstorms with Small Hail'
    ],
    'partlycloudy': [
        'Partly Cloudy',
        'Scattered Clouds'
    ...
    'rainy': [
        ...
        'Rain', 'Light Rain',
        'Rain Showers', 'Light Rain Showers',
    ...
    'snowy': [
        ...
        'Snow Showers', 'Light Snow Showers', 'Heavy Snow Showers',
        'Blowing Snow', 'Light Blowing Snow', 'Heavy Blowing Snow'
    ],
    'snowy-rainy': [
        'Snow Grains', 'Light Snow Grains', 'Heavy Snow Grains',
        'Ice Crystals', 'Light Ice Crystals', 'Heavy Ice Crystals',
        'Ice Pellets', 'Light Ice Pellets', 'Heavy Ice Pellets',
        'Ice Pellet Showers', 'Light Ice Pellet Showers', 'Heavy Ice Pellet Showers',
    ],
    'sunny': [
        'Clear'
    ],
    'windy': [
        'Blowing Sand', 'Light Blowing Sand', 'Heavy Blowing Sand',
        'Blowing Widespread Dust', 'Light Blowing Widespread Dust', 'Heavy Blowing Widespread Dust',
        'Low Drifting Snow', 'Light Low Drifting Snow', 'Heavy Low Drifting Snow',
        'Low Drifting Widespread Dust', 'Light Low Drifting Widespread Dust', 'Heavy Low Drifting Widespread Dust',
        'Low Drifting Sand', 'Light Low Drifting Sand', 'Heavy Low Drifting Sand'
    ],
    'windy-variant': [
        'Snow Blowing Snow Mist', 'Light Snow Blowing Snow Mist', 'Heavy Snow Blowing Snow Mist',
        'Squalls',
        'Spray', 'Light Spray', 'Heavy Spray'
    ],
    'exceptional': [
        'Funnel Cloud',
        'Smoke', 'Light Smoke', 'Heavy Smoke',
        'Volcanic Ash', 'Light Volcanic Ash', 'Heavy Volcanic Ash',
        'Widespread Dust', 'Light Widespread Dust', 'Heavy Widespread Dust',
        'Sand', 'Light Sand', 'Heavy Sand',
        'Haze', 'Light Haze', 'Heavy Haze',
        'Dust Whirls', 'Light Dust Whirls', 'Heavy Dust Whirls',
        'Sandstorm', 'Light Sandstorm', 'Heavy Sandstorm',
    ],
}
