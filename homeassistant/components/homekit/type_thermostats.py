...
from .const import (
    ACC_THERMOSTAT, CHAR_COOLING_THRESHOLD_TEMPERATURE,
    CHAR_CURRENT_HEATING_COOLING, CHAR_CURRENT_TEMPERATURE,
    CHAR_TARGET_HEATING_COOLING, CHAR_HEATING_THRESHOLD_TEMPERATURE,
    CHAR_TARGET_TEMPERATURE, CHAR_TEMP_DISPLAY_UNITS, PROP_MAX_VALUE,
