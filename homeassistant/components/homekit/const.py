...
# #### Accessory Types
ACC_AIR_QUALITY_SENSOR = 'AirQualitySensor'
ACC_BINARY_SENSOR = 'BinarySensor'
ACC_CARBON_DIOXIDE_SENSOR = 'CarbonDioxideSensor'
ACC_FAN = 'Fan'
ACC_GARAGE_DOOR_OPENER = 'GarageDoorOpener'
ACC_HUMIDITY_SENSOR = 'HumiditySensor'
ACC_LIGHT = 'Light'
ACC_LIGHT_SENSOR = 'LightSensor'
ACC_LOCK = 'Lock'
ACC_MEDIA_PLAYER = 'MediaPlayer'
ACC_OUTLET = 'Outlet'
ACC_SECURITY_SYSTEM = 'SecuritySystem'
ACC_SWITCH = 'Switch'
ACC_TEMPERATURE_SENSOR = 'TemperatureSensor'
ACC_THERMOSTAT = 'Thermostat'
ACC_WINDOW_COVERING = 'WindowCovering'
ACC_WINDOW_COVERING_BASIC = 'WindowCoveringBasic'
