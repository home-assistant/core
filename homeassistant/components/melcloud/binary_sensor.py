...
ATW_BINARY_SENSORS: tuple[MelcloudBinarySensorEntityDescription, ...] = (
    MelcloudBinarySensorEntityDescription(
        ...
        value_fn=lambda x: x.device.boiler_status,
        enabled=lambda x: x.device.boiler_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        device_class=BinarySensorDeviceClass.RUNNING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda x: x.device.booster_heater1_status,
        enabled=lambda x: x.device.booster_heater1_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        value_fn=lambda x: x.device.booster_heater2_status,
        enabled=lambda x: x.device.booster_heater2_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.booster_heater2plus_status,
        enabled=lambda x: x.device.booster_heater2plus_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        device_class=BinarySensorDeviceClass.RUNNING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda x: x.device.immersion_heater_status,
        enabled=lambda x: x.device.immersion_heater_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        device_class=BinarySensorDeviceClass.RUNNING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda x: x.device.water_pump1_status,
        enabled=lambda x: x.device.water_pump1_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        device_class=BinarySensorDeviceClass.RUNNING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda x: x.device.water_pump2_status,
        enabled=lambda x: x.device.water_pump2_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.water_pump3_status,
        enabled=lambda x: x.device.water_pump3_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.water_pump4_status,
        enabled=lambda x: x.device.water_pump4_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        key="valve_3way_status",
        translation_key="valve_3way_status",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda x: x.device.valve_3way_status,
        enabled=lambda x: x.device.valve_3way_status is not None,
    ),
    MelcloudBinarySensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.valve_2way_status,
        enabled=lambda x: x.device.valve_2way_status is not None,
    ),
)
