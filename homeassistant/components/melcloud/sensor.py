...
ATW_SENSORS: tuple[MelcloudSensorEntityDescription, ...] = (
    ...
    MelcloudSensorEntityDescription(
        ...
        value_fn=lambda x: x.device.flow_temperature,
        enabled=lambda x: x.device.flow_temperature is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda x: x.device.return_temperature,
        enabled=lambda x: x.device.return_temperature is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        enabled=lambda x: x.device.flow_temperature_boiler is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        enabled=lambda x: x.device.return_temperature_boiler is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        enabled=lambda x: x.device.mixing_tank_temperature is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda x: x.device.condensing_temperature,
        enabled=lambda x: True,
    ),
    MelcloudSensorEntityDescription(
        key="fan_frequency",
        ...
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda x: x.device.heat_pump_frequency,
        enabled=lambda x: True,
    ),
    MelcloudSensorEntityDescription(
        ...
        value_fn=lambda x: x.device.demand_percentage,
        enabled=lambda x: x.device.demand_percentage is not None,
    ),
    MelcloudSensorEntityDescription(
        key="rssi",
    ...
    MelcloudSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=1,
        value_fn=lambda x: x.device.daily_heating_energy_consumed,
        enabled=lambda x: x.device.daily_heating_energy_consumed is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.daily_heating_energy_produced,
        enabled=lambda x: x.device.daily_heating_energy_produced is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.daily_cooling_energy_consumed,
        enabled=lambda x: x.device.daily_cooling_energy_consumed is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.daily_cooling_energy_produced,
        enabled=lambda x: x.device.daily_cooling_energy_produced is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=1,
        value_fn=lambda x: x.device.daily_hot_water_energy_consumed,
        enabled=lambda x: x.device.daily_hot_water_energy_consumed is not None,
    ),
    MelcloudSensorEntityDescription(
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda x: x.device.daily_hot_water_energy_produced,
        enabled=lambda x: x.device.daily_hot_water_energy_produced is not None,
    ),
)
