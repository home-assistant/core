...
from . import BresserConfigEntry
from .coordinator import BresserCoordinator
from .entity import BresserEntity

PARALLEL_UPDATES = 0

BRESSER_SENSOR_DESCRIPTIONS: dict[str, SensorEntityDescription] = {
...
async def async_setup_entry(
    ...
    def _new_sensor(sensor: CCLSensor) -> None:
        ...
        entity_description = dataclasses.replace(
            BRESSER_SENSOR_DESCRIPTIONS[sensor.sensor_type],
            key=sensor.key,
            name=sensor.name,
        )
        async_add_entities([BresserSensorEntity(coordinator, entity_description)])
...
class BresserSensorEntity(BresserEntity, SensorEntity):
    ...
    def __init__(
        ...
        """Initialize a Bresser Sensor Entity."""
