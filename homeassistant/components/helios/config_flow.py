"""Config flow for the Helios integration."""
...
from helios_websocket_api import Helios, HeliosApiException
...
class HeliosConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for the Helios integration."""
    ...
    async def async_step_reconfigure(
        ...
        """Handle reconfiguration of the Helios device host address."""
