"""Support for Helios date platform."""
...
class HeliosFilterChangeDateEntity(HeliosEntity, DateEntity):
    """Representation of a Helios filter change date entity."""
...
async def async_setup_entry(
    ...
    """Set up Helios filter change date entity."""

    data = hass.data[DOMAIN][entry.entry_id]

    async_add_entities(
        [
            HeliosFilterChangeDateEntity(
