...
def setup_platform(hass, config, add_devices_callback, discovery_info=None):
    ...
    if switches:
        ...
        for switch in switches:
            ...
            name = (switch[CONF_NAME] if CONF_NAME in switch
                    else "ihc_" + str(ihcid))
...
def add_switch_from_node(devices, ihccontroller, ihcid: int, name: str,
                         product) -> IHCSwitch:
    ...
    return add_switch(devices, ihccontroller, ihcid, name, False, ihcname,
                      ihcnote, ihcposition)
