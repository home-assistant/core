...
SENSOR_TYPES: dict[str, DarkskySensorEntityDescription] = {
    ...
    "precip_intensity": DarkskySensorEntityDescription(
        ...
        si_unit=PRECIPITATION_INTENSITY_MILLIMETERS_PER_HOUR,
        us_unit=PRECIPITATION_INTENSITY_INCHES_PER_HOUR,
        ca_unit=PRECIPITATION_INTENSITY_MILLIMETERS_PER_HOUR,
        uk_unit=PRECIPITATION_INTENSITY_MILLIMETERS_PER_HOUR,
        uk2_unit=PRECIPITATION_INTENSITY_MILLIMETERS_PER_HOUR,
