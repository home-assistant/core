...
DEFINITIONS = {
    ...
    "dsmr/current-month/electricity1": {
        "name": "Current month low tarrif usage",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    "dsmr/current-month/electricity2": {
        "name": "Current month high tarrif usage",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    "dsmr/current-month/electricity1_returned": {
        "name": "Current month low tarrif returned",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    "dsmr/current-month/electricity2_returned": {
        "name": "Current month high taffif returned",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    ...
    "dsmr/current-month/electricity1_cost": {
        "name": "Current month low tarrif cost",
        "enable_default": True,
        "icon": "mdi:currency-eur",
        "unit": CURRENCY_EURO,
    },
    "dsmr/current-month/electricity2_cost": {
        "name": "Current month high tarrif cost",
        "enable_default": True,
        "icon": "mdi:currency-eur",
        "unit": CURRENCY_EURO,
    },
    ...
    "dsmr/current-year/electricity1": {
        "name": "Current year low taffif usage",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    "dsmr/current-year/electricity2": {
        "name": "Current year high taffif usage",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
    "dsmr/current-year/electricity1_returned": {
        "name": "Current year low taffif returned",
        "enable_default": True,
        "device_class": DEVICE_CLASS_ENERGY,
        "unit": ENERGY_KILO_WATT_HOUR,
    },
