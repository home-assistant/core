...
class WeatherSchema:
    ...
    CONF_SYNC_STATE = CONF_SYNC_STATE
    CONF_KNX_TEMPERATURE_ADDRESS = "group_address_temperature"
    CONF_KNX_BRIGHTNESS_SOUTH_ADDRESS = "group_address_brightness_south"
    CONF_KNX_BRIGHTNESS_EAST_ADDRESS = "group_address_brightness_east"
    CONF_KNX_BRIGHTNESS_WEST_ADDRESS = "group_address_brightness_west"
    CONF_KNX_WIND_SPEED_ADDRESS = "group_address_wind_speed"
    CONF_KNX_RAIN_ALARM_ADDRESS = "group_address_rain_alarm"
    CONF_KNX_FROST_ALARM_ADDRESS = "group_address_frost_alarm"
    CONF_KNX_WIND_ALARM_ADDRESS = "group_address_wind_alarm"
    CONF_KNX_DAY_NIGHT_ADDRESS = "group_address_day_night"
    CONF_KNX_AIR_PRESSURE_ADDRESS = "group_address_air_pressure"
    CONF_KNX_HUMIDITY_ADDRESS = "group_address_humidity"
