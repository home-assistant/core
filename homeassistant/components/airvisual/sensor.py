...
NODE_PRO_SENSORS = [
    (SENSOR_KIND_BATTERY_LEVEL, "Battery", "battery", UNIT_PERCENTAGE),
    (SENSOR_KIND_HUMIDITY, "Humidity", "humidity", UNIT_PERCENTAGE),
    (SENSOR_KIND_TEMPERATURE, "Temperature", "temperature", TEMP_CELSIUS),
]
