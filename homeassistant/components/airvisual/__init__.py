...
@callback
def _standardize_geography_entry(hass, entry):
...
@callback
def _standardize_node_pro_entry(hass, entry):
...
async def async_setup_entry(hass, entry):
    ...
    if CONF_API_KEY in entry.data:
        _standardize_geography_entry(hass, entry)
        ...
        _standardize_node_pro_entry(hass, entry)
