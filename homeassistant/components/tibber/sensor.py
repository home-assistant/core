...
class TibberDataSensor(TibberSensor, CoordinatorEntity[TibberDataCoordinator]):
    ...
    def native_value(self) -> StateType:
        ...
        if self.entity_description.key == "base_electricity_price":
            return self._tibber_home.current_price_info()["energy"]  # type: ignore[no-any-return]
...
class TibberSensorRT(TibberSensor, CoordinatorEntity["TibberRtDataCoordinator"]):
    ...
    def available(self) -> bool:
        ...
        return self._tibber_home.rt_subscription_running  # type: ignore[no-any-return]
