...
SERVICE_VACUUM_CLEAN_ZONE = "Vacuum clean zone"
SERVICE_VACUUM_CLEAN_SEGMENT = "Vacuum clean segment"
SERVICE_VACUUM_SET_MOP_MODE = "Vacuum set mop mode"
SERVICE_VACUUM_SET_MOP_INTENSITY = "Vacuum set mop intensity"
SERVICE_VACUUM_SET_FAN_SPEED = "Vacuum set fan speed"
SERVICE_VACUUM_RESET_CONSUMABLES = "Vacuum reset consumables"
