...
SERVICES = [
    {"schema" : CHANGE_CONTROL_TYPE_SCHEMA, "service" : "change_control_type", "service_func_name" : "change_control_type"}
]
...
async def async_setup_services(hass: HomeAssistant) -> None:
    ...
    async def change_control_type(call : ServiceCall):
        ...
        hass.states.async_set(f"{DOMAIN}.cem", json.dumps({"control_type": str(cem._control_type)})) # TODO: expose control type as public property
