...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    await integration_platform.async_process_integration_platforms(
        hass, DOMAIN, _register_actions_platform
    )
