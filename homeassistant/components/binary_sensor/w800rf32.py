...
from homeassistant.components.w800rf32 import (
    DOMAIN, CONF_FIRE_EVENT, CONF_OFF_DELAY)
...
DEVICE_TYPE = 'W800rf32BinarySensor'
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    def binary_sensor_update(event):
        ...
        if dev_id in hass.data[DOMAIN]['entities']:
            sensor = hass.data[DOMAIN]['entities'][dev_id]
    ...
    dispatcher_connect(hass, DEVICE_TYPE, binary_sensor_update)


class W800rf32BinarySensor(BinarySensorDevice):
    """A representation of a w800rf32 binary sensor."""

    def __init__(self, device_id, name, device_class=None,
