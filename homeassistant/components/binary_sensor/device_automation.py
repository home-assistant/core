...
CONF_IS_PRESCENT = "is_prescent"
CONF_IS_NOT_PRESCENT = "is_not_prescent"
...
CONF_PRESCENT = "prescent"
CONF_NOT_PRESCENT = "not_prescent"
...
ENTITY_CONDITIONS = {
    ...
    DEVICE_CLASS_PRESENCE: [
        {CONF_TYPE: CONF_IS_PRESCENT},
        {CONF_TYPE: CONF_IS_NOT_PRESCENT},
    ],
    DEVICE_CLASS_PROBLEM: [
...
ENTITY_TRIGGERS = {
    ...
    DEVICE_CLASS_PRESENCE: [{CONF_TYPE: CONF_PRESCENT}, {CONF_TYPE: CONF_NOT_PRESCENT}],
