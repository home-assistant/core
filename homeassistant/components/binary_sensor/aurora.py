...
https://home-assistant.io/components/sensor.aurora/
"""
import logging
...
# number 0-100. Higher = more probability of visible lights
VISIBILITY_CUTOFF = 75
...
class AuroraSensor(BinarySensorDevice):
    ...
    # def state(self):
    #     """Return true if aurora is visible."""
    #     return "visible" if self.is_on else "not visible"
...
class AuroraData(object):
    ...
    def update(self):
        ...
        try:
            ...
            if int(self.visibility_level) > VISIBILITY_CUTOFF:
