...
MODEL_SCHEMA_MAP = {
    ("P", "2"): PICO_REMOTE_2_TRIGGER_SCHEMA,  # PJ2-2B-GXX-X01
    ("P", "3"): PICO_REMOTE_3_TRIGGER_SCHEMA,  # PJ2-3BRL-GXX-X01
    ("P", "4"): PICO_REMOTE_4_TRIGGER_SCHEMA,  # PJ2-4B-GXX-X21
    ("C", "Y"): SHADE_REMOTE_TRIGGER_SCHEMA,  # CS-YJ-4GC-WH
}


MODEL_SUBTYPE_MAP = {
    ("P", "2"): PICO_REMOTE_2_BUTTON_TYPES,  # PJ2-2B-GXX-X01
    ("P", "3"): PICO_REMOTE_3_BUTTON_TYPES,  # PJ2-3BRL-GXX-X01
    ("P", "4"): PICO_REMOTE_4_BUTTON_TYPES,  # PJ2-4B-GXX-X21
