...
PICO_REMOTE_2_MODELS = ("P", "2")
PICO_REMOTE_3_MODELS = ("P", "3")
PICO_REMOTE_4_MODELS = ("P", "4")
SHADE_REMOTE_MODELS = ("C", "Y")

MODEL_SCHEMA_MAP = {
    PICO_REMOTE_2_MODELS: PICO_REMOTE_2_TRIGGER_SCHEMA,  # PJ2-2B-GXX-X01
    PICO_REMOTE_3_MODELS: PICO_REMOTE_3_TRIGGER_SCHEMA,  # PJ2-3BRL-GXX-X01
    PICO_REMOTE_4_MODELS: PICO_REMOTE_4_TRIGGER_SCHEMA,  # PJ2-4B-GXX-X21
    SHADE_REMOTE_MODELS: SHADE_REMOTE_TRIGGER_SCHEMA,  # CS-YJ-4GC-WH
}


MODEL_SUBTYPE_MAP = {
    PICO_REMOTE_2_MODELS: PICO_REMOTE_2_BUTTON_TYPES,  # PJ2-2B-GXX-X01
    PICO_REMOTE_3_MODELS: PICO_REMOTE_3_BUTTON_TYPES,  # PJ2-3BRL-GXX-X01
    PICO_REMOTE_4_MODELS: PICO_REMOTE_4_BUTTON_TYPES,  # PJ2-4B-GXX-X21
    SHADE_REMOTE_MODELS: SHADE_REMOTE_BUTTON_TYPES,  # CS-YJ-4GC-WH
}
