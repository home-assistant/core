...
SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES_TO_LIP = {
    "button_1": 1,
    "button_2": 2,
}
...
LEAP_TO_SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES = {
    v: k for k, v in SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES_TO_LEAP.items()
}
SUNNATA_KEYPAD_2_BUTTON_TRIGGER_SCHEMA = LUTRON_BUTTON_TRIGGER_SCHEMA.extend(
    {
        vol.Required(CONF_SUBTYPE): vol.In(SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES_TO_LIP),
    }
)

SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_BUTTON_TYPES_TO_LIP = {
    "button_1": 1,
    "button_2": 2,
    "button_3": 3,
    "raise": 19,
...
LEAP_TO_SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_BUTTON_TYPES = {
    v: k for k, v in SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_BUTTON_TYPES_TO_LEAP.items()
}
...
SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES_TO_LIP = {
    "button_1": 1,
    "button_2": 2,
    "button_3": 3,
    "button_4": 4,
...
LEAP_TO_SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES = {
    v: k for k, v in SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES_TO_LEAP.items()
}
SUNNATA_KEYPAD_4_BUTTON_TRIGGER_SCHEMA = LUTRON_BUTTON_TRIGGER_SCHEMA.extend(
    {
        vol.Required(CONF_SUBTYPE): vol.In(SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES_TO_LIP),
    }
)
...
DEVICE_TYPE_SCHEMA_MAP = {
    ...
    "SunnataKeypad2Button": SUNNATA_KEYPAD_2_BUTTON_TRIGGER_SCHEMA,
    "SunnataKeypad3ButtonRaiseLower": SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_TRIGGER_SCHEMA,
    "SunnataKeypad4Button": SUNNATA_KEYPAD_4_BUTTON_TRIGGER_SCHEMA,
}
...
DEVICE_TYPE_SUBTYPE_MAP_TO_LIP = {
    ...
    "SunnataKeypad_2Button": SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES_TO_LIP,
    "SunnataKeypad_3ButtonRaiseLower": SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_BUTTON_TYPES_TO_LIP,
    "SunnataKeypad_4Button": SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES_TO_LIP,
}
...
LEAP_TO_DEVICE_TYPE_SUBTYPE_MAP = {
    ...
    "SunnataKeypad_2Button": LEAP_TO_SUNNATA_KEYPAD_2_BUTTON_BUTTON_TYPES,
    "SunnataKeypad_3ButtonRaiseLower": LEAP_TO_SUNNATA_KEYPAD_3_BUTTON_RAISE_LOWER_BUTTON_TYPES,
    "SunnataKeypad_4Button": LEAP_TO_SUNNATA_KEYPAD_4_BUTTON_BUTTON_TYPES,
}
