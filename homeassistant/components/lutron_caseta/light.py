...
from .const import DEVICE_TYPE_SPECTRUM_TUNE, DEVICE_TYPE_WHITE_TUNE, DEVICE_TYPE_COLOR_TUNE
...
WARM_DEVICE_TYPES = {DEVICE_TYPE_WHITE_TUNE, DEVICE_TYPE_SPECTRUM_TUNE, DEVICE_TYPE_COLOR_TUNE}
