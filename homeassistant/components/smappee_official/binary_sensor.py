...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    for _, service_location in smappee_base._smappee.service_locations.items():
        ...
        dev.append(SmappeePresence(smappee_base, service_location))
...
class SmappeePresence(BinarySensorEntity):
    ...
    def unique_id(self,):
        ...
        return f"{self._service_location.device_serial_number}-{self._service_location.service_location_id}-presence"
...
class SmappeeAppliance(BinarySensorEntity):
    ...
    def name(self):
        ...
        return f"{self._service_location.service_location_name} - {BINARY_SENSOR_PREFIX} - {self._appliance_name if self._appliance_name != '' else self._appliance_type}"
    ...
    def unique_id(self,):
        """Return the unique ID for this binary sensor."""
        return f"{self._service_location.device_serial_number}-{self._service_location.service_location_id}-appliance-{self._appliance_id}"
        ...
        return dict(
            {
                ...
                "Service location name": self._service_location.service_location_name,
                "Device serialnumber": self._service_location.device_serial_number,
                "Appliance id": self._appliance_id,
                "Appliance name": self._appliance_name,
                "Appliance average power": self._appliance_power,
                "Appliance type": self._appliance_type,
                "Unique id": self.unique_id,
            }
        )
