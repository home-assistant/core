    ...
    def update(self) -> None:
        ...
        if self._state["state"] == 1:
            if self._state["details"]["isCharging"]:
                self._attr_vacuum_state = VacuumEntityState.DOCKED
                ...
                self._attr_vacuum_state = VacuumEntityState.IDLE
            ...
            self._attr_vacuum_state = VacuumEntityState.PAUSED
            self._status_state = "Paused"
        elif self._state["state"] == 4:
            self._attr_vacuum_state = VacuumEntityState.ERROR
    ...
    def return_to_base(self, **kwargs: Any) -> None:
        ...
        try:
            if self._attr_vacuum_state == VacuumEntityState.CLEANING:
                self.robot.pause_cleaning()
            self._attr_vacuum_state = VacuumEntityState.RETURNING
