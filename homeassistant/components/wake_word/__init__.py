...
DATA: HassKey[EntityComponent[WakeWordDetectionEntity]] = HassKey(DOMAIN)
...
def async_get_wake_word_detection_entity(
    ...
    return hass.data[DATA].get_entity(entity_id)
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    component = hass.data[DATA] = EntityComponent[WakeWordDetectionEntity](
        _LOGGER, DOMAIN, hass
    )
...
async def websocket_entity_info(
    ...
    entity = hass.data[DATA].get_entity(msg["entity_id"])
