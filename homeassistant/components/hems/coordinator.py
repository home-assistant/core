...
class HemsCoordinator(DataUpdateCoordinator[dict[str, HemsNodeState]]):
    """Coordinator that tracks state for detected SEOJ nodes."""

    config_entry: HemsConfigEntry
    ...
    def __init__(
        ...
        *,
        ...
        self.data: dict[str, HemsNodeState] = {}
    ...
    async def _async_setup_device(self, node_id: str, eoj: int) -> None:
        """Set up a device by requesting its properties and creating a HemsNodeState.
    ...
    async def _async_send_initial_notification(
        self, device_key: str, node: HemsNodeState
    ) -> None:
