...
class HemsSwitchEntityDescription(SwitchEntityDescription, HemsEntityDescription):
...
async def async_setup_entry(
    ...
    """Set up HEMS switches from a config entry."""
    setup_hems_platform(
        entry,
        async_add_entities,
        "binary",
...
class HemsSwitch(HemsDescribedEntity[HemsSwitchEntityDescription], SwitchEntity):
