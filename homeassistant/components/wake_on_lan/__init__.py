...
from homeassistant.const import CONF_BROADCAST_ADDRESS, CONF_BROADCAST_PORT, CONF_BROADCAST_INTERFACE, CONF_MAC
...
WAKE_ON_LAN_SEND_MAGIC_PACKET_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_BROADCAST_INTERFACE): cv.string,
    }
)
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    async def send_magic_packet(call: ServiceCall) -> None:
        ...
        broadcast_interface = call.data.get(CONF_BROADCAST_INTERFACE)
