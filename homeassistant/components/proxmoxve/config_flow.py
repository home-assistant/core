...
class ProxmoxVEConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_reauth_confirm(
        ...
        if user_input is not None:
            ...
            try:
                ...
                if CONF_NODES in self._reauth_entry.data:
                    user_input[CONF_NODES] = self._reauth_entry.data[CONF_NODES]
                self.hass.config_entries.async_update_entry(
    ...
    async def async_step_init(self, user_input, is_import) -> FlowResult:
