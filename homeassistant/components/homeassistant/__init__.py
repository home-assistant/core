...
from homeassistant.helpers.template import async_load_custom_template
...
SERVICE_RELOAD_CUSTOM_TEMPLATE = "reload_custom_template"
...
async def async_setup(hass: ha.HomeAssistant, config: ConfigType) -> bool:  # noqa: C901
    ...
    async def async_handle_reload_jinja(call: ha.ServiceCall) -> None:
        ...
        await async_load_custom_template(hass)

    async_register_admin_service(
        hass, ha.DOMAIN, SERVICE_RELOAD_CUSTOM_TEMPLATE, async_handle_reload_jinja
    )
    ...
    async def async_handle_reload_all(call: ha.ServiceCall) -> None:
        ...
        `homeassistant.reload_custom_template` service that reloads any custom
        jinja into memory.
        ...
        tasks = [
            ...
            for domain, service in (
                ...
                (ha.DOMAIN, SERVICE_RELOAD_CUSTOM_TEMPLATE),
            )
        ]
