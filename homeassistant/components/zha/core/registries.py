...
SINGLE_INPUT_CLUSTER_DEVICE_CLASS = {
    ...
    zcl.clusters.measurement.EthyleneConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.EthyleneOxideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.HydrogenConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.HydrogenSulfideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.NitricOxideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.NitrogenDioxideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.OxygenConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.OzoneConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.SulfurDioxideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.DissolvedOxygenConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.BromateConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.ChloraminesConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.ChlorineConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.FecalColiformAndEColiFraction.cluster_id: SENSOR,    
    zcl.clusters.measurement.FluorideConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.HaloaceticAcidsConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.TotalTrihalomethanesConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.TotalColiformBacteriaFraction.cluster_id: SENSOR,    
    zcl.clusters.measurement.Turbidity.cluster_id: SENSOR,    
    zcl.clusters.measurement.CopperConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.LeadConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.ManganeseConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.SulfateConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.BromodichloromethaneConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.BromoformConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.ChlorodibromomethaneConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.ChloroformConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.SodiumConcentration.cluster_id: SENSOR,    
    zcl.clusters.measurement.PM25.cluster_id: SENSOR,    
