...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED1OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led1_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 1 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED1OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led1_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 1 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED1OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led1_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED1OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led1_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED2OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led2_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 2 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED2OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led2_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 2 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED2OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led2_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED2OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led2_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED3OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led3_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 3 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED3OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led3_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 3 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED3OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led3_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED3OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led3_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED4OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led4_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 4 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED4OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led4_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 4 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED4OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led4_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED4OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led4_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED5OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led5_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 5 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED5OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led5_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 5 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED5OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led5_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED5OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led5_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED6OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led6_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 6 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED6OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led6_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 6 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED6OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led6_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED6OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led6_strip_intensity_when_off"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED7OnColor(
    ZHANumberConfigurationEntity, id_suffix="default_led7_strip_color_when_on"
):
    ...
    _attr_name: str = "Default LED 7 on color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED7OffColor(
    ZHANumberConfigurationEntity, id_suffix="default_led7_strip_color_when_off"
):
    ...
    _attr_name: str = "Default LED 7 off color"


@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED7OnIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led7_strip_intensity_when_on"
):
...
@CONFIG_DIAGNOSTIC_MATCH(channel_names=CHANNEL_INOVELLI)
class InovelliDefaultLED7OffIntensity(
    ZHANumberConfigurationEntity, id_suffix="default_led7_strip_intensity_when_off"
):
