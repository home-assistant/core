...
class SensorManager:
    ...
    async def _process_manager_data(self) -> None:
        ...
        # manager.data is always set when this method is called:
        # - async_start only calls this if manager.data exists
        # - async_update always sets data to default_preferences() or existing data copy
        assert self.manager.data is not None
