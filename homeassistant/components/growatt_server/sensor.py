...
async def async_setup_entry(
    ...
    # Initialise the library with a random user id each time it is started, also extend the library's default identifier to include 'home-assistant'
    api = growattServer.GrowattApi(
        add_random_user_id=True,
        agent_identifier=growattServer.GrowattApi.agent_identifier
        + " - home-assistant",
    )
    api.server_url = url
