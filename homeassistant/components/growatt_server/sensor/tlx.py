...
TLX_SENSOR_TYPES: tuple[GrowattSensorEntityDescription, ...] = (
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_production_total",
        translation_key="tlx_solar_production_total",
        api_key="epvTotal",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_all_batteries_discharge_power",
        translation_key="tlx_all_batteries_discharge_power",
        api_key="pdisCharge",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        precision=1,
    ...
    GrowattSensorEntityDescription(
        key="tlx_all_batteries_charge_power",
        translation_key="tlx_all_batteries_charge_power",
        api_key="chargePower",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        precision=1,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_production_today",
        translation_key="tlx_solar_production_today",
        api_key="epvToday",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_load_consumption_total",
        translation_key="tlx_load_consumption_total",
    ...
    GrowattSensorEntityDescription(
        key="tlx_state_of_charge",
        translation_key="tlx_state_of_charge",
        api_key="bmsSoc",
