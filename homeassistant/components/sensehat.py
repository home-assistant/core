"""
A component which show the value of temperature, humidity and pressure from Sense HAT board in the form of service.
Interval time between each reading is a minute by default but it is configurable from configuration file.
