...
class GarniEntity(CoordinatorEntity, Entity):
    """Representation of a GARNI Entity."""
    ...
    def __init__(
        self,
        internal: CCLSensor,
        coordinator: GarniCoordinator,
    ) -> None:
        """Initialize a GARNI Entity."""
