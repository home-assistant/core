...
SENSOR_TYPES = {
    ...
    TYPE_BATT_CO2: ("CO2 Battery", None, BINARY_SENSOR, "battery"),
    ...
    TYPE_PM25_BATT: ("PM25 Battery", None, BINARY_SENSOR, "battery"),
    TYPE_PM25_IN: (
        "PM25 Indoor",
        CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        SENSOR,
    ...
    TYPE_PM25IN_BATT: ("PM25 Indoor Battery", None, BINARY_SENSOR, "battery"),
