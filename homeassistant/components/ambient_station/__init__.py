...
SENSOR_TYPES = {
    ...
    TYPE_PM25IN_BATT: ("PM25 Indoor Battery", None, BINARY_SENSOR, DEVICE_CLASS_BATTERY),
    ...
    TYPE_SOILTEMP10F: ("Soil Temp 10", TEMP_FAHRENHEIT, SENSOR, DEVICE_CLASS_TEMPERATURE),
    ...
    TYPE_SOLARRADIATION_LX: ("Solar Rad (lx)", LIGHT_LUX, SENSOR, DEVICE_CLASS_ILLUMINANCE),
