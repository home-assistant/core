...
# Public API devices WebSocket: NVR (for arm_mode updates) and Relay
# (for relay output state updates).
DEVICES_WS_SUBSCRIBED_MODELS = {ModelType.NVR, ModelType.RELAY}
