...
from .const import (  # noqa: F401
    _DEPRECATED_FAN_AUTO,
    _DEPRECATED_FAN_DIFFUSE,
    _DEPRECATED_FAN_FOCUS,
    _DEPRECATED_FAN_HIGH,
    _DEPRECATED_FAN_LOW,
    _DEPRECATED_FAN_MEDIUM,
    _DEPRECATED_FAN_MIDDLE,
    _DEPRECATED_FAN_OFF,
    _DEPRECATED_FAN_ON,
    _DEPRECATED_FAN_TOP,
    ...
    _DEPRECATED_PRESET_ACTIVITY,
    _DEPRECATED_PRESET_AWAY,
    _DEPRECATED_PRESET_BOOST,
    _DEPRECATED_PRESET_COMFORT,
    _DEPRECATED_PRESET_ECO,
    _DEPRECATED_PRESET_HOME,
    _DEPRECATED_PRESET_NONE,
    _DEPRECATED_PRESET_SLEEP,
    ...
    _DEPRECATED_SWING_BOTH,
    _DEPRECATED_SWING_HORIZONTAL,
    _DEPRECATED_SWING_OFF,
    _DEPRECATED_SWING_ON,
    _DEPRECATED_SWING_VERTICAL,
    ATTR_AUX_HEAT,
