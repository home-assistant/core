...
SUPPORT_MIN_HUMIDITY = 1 << 2
SUPPORT_MAX_HUMIDITY = 1 << 3
SUPPORT_TARGET_TEMPERATURE = 1 << 4
SUPPORT_TARGET_TEMPERATURE_HIGH = 1 << 5
SUPPORT_TARGET_TEMPERATURE_LOW = 1 << 6
SUPPORT_TARGET_HUMIDITY = 1 << 7
SUPPORT_TARGET_HUMIDITY_HIGH = 1 << 8
SUPPORT_TARGET_HUMIDITY_LOW = 1 << 9
SUPPORT_FAN_MODE = 1 << 10
SUPPORT_OPERATION_MODE = 1 << 11
SUPPORT_HOLD_MODE = 1 << 12
SUPPORT_SWING_MODE = 1 << 13
SUPPORT_AWAY_MODE = 1 << 14
SUPPORT_AUX_HEAT = 1 << 15
