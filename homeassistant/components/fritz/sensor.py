...
class FritzRequireKeysMixin:
    ...
    state_provider: Callable[[FritzStatus, Any], Any]
...
SENSOR_DATA: tuple[FritzSensorEntityDescription, ...] = (
...
async def async_setup_entry(
    ...
    entities = [
        ...
        for description in SENSOR_DATA
...
class FritzBoxSensor(FritzBoxBaseEntity, SensorEntity):
    ...
    def update(self) -> None:
        ...
        ) = self.entity_description.state_provider(status, self._last_device_value)
