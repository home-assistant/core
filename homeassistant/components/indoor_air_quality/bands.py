"""IAQUK 2015 component bands for the Indoor Air Quality integration.

This is an indoor rating methodology and is unrelated to the UK government's
outdoor Daily Air Quality Index. Home Assistant normalizes the configured
component subset to the methodology's 13-65 output range.

Methodology: IAQUK Indoor Air Quality Rating Index (2015), archived at
https://web.archive.org/web/20161014083724id_/http://iaquk.org.uk/ESW/Files/IAQ_Rating_Index.pdf
"""
...
_BANDS_IAQUK_2015: Final[dict[str, tuple[ScoreBand, ...]]] = {
    CONF_TEMPERATURE: (
...
_LEVEL_BANDS_IAQUK_2015: Final[tuple[tuple[int, str], ...]] = (
    (25, LEVEL_INADEQUATE),
    (38, LEVEL_POOR),
    (51, LEVEL_FAIR),
    (60, LEVEL_GOOD),
...
BANDS: Final[dict[str, dict[str, tuple[ScoreBand, ...]]]] = {
    STANDARD_IAQUK_2015: _BANDS_IAQUK_2015,
}

LEVEL_BANDS: Final[dict[str, tuple[tuple[int, str], ...]]] = {
    STANDARD_IAQUK_2015: _LEVEL_BANDS_IAQUK_2015,
}

LEVEL_TOP: Final[dict[str, str]] = {
    STANDARD_IAQUK_2015: LEVEL_EXCELLENT,
}
