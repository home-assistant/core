...
NUMBER_ENTITIES = (
    ...
    ReolinkNumberEntityDescription(
        ...
        supported=lambda api, ch: api.supported(ch, "ispBright"),
    ...
    ReolinkNumberEntityDescription(
        ...
        native_min_value=0,
        native_max_value=255,
        supported=lambda api, ch: api.supported(ch, "ispContrast"),
    ...
    ReolinkNumberEntityDescription(
        ...
        native_min_value=0,
        native_max_value=255,
        supported=lambda api, ch: api.supported(ch, "ispSatruation"),
    ...
    ReolinkNumberEntityDescription(
        ...
        native_min_value=0,
        native_max_value=255,
        supported=lambda api, ch: api.supported(ch, "ispSharpen"),
    ...
    ReolinkNumberEntityDescription(
        ...
        native_min_value=0,
        native_max_value=255,
        supported=lambda api, ch: api.supported(ch, "ispHue"),
