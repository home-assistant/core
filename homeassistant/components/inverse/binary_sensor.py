"""Binary sensor support for inverse entities."""
...
async def async_setup_entry(
    ...
    """Initialize Binary Sensor Inverse config entry."""
...
class InverseBinarySensor(BaseEntity, BinarySensorEntity):
    """Represents an Inverse Binary Sensor."""
