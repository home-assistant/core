...
ENTITY_DESCRIPTIONS: tuple[EcovacsSensorEntityDescription, ...] = (
    ...
    # RTK (mowers only — currently the GOAT family)
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: e.rover_satellites_visible,
        key="rtk_rover_satellites_visible",
        translation_key="rtk_rover_satellites_visible",
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: e.rover_satellites_used,
        key="rtk_rover_satellites_used",
        translation_key="rtk_rover_satellites_used",
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: e.base_satellites_used,
        key="rtk_base_satellites_used",
        translation_key="rtk_base_satellites_used",
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: (
            e.base_stations[0].satellites_visible if e.base_stations else None
        ),
        key="rtk_base_satellites_visible",
        translation_key="rtk_base_satellites_visible",
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: e.rover_signal_score,
        key="rtk_rover_signal_score",
        translation_key="rtk_rover_signal_score",
        native_unit_of_measurement=PERCENTAGE,
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    EcovacsSensorEntityDescription[RtkEvent](
        capability_fn=lambda caps: caps.rtk,
        value_fn=lambda e: e.base_signal_score,
        key="rtk_base_signal_score",
        translation_key="rtk_base_signal_score",
        native_unit_of_measurement=PERCENTAGE,
        entity_category=EntityCategory.DIAGNOSTIC,
        state_class=SensorStateClass.MEASUREMENT,
    ),
