...
SVE_TRANSLATION_KEY_DESCRIPTION = "description"
SVE_TRANSLATION_KEY_ENTITY_ID = "entity_id"
SVE_TRANSLATION_KEY_SETTING_KEY = "setting_key"
SVE_TRANSLATION_KEY_VALUE = "value"
