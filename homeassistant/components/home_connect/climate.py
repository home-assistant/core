...
from .const import DOMAIN, PROGRAMS_TRANSLATION_KEYS_MAP, TRANSLATION_KEYS_PROGRAMS_MAP
...
class HomeConnectAirConditioningEntity(HomeConnectEntity, ClimateEntity):
    ...
    async def async_set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        await self.set_program(HVAC_MODES_PROGRAMS_MAP[hvac_mode])

    async def async_set_preset_mode(self, preset_mode: str) -> None:
        """Set new preset mode."""
        await self.set_program(TRANSLATION_KEYS_PROGRAMS_MAP[preset_mode])
