...
from homeassistant.const import (
    LENGTH_CENTIMETERS as UOM_LENGTH_CM,
    LENGTH_INCHES as UOM_LENGTH_IN,
    LENGTH_METERS as UOM_LENGTH_M,
    MASS_KILOGRAMS as UOM_MASS_KG,
    MASS_POUNDS as UOM_MASS_LB,
    STATE_UNKNOWN,
    TEMP_CELSIUS as UOM_TEMP_C,
    TEMP_FAHRENHEIT as UOM_TEMP_F
)
