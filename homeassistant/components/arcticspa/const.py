...
# The ArcticSpas remote endpoint has a very low tolerance for regular polling. (About 15 queries per minute.)
...
# If the number is set higher, the user interface gets notified of the change too late, leading to transient switching.
