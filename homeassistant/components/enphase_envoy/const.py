...
OPTION_SET_RETRY_ATTEMPTS = "set_retry_attempts"
OPTION_SET_RETRY_ATTEMPTS_DEFAULT_VALUE = 4
OPTION_SET_RETRY_ATTEMPTS_MIN_VALUE = 2
OPTION_SET_RETRY_ATTEMPTS_MAX_VALUE = 10
