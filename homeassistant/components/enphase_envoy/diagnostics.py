...
async def async_get_config_entry_diagnostics(
    ...
    envoy_model: dict[str, Any] = {
        ...
        "generator": envoy_data.generator,
        "generator_config": envoy_data.generator_config,
        "generator_schedule": envoy_data.generator_schedule,
        "generator_mode": envoy_data.generator_mode,
