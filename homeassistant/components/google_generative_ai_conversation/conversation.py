...
from homeassistant.helpers import intent, llm, template, trace
...
class GoogleGenerativeAIConversationEntity(
    ...
    async def async_process(
        ...
        with trace.trace_path("google-generative-ai-conversation"):
            ...
            trace_element = trace.TraceElement({"prompt": prompt}, "google/prompt")
            trace.trace_append_element(trace_element)
            ...
            for _iteration in range(MAX_TOOL_ITERATIONS):
                ...
                if not tool_call or not llm_api:
                    break
                trace_element = trace.TraceElement(
                    {
            ...
            trace_element = trace.TraceElement(
                {"response": chat_response.text}, "google/response"
            )
            trace.trace_append_element(trace_element)
