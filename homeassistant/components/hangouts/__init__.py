...
async def async_setup(hass, config):
    ...
    hass.services.async_register(DOMAIN, SERVICE_UPDATE_USERS_AND_CONVERSATIONS,
                                 bot.async_handle_update_users_and_conversations, schema=None)
...
class HangoutsBot(object):
    ...
    async def async_connect(self):
        ...
        self._client = Client(
            get_auth(HangoutsCredentials(self._email, self._password), RefreshTokenCache(self._session_filepath)))
    ...
    async def _async_list_conversations(self):
        ...
        self.hass.states.async_set("{}.conversations".format(DOMAIN), len(self._conversation_list.get_all()),
