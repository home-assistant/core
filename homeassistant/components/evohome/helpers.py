"""The helper APIs of the Evohome integration."""
...
def dt_local_to_aware(dt_naive: datetime) -> datetime:
    """Convert a naive datetime to a local/aware datetime."""
...
def dt_aware_to_naive(dt_aware: datetime) -> datetime:
    """Convert a local/aware datetime to a naive datetime."""
...
def convert_until(status_dict: dict[str, str], until_key: str) -> None:
...
def handle_exception(err: evo.RequestFailed) -> None:
    """Lg a useful message and return False if the exception can't be ignored."""
