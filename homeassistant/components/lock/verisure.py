...
class VerisureDoorlock(LockDevice):
    ...
    def unlock(self, **kwargs):
        """ Send unlock command. """
        if ATTR_CODE in kwargs:
            self._code = kwargs[ATTR_CODE]
        verisure.MY_PAGES.lock.set(self._code, self._id, 'UNLOCKED')
    ...
    def lock(self, **kwargs):
        ...
        if ATTR_CODE in kwargs:
            self._code = kwargs[ATTR_CODE]
        verisure.MY_PAGES.lock.set(self._code, self._id, 'LOCKED')
