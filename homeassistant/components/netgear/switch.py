...
ROUTER_SWITCH_TYPES = [
    ...
    NetgearSwitchEntityDescription(
        ...
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_traffic_meter_enabled,
        action=lambda router: router._api.enable_traffic_meter,
    ),
    NetgearSwitchEntityDescription(
        ...
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_parental_control_enable_status,
        action=lambda router: router._api.enable_parental_control,
    ),
    NetgearSwitchEntityDescription(
        key="qos",
        ...
        icon="mdi:wifi-star",
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_qos_enable_status,
        action=lambda router: router._api.set_qos_enable_status,
    ),
    NetgearSwitchEntityDescription(
        key="2g_guest_wifi",
        ...
        icon="mdi:wifi",
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_2g_guest_access_enabled,
        action=lambda router: router._api.set_2g_guest_access_enabled,
    ),
    NetgearSwitchEntityDescription(
        key="5g_guest_wifi",
        name="5G Guest Wifi",
        icon="mdi:wifi",
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_5g_guest_access_enabled,
        action=lambda router: router._api.set_5g_guest_access_enabled,
    ),
    NetgearSwitchEntityDescription(
        key="smart_connect",
        name="Smart Connect",
        icon="mdi:wifi",
        entity_category=EntityCategory.CONFIG,
        update=lambda router: router._api.get_smart_connect_enabled,
        action=lambda router: router._api.set_smart_connect_enabled,
    )
]
