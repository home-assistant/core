...
CHARACTERISTIC_PLATFORMS = {
    ...
    CharacteristicsTypes.VENDOR_ECOBEE_FAN_WRITE_SPEED: "fan",
    CharacteristicsTypes.VENDOR_ECOBEE_FAN_READ_SPEED: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_ALERT_TEXT: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_NEXT_SCHEDULED_CHANGE_TIME: "datetime",
    CharacteristicsTypes.VENDOR_ECOBEE_EQUIPMENT_RUNNING: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_STATUS_CODE: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_AUX_HEAT_ACTIVE: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_MOTION_LAST_ACTIVATION: "sensor",
    CharacteristicsTypes.VENDOR_ECOBEE_OCCUPANCY_LAST_ACTIVATION: "sensor",
