...
SUPPORT_PRESET = [PRESET_AWAY, PRESET_BOOST, PRESET_FROST_GUARD, PRESET_SCHEDULE, PRESET_MANUAL]
...
PRESET_MAP_NETATMO = {
    ...
    PRESET_MANUAL: STATE_NETATMO_MANUAL,
...
NETATMO_MAP_PRESET = {
    ...
    STATE_NETATMO_AWAY: PRESET_AWAY,
    STATE_NETATMO_OFF: STATE_NETATMO_OFF,
    STATE_NETATMO_MANUAL: PRESET_MANUAL,
