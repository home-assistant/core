...
SENSOR_UNIT_MAP = {
    hc.UnitOfDensity.MICROGRAMS_PER_CUBIC_METER: (
        UnitOfDensity.MICROGRAMS_PER_CUBIC_METER
    ),
    hc.UnitOfRatio.PARTS_PER_BILLION: UnitOfRatio.PARTS_PER_BILLION,
    hc.UnitOfRatio.PARTS_PER_MILLION: UnitOfRatio.PARTS_PER_MILLION,
