...
SENSOR_DEVICE_CLASS_ICON_MAP: dict[str, dict[str, Any]] = {
    hc.SENSOR_ACTIVE_ENERGYEXPORT: {DEVICE_CLASS: SensorDeviceClass.ENERGY},
    hc.SENSOR_ACTIVE_ENERGYIMPORT: {DEVICE_CLASS: SensorDeviceClass.ENERGY},
    ...
    hc.SENSOR_REACTIVE_ENERGYEXPORT: {DEVICE_CLASS: SensorDeviceClass.ENERGY},
    hc.SENSOR_REACTIVE_ENERGYIMPORT: {DEVICE_CLASS: SensorDeviceClass.ENERGY},
