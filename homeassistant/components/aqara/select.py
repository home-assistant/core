...
class AqaraSelectEntity(AqaraEntity, SelectEntity):
    ...
    def __init__(
        ...
        if description.selection is not None:
            selections: dict[str, str] = description.selection
            self._attr_options = list(selections.keys())
    ...
    def current_option(self) -> str | None:
        ...
        if self.entity_description.selection is None:
            return None
        select = self.entity_description.selection
