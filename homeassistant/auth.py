...
class Client:
    ...
    redirect_uri = attr.ib(type=list, default=attr.Factory(list))
...
class AuthManager:
    ...
    async def async_create_client(self, name, *, redirect_uri=None,
                                  no_secret=False):
        """Create a new client."""
        return await self._store.async_create_client(
            name, redirect_uri, no_secret)
...
class AuthStore:
    ...
    async def async_create_client(self, name, redirect_uri, no_secret):
        """Create a new client."""
