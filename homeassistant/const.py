...
# Frequency units
FREQUENCY_HERTZ = "Hz"
FREQUENCY_KILOHERTZ = f"k{FREQUENCY_HERTZ}"
FREQUENCY_MEGAHERTZ = f"M{FREQUENCY_HERTZ}"
...
PRESSURE_ATM: str = "atm"
PRESSURE_BARYE: str = "Ba"
...
AREA_SQUARE_FEET = f"{LENGTH_FEET}²"
...
# Radiation Units
RADIATION_ACTIVITY_BECQUEREL = "Bq"
RADIATION_ACTIVITY_CURIE = "Ci"
RADIATION_DOSE_GRAY = "Gy"
RADIATION_DOSE_RAD = "rad"
RADIATION_DOSE_SIEVERT = "Sv"
RADIATION_EXPOSURE_RONTGEN = "R"
RADIATION_EXPOSURE_COULOMB_PER_KG = f"C/{MASS_KILOGRAMS}"
RADON_CONCENTRATION_PICOCURIES = f"p{RADIATION_ACTIVITY_CURIE}/{VOLUME_LITERS}"
RADON_CONCENTRATION_BECQUERELS = f"{RADIATION_ACTIVITY_BECQUEREL}/{VOLUME_CUBIC_METERS}"
