...
class AuthManager:
    ...
    async def async_create_refresh_token(
        ...
        token_type, expire_at = self._resolve_token_type_and_expiration(
            user, token_type
        )
        self._validate_user_token_type(user, token_type)
        self._validate_client_requirements(token_type, client_id, client_name)
        self._validate_long_lived_token(user, token_type, client_name)
    ...
    def _assert_user_active(self, user: models.User) -> None:
    ...
    def _resolve_token_type_and_expiration(
        self, user: models.User, token_type: str | None
        ...
        if token_type is models.TOKEN_TYPE_NORMAL:
            ...
            expire_at = None
        return token_type, expire_at

    def _validate_user_token_type(self, user: models.User, token_type: str) -> None:
    ...
    def _validate_long_lived_token(
