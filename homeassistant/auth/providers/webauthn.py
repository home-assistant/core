...
class Data:
    ...
    def get_challenge(self, user_id: str) -> str | None:
        """Get a challenge."""
        return self.users.get(user_id, {}).get("challenge")
    ...
    def get_username(self, user: User) -> str | None:
        """Get a user name."""
        if user.id in self.users:
            return self.users[user.id].get("username")
        username = user.name
