...
@pytest.mark.parametrize(
    "entity_name,expected_entity_id",
    (
        ("Entity Blu", "test_domain.device_bla_entity_blu"),
        (None, "test_domain.device_bla"),
    ),
)
async def test_entity_name_influences_entity_id(hass, entity_name, expected_entity_id):
