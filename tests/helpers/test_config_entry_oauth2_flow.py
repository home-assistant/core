...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {},
            "oauth_unauthorized",
            "Token request to https://example.como/auth/token failed (unknown): unknown",
        ),
        (
        ...
        (
            ...
            "oauth_failed",
            "Token request to https://example.como/auth/token failed (invalid_request): Request was missing the",
        ),
    ],
)
