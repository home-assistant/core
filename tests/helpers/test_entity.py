...
async def test_async_before_added_to_hass_runs_before_registration(
    hass: HomeAssistant, entity_registry: er.EntityRegistry
) -> None:
    """Test async_before_added_to_hass runs before registration and the state write.
...
async def test_async_before_added_to_hass_runs_for_disabled_entity(
    hass: HomeAssistant, entity_registry: er.EntityRegistry
) -> None:
    """Test async_before_added_to_hass runs even for a disabled, aborted entity."""
    events: list[str] = []
    ...
    # but async_before_added_to_hass still does.
...
async def test_async_before_added_to_hass_raising_aborts_add(
    hass: HomeAssistant,
    entity_registry: er.EntityRegistry,
    caplog: pytest.LogCaptureFixture,
) -> None:
    """Test a raising async_before_added_to_hass aborts the add cleanly.
