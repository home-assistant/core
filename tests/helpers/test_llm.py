...
async def test_get_exposed_entities_timestamp_conversion(hass: HomeAssistant) -> None:
    ...
    # ---------------------------------------------------------------------------
# Tests for sanitize_tool_schema
# ---------------------------------------------------------------------------
...
def test_sanitize_tool_schema_keeps_clean_schema() -> None:
    ...
    assert llm.sanitize_tool_schema(schema) == schema
...
def test_sanitize_tool_schema_removes_unsupported_root_keys() -> None:
    ...
    result = llm.sanitize_tool_schema(schema)
...
def test_sanitize_tool_schema_does_not_mutate_input() -> None:
    ...
    _ = llm.sanitize_tool_schema(schema)
...
def test_sanitize_tool_schema_hass_start_timer_schema() -> None:
    ...
    result = llm.sanitize_tool_schema(HASS_START_TIMER_SCHEMA)
    assert "anyOf" not in result
