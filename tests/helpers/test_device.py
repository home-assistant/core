...
async def test_remove_stale_device_links_keep_entity_device(
    ...
    # After cleanup, only one device is expected to be linked to the configuration
    # entry if at least source_entity_id_or_uuid or device_id was given, else zero
