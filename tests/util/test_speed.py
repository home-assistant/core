...
def test_deprecated_constant() -> None:
    ...
    assert speed_util.UNIT_CONVERSION == {
        ...
        SPEED_INCHES_PER_DAY: pytest.approx((24 * 60 * 60) / 0.0254),
        SPEED_INCHES_PER_HOUR: 60 * 60 / 0.0254,
        SPEED_KILOMETERS_PER_HOUR: 60 * 60 / 1000,
        SPEED_KNOTS: 60 * 60 / 1852,
        SPEED_METERS_PER_SECOND: 1,
        SPEED_MILES_PER_HOUR: pytest.approx(60 * 60 / 1609.344),
