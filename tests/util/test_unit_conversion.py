...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VolumeConverter, 500, VOLUME_CUBIC_METERS, 500, VOLUME_CUBIC_METERS),
        (
            VolumeConverter,
            500,
            VOLUME_CUBIC_METERS,
        ...
        (VolumeConverter, 500, VOLUME_CUBIC_METERS, 500000, VOLUME_LITERS),
        (VolumeConverter, 500, VOLUME_CUBIC_METERS, 500000000, VOLUME_MILLILITERS),
        (
            VolumeConverter,
            500,
            VOLUME_FLUID_OUNCE,
        ...
        (VolumeConverter, 500, VOLUME_FLUID_OUNCE, 3.90625, VOLUME_GALLONS),
        (
            VolumeConverter,
            500,
            VOLUME_FLUID_OUNCE,
        ...
        (VolumeConverter, 500, VOLUME_GALLONS, 64000, VOLUME_FLUID_OUNCE),
        (
            VolumeConverter,
            500,
            VOLUME_GALLONS,
            pytest.approx(1892.70589),
            VOLUME_LITERS,
        ),
        (
            VolumeConverter,
        ...
        (
            ...
            500,
            VOLUME_LITERS,
            pytest.approx(17.65733),
            VOLUME_CUBIC_FEET,
        ),
        (VolumeConverter, 500, VOLUME_LITERS, 0.5, VOLUME_CUBIC_METERS),
        (
            VolumeConverter,
            500,
            VOLUME_LITERS,
        ...
        (VolumeConverter, 500, VOLUME_LITERS, pytest.approx(132.086), VOLUME_GALLONS),
        (VolumeConverter, 500, VOLUME_LITERS, 500000, VOLUME_MILLILITERS),
        (
            VolumeConverter,
            500,
            VOLUME_MILLILITERS,
        ...
        (VolumeConverter, 500, VOLUME_MILLILITERS, 0.0005, VOLUME_CUBIC_METERS),
        (
            VolumeConverter,
            500,
            VOLUME_MILLILITERS,
        ...
        (VolumeConverter, 500, VOLUME_MILLILITERS, 0.5, VOLUME_LITERS),
    ],
)
def test_convert(
