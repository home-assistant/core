...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VolumeConverter, UnitOfVolume.US_GALLONS),
        (VolumeConverter, UnitOfVolume.US_FLUID_OUNCES),
        (VolumeConverter, UnitOfVolume.IMPERIAL_GALLONS),
        (VolumeConverter, UnitOfVolume.IMPERIAL_FLUID_OUNCES),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VolumeConverter, UnitOfVolume.US_GALLONS, UnitOfVolume.LITERS),
    ],
)
...
@pytest.mark.parametrize(
    "value,from_unit,expected,to_unit",
    [
        (5, UnitOfVolume.LITERS, pytest.approx(1.32086), UnitOfVolume.US_GALLONS),
        (5, UnitOfVolume.US_GALLONS, pytest.approx(18.92706), UnitOfVolume.LITERS),
        (
            5,
        ...
        (
            ...
            pytest.approx(0.5016989),
            UnitOfVolume.CUBIC_FEET,
        ),
        (
            500,
            UnitOfVolume.IMPERIAL_FLUID_OUNCES,
            pytest.approx(0.01420653),
            UnitOfVolume.CUBIC_METERS,
        ),
        (500, UnitOfVolume.IMPERIAL_FLUID_OUNCES, 3.125, UnitOfVolume.IMPERIAL_GALLONS),
        (
            500,
            UnitOfVolume.IMPERIAL_FLUID_OUNCES,
            pytest.approx(14.20653),
            UnitOfVolume.LITERS,
        ),
        (
            500,
            UnitOfVolume.IMPERIAL_FLUID_OUNCES,
            pytest.approx(14206.53),
            UnitOfVolume.MILLILITERS,
        ),
        (
            500,
            UnitOfVolume.IMPERIAL_GALLONS,
            pytest.approx(80.2718),
            UnitOfVolume.CUBIC_FEET,
        ),
        (500, UnitOfVolume.IMPERIAL_GALLONS, 2.273045, UnitOfVolume.CUBIC_METERS),
        (500, UnitOfVolume.IMPERIAL_GALLONS, 80000, UnitOfVolume.IMPERIAL_FLUID_OUNCES),
        (500, UnitOfVolume.IMPERIAL_GALLONS, 2273.045, UnitOfVolume.LITERS),
        (500, UnitOfVolume.IMPERIAL_GALLONS, 2273045, UnitOfVolume.MILLILITERS),
        ...
        (
            500,
            UnitOfVolume.LITERS,
            pytest.approx(16907.011),
            UnitOfVolume.US_FLUID_OUNCES,
        ),
        (500, UnitOfVolume.LITERS, pytest.approx(132.086), UnitOfVolume.US_GALLONS),
        ...
        (500, VOLUME_FLUID_OUNCE, 3.90625, UnitOfVolume.US_GALLONS),
        (500, VOLUME_FLUID_OUNCE, pytest.approx(14.786764), UnitOfVolume.LITERS),
        (500, VOLUME_FLUID_OUNCE, pytest.approx(14786.764), UnitOfVolume.MILLILITERS),
        (500, VOLUME_GALLONS, pytest.approx(66.84027), UnitOfVolume.CUBIC_FEET),
        (500, VOLUME_GALLONS, pytest.approx(1.892706), UnitOfVolume.CUBIC_METERS),
        (500, VOLUME_GALLONS, 64000, UnitOfVolume.US_FLUID_OUNCES),
        (500, VOLUME_GALLONS, pytest.approx(1892.70589), UnitOfVolume.LITERS),
        (500, VOLUME_GALLONS, pytest.approx(1892705.89), UnitOfVolume.MILLILITERS),
    ],
)
