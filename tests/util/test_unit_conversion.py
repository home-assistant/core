...
from homeassistant.const import (
    ...
    POWER_KILO_WATT,
    POWER_WATT,
    PRECIPITATION_INCHES_PER_DAY,
    PRECIPITATION_INCHES_PER_HOUR,
    PRECIPITATION_MILLIMETERS_PER_DAY,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SpeedConverter, PRECIPITATION_INCHES_PER_DAY),
        (SpeedConverter, PRECIPITATION_INCHES_PER_HOUR),
        (SpeedConverter, PRECIPITATION_MILLIMETERS_PER_DAY),
        (SpeedConverter, PRECIPITATION_MILLIMETERS_PER_HOUR),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (5, PRECIPITATION_INCHES_PER_DAY, 127, PRECIPITATION_MILLIMETERS_PER_DAY),
        ...
        (5, PRECIPITATION_INCHES_PER_HOUR, 3048, PRECIPITATION_MILLIMETERS_PER_DAY),
