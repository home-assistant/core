...
_GET_UNIT_RATIO: dict[type[BaseUnitConverter], tuple[str | None, str | None, float]] = {
    ...
    ForceConverter: (UnitOfForce.NEWTONS, UnitOfForce.KILONEWTONS, 1000),
...
_CONVERTED_VALUE: dict[
    ...
    EnergyConverter: [
        ...
        (10, UnitOfEnergy.KILO_CALORIE, 0.04184, UnitOfEnergy.MEGA_JOULE),
        (10, UnitOfEnergy.KILO_CALORIE, 0.011622, UnitOfEnergy.KILO_WATT_HOUR),
        (10, UnitOfEnergy.MEGA_CALORIE, 0.011622, UnitOfEnergy.MEGA_WATT_HOUR),
    ],
    ForceConverter: [
        (10, UnitOfForce.NEWTONS, 10e-3, UnitOfForce.KILONEWTONS),
        (10, UnitOfForce.NEWTONS, 10e-6, UnitOfForce.MEGANEWTONS),
        (10, UnitOfForce.KILONEWTONS, 10e3, UnitOfForce.NEWTONS),
        (10, UnitOfForce.KILONEWTONS, 10e-3, UnitOfForce.MEGANEWTONS),
        (10, UnitOfForce.MEGANEWTONS, 10e6, UnitOfForce.NEWTONS),
        (10, UnitOfForce.MEGANEWTONS, 10e3, UnitOfForce.KILONEWTONS),
    ],
    InformationConverter: [
