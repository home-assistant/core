...
@pytest.mark.parametrize(
    ...
    [
        ...
        (5, LENGTH_MILES, 26400, LENGTH_FEET),
        (5, LENGTH_MILES, 316800, LENGTH_INCHES),
        (5, LENGTH_YARD, 0.004572, LENGTH_KILOMETERS),
        (5, LENGTH_YARD, 4.572, LENGTH_METERS),
        (5, LENGTH_YARD, 457.2, LENGTH_CENTIMETERS),
        ...
        (5000, LENGTH_FEET, 1.524, LENGTH_KILOMETERS),
        (5000, LENGTH_FEET, 1524, LENGTH_METERS),
        (5000, LENGTH_FEET, 152400, LENGTH_CENTIMETERS),
        (5000, LENGTH_FEET, 1524000, LENGTH_MILLIMETERS),
        ...
        (5000, LENGTH_INCHES, 127000, LENGTH_MILLIMETERS),
        ...
        (5, LENGTH_KILOMETERS, 500000, LENGTH_CENTIMETERS),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1000, PRESSURE_HPA, 100000, PRESSURE_PA),
        (1000, PRESSURE_HPA, 100, PRESSURE_KPA),
        (1000, PRESSURE_HPA, 1000, PRESSURE_MBAR),
        (1000, PRESSURE_HPA, 100, PRESSURE_CBAR),
        (100, PRESSURE_KPA, pytest.approx(14.5037743897), PRESSURE_PSI),
        (100, PRESSURE_KPA, pytest.approx(29.5299801647), PRESSURE_INHG),
        (100, PRESSURE_KPA, 100000, PRESSURE_PA),
        (100, PRESSURE_KPA, 1000, PRESSURE_HPA),
        (100, PRESSURE_KPA, 1000, PRESSURE_MBAR),
        (100, PRESSURE_KPA, 100, PRESSURE_CBAR),
