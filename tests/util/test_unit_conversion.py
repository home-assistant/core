...
@pytest.mark.parametrize(
    ...
    [
        (5, LENGTH_MILES, 8.04672, LENGTH_KILOMETERS),
        (5, LENGTH_MILES, 8046.72, LENGTH_METERS),
        (5, LENGTH_MILES, 804672, LENGTH_CENTIMETERS),
        (5, LENGTH_MILES, 8046720, LENGTH_MILLIMETERS),
        (5, LENGTH_MILES, 8800, LENGTH_YARD),
        (5, LENGTH_MILES, pytest.approx(26400), LENGTH_FEET),
        (5, LENGTH_MILES, pytest.approx(316800), LENGTH_INCHES),
        (5, LENGTH_YARD, 0.004572, LENGTH_KILOMETERS),
        (5, LENGTH_YARD, 4.572, LENGTH_METERS),
        (5, LENGTH_YARD, pytest.approx(457.2), LENGTH_CENTIMETERS),
        (5, LENGTH_YARD, 4572, LENGTH_MILLIMETERS),
        (5, LENGTH_YARD, pytest.approx(0.002840908212), LENGTH_MILES),
        (5, LENGTH_YARD, 15, LENGTH_FEET),
        (5, LENGTH_YARD, 180, LENGTH_INCHES),
        (5000, LENGTH_FEET, pytest.approx(1.524), LENGTH_KILOMETERS),
        (5000, LENGTH_FEET, pytest.approx(1524), LENGTH_METERS),
        (5000, LENGTH_FEET, pytest.approx(152400), LENGTH_CENTIMETERS),
        (5000, LENGTH_FEET, pytest.approx(1524000), LENGTH_MILLIMETERS),
        (5000, LENGTH_FEET, pytest.approx(0.9469694040000001), LENGTH_MILES),
        (5000, LENGTH_FEET, pytest.approx(1666.66667), LENGTH_YARD),
        (5000, LENGTH_FEET, 60000, LENGTH_INCHES),
        (5000, LENGTH_INCHES, 0.127, LENGTH_KILOMETERS),
        (5000, LENGTH_INCHES, 127, LENGTH_METERS),
        (5000, LENGTH_INCHES, 12700, LENGTH_CENTIMETERS),
        (5000, LENGTH_INCHES, pytest.approx(127000), LENGTH_MILLIMETERS),
        ...
        (5, LENGTH_KILOMETERS, 5000, LENGTH_METERS),
        (5, LENGTH_KILOMETERS, pytest.approx(500000), LENGTH_CENTIMETERS),
        (5, LENGTH_KILOMETERS, 5000000, LENGTH_MILLIMETERS),
        ...
        (5000, LENGTH_METERS, 5, LENGTH_KILOMETERS),
        (5000, LENGTH_METERS, 500000, LENGTH_CENTIMETERS),
        (5000, LENGTH_METERS, 5000000, LENGTH_MILLIMETERS),
        ...
        (500000, LENGTH_CENTIMETERS, 5, LENGTH_KILOMETERS),
        (500000, LENGTH_CENTIMETERS, 5000, LENGTH_METERS),
        (500000, LENGTH_CENTIMETERS, 5000000, LENGTH_MILLIMETERS),
        ...
        (5000000, LENGTH_MILLIMETERS, 5, LENGTH_KILOMETERS),
        (5000000, LENGTH_MILLIMETERS, 5000, LENGTH_METERS),
        (5000000, LENGTH_MILLIMETERS, 500000, LENGTH_CENTIMETERS),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (10, ENERGY_WATT_HOUR, pytest.approx(0.00001), ENERGY_MEGA_WATT_HOUR),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (10, MASS_MILLIGRAMS, pytest.approx(0.00001), MASS_KILOGRAMS),
        ...
        (10000, MASS_MICROGRAMS, pytest.approx(0.00001), MASS_KILOGRAMS),
        ...
        (1, MASS_POUNDS, pytest.approx(0.45359237), MASS_KILOGRAMS),
        (1, MASS_POUNDS, pytest.approx(453.59237), MASS_GRAMS),
        (1, MASS_POUNDS, pytest.approx(453592.37), MASS_MILLIGRAMS),
        (1, MASS_POUNDS, pytest.approx(453592370), MASS_MICROGRAMS),
        (1, MASS_POUNDS, pytest.approx(16), MASS_OUNCES),
        (16, MASS_OUNCES, pytest.approx(0.45359237), MASS_KILOGRAMS),
        (16, MASS_OUNCES, pytest.approx(453.59237), MASS_GRAMS),
        (16, MASS_OUNCES, pytest.approx(453592.37), MASS_MILLIGRAMS),
        (16, MASS_OUNCES, pytest.approx(453592370), MASS_MICROGRAMS),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (500, VOLUME_LITERS, pytest.approx(500000), VOLUME_MILLILITERS),
        (500, VOLUME_MILLILITERS, pytest.approx(0.01765733), VOLUME_CUBIC_FEET),
        (500, VOLUME_MILLILITERS, pytest.approx(0.0005), VOLUME_CUBIC_METERS),
