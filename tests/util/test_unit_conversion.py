...
_CONVERTED_VALUE: dict[
    ...
    TemperatureDeltaConverter: [
        (100, UnitOfTemperatureDelta.CELSIUS, 180, UnitOfTemperatureDelta.FAHRENHEIT),
        (100, UnitOfTemperatureDelta.CELSIUS, 100, UnitOfTemperatureDelta.KELVIN),
        (72, UnitOfTemperatureDelta.FAHRENHEIT, 40, UnitOfTemperatureDelta.CELSIUS),
        (72, UnitOfTemperatureDelta.FAHRENHEIT, 40, UnitOfTemperatureDelta.KELVIN),
        (100, UnitOfTemperatureDelta.KELVIN, 100, UnitOfTemperatureDelta.CELSIUS),
        (100, UnitOfTemperatureDelta.KELVIN, 180, UnitOfTemperatureDelta.FAHRENHEIT),
    ],
    UnitlessRatioConverter: [
