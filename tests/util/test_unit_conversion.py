...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VolumeConverter, UnitOfVolume.UK_GALLONS),
        (VolumeConverter, UnitOfVolume.UK_FLUID_OUNCES),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (500, UnitOfVolume.UK_FLUID_OUNCES, 3.125, UnitOfVolume.UK_GALLONS),
        (
            500,
            UnitOfVolume.UK_FLUID_OUNCES,
        ...
        (500, UnitOfVolume.UK_GALLONS, pytest.approx(80.2718), UnitOfVolume.CUBIC_FEET),
        (500, UnitOfVolume.UK_GALLONS, 2.273045, UnitOfVolume.CUBIC_METERS),
        (500, UnitOfVolume.UK_GALLONS, 80000, UnitOfVolume.UK_FLUID_OUNCES),
        (500, UnitOfVolume.UK_GALLONS, 2273.045, UnitOfVolume.LITERS),
        (500, UnitOfVolume.UK_GALLONS, 2273045, UnitOfVolume.MILLILITERS),
