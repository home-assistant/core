...
IGNORE_UNCAUGHT_EXCEPTIONS = [
    ...
    (
        ...
        "test_setup_platform_discover_duplicate",
    ),
    (
        "tests.components.directv.test_media_player",
        "test_setup_platform_discover_client",
    ),
    ...
    ("tests.components.zha.test_gateway", "test_device_left"),
    ...
    ("tests.components.zha.test_sensor", "test_temp_uom"),
