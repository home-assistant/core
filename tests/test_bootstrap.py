...
INTEGRATIONS_WITH_DEFERRED_PLATFORM_FORWARDS = {"hassio"}
# hassio is a special case where it won't forward the platforms until the recorder
# is setup.
...
async def test_no_base_platforms_loaded_before_recorder(hass: HomeAssistant) -> None:
    ...
    for integration in integrations:
        if integration.domain in INTEGRATIONS_WITH_DEFERRED_PLATFORM_FORWARDS:
            continue
