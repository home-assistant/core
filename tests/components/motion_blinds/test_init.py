...
async def test_position_polling_stops_when_stable(hass: HomeAssistant) -> None:
    """Polling loop terminates once the position is the same for three consecutive reads."""
    ...
    with (
        ...
        # First two calls: fewer than 3 samples → not enough to confirm stability.
        ...
        # Third call: same position three times → polling must stop.
        await entity.async_scheduled_update_request()
