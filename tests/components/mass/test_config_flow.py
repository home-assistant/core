...
from homeassistant.components.mass import config_flow
from homeassistant.components.mass.config_flow import CONF_URL
from homeassistant.components.mass.const import DOMAIN
...
@patch("homeassistant.components.mass.config_flow.get_server_info")
...
@patch("homeassistant.components.mass.config_flow.MusicAssistantClient")
async def test_flow_discovery_confirm_creates_config_entry(
    m_mass, hass: HomeAssistant
) -> None:
