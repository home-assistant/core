...
async def test_get_triggers(hass, device_reg, entity_reg):
    ...
    entity_reg.async_get_or_create(
        "media_player", DOMAIN, MOCK_SERIAL_NO, device_id=device_entry.id
    )
    expected_triggers = [
        {
            "platform": "device",
            ...
            "entity_id": "media_player.philips_js_1234567890",
        },
    ]
...
async def test_if_fires_on_turn_on_request(hass, calls, mock_entity):
