...
from homeassistant.components.climate.const import (
    ATTR_AUX_HEAT, ATTR_PRESET_MODE, ATTR_HUMIDITY,
    ATTR_HVAC_MODE, ATTR_SWING_MODE, ATTR_TARGET_TEMP_HIGH,
    ATTR_TARGET_TEMP_LOW, DOMAIN, SERVICE_SET_AUX_HEAT,
    SERVICE_SET_PRESET_MODE, SERVICE_SET_HUMIDITY, SERVICE_SET_HVAC_MODE,
    SERVICE_SET_SWING_MODE, SERVICE_SET_TEMPERATURE, HVAC_MODE_HEAT,
