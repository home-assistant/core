...
class TestHoneywellRound(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertEqual(TEMP_CELSIUS, self.round1._platform_unit_of_measurement)
        ...
        self.assertEqual(TEMP_CELSIUS, self.round2._platform_unit_of_measurement)
...
class TestHoneywellUS(unittest.TestCase):
    ...
    def test_unit_of_measurement(self):
        ...
        self.assertEqual(TEMP_FAHRENHEIT, self.honeywell._platform_unit_of_measurement)
        self.device.temperature_unit = 'C'
        self.assertEqual(TEMP_CELSIUS, self.honeywell._platform_unit_of_measurement)
