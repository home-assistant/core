...
async def test_setup(hass, two_zone_alarm):  # noqa: F811
    ...
    await setup_risco(hass, alarm=two_zone_alarm)
...
async def test_bypass(hass, two_zone_alarm):  # noqa: F811
    ...
    mock = await setup_risco(hass, alarm=two_zone_alarm)
    with patch.object(mock, "bypass_zone") as mock2:
        ...
        mock2.assert_awaited_once_with(0, True)
...
async def test_unbypass(hass, two_zone_alarm):  # noqa: F811
    ...
    with patch.object(mock, "bypass_zone") as mock2:
        ...
        mock2.assert_awaited_once_with(0, False)
