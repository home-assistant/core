...
from homeassistant.components.keyboard_remote import DOMAIN, KEYBOARD_REMOTE_CONNECTED
...
def create_watcher(manager: MockManager):
    ...
    class Watcher(WatcherInterface):
        ...
        async def watch(self, *args, **kwargs) -> None:
            """Mock call."""
...
@pytest.fixture
async def keyboard_remote(hass: HomeAssistant, request: pytest.FixtureRequest) -> None:
    ...
    await asyncio.wait_for(listener.wait(), 0.01)
