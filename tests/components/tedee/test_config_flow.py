...
async def test_reauth_flow_errors(
    ...
    mock_tedee.get_local_bridge.side_effect = TedeeLocalAuthException("Invalid token")
    ...
    mock_tedee.get_local_bridge.side_effect = TedeeClientException("")
    ...
    assert len(mock_tedee.get_local_bridge.mock_calls) == 2
