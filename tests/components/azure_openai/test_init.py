...
from homeassistant.components.azure_openai import CONF_CHAT_MODEL
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "azure_openai integration not ready yet",
        ),
    ],
)
...
async def test_migration_from_v1_disabled(
    ...
    assert not entry.options
    assert entry.title == "Azure OpenAI Conversation"
...
async def test_migration_from_v2_2(
    ...
    assert ai_task_subentry.title == "Azure OpenAI AI Task"
...
async def test_migration_from_v2_4(
    ...
    assert tts_subentry.title == "Azure OpenAI TTS"
...
async def test_migration_from_v2_5(
    ...
    assert stt_subentry.title == "Azure OpenAI STT"
