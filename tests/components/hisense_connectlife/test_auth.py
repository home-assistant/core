...
from homeassistant.components.hisense_connectlife.auth import HisenseAuthProvider
...
async def test_get_access_token_legacy_oauth2(mock_hass, mock_legacy_config_entry):
    ...
    with patch("homeassistant.components.hisense_connectlife.auth.HisenseOAuth2Implementation") as mock_impl:
        ...
        with patch("homeassistant.components.hisense_connectlife.auth.OAuth2Session") as mock_oauth2_session:
