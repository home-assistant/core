...
async def test_async_setup_entry(hass: HomeAssistant, mock_config_entry: ConfigEntry):
    ...
    from homeassistant.components.hisense_connectlife import async_setup_entry
    
    with patch("homeassistant.components.hisense_connectlife.HisenseACPluginDataUpdateCoordinator") as mock_coord_class:
