...
from homeassistant.components.hisense_connectlife.diagnostics import (
...
async def test_diagnostics_redaction():
    ...
    from homeassistant.components.hisense_connectlife.diagnostics import TO_REDACT
    ...
    with patch("homeassistant.components.hisense_connectlife.diagnostics.async_redact_data") as mock_redact:
