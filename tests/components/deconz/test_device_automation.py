    ...
    expected_triggers = [
        {
            ...
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_on_short_press",
        },
        {
            "device_id": device_id,
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_on_long_press",
        },
        {
            "device_id": device_id,
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_on_long_release",
        },
        {
            "device_id": device_id,
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_off_short_press",
        },
        {
            "device_id": device_id,
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_off_long_press",
        },
        {
            "device_id": device_id,
            "domain": "deconz",
            "platform": "device",
            "type": "remote_button_turn_off_long_release",
        },
    ]
