...
async def test_sensor_access_denied(hass: HomeAssistant, config_entry: ConfigEntry):
...
async def test_sensor_not_supported(hass: HomeAssistant, config_entry: ConfigEntry):
    """Test for Renault sensors with access denied failure."""
