...
from spencerassistant.components import keenetic_ndms2 as keenetic, ssdp
from spencerassistant.components.keenetic_ndms2 import const
from spencerassistant.const import CONF_HOST, CONF_SOURCE
...
async def test_flow_works(hass: spencerAssistant, connect) -> None:
    """Test config flow."""
    ...
    with patch(
        "spencerassistant.components.keenetic_ndms2.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
async def test_host_already_configured(hass: spencerAssistant, connect) -> None:
...
async def test_connection_error(hass: spencerAssistant, connect_error) -> None:
...
async def test_ssdp_works(hass: spencerAssistant, connect) -> None:
...
async def test_ssdp_already_configured(hass: spencerAssistant) -> None:
    """Test host already configured and discovered."""
...
async def test_ssdp_ignored(hass: spencerAssistant) -> None:
...
async def test_ssdp_update_host(hass: spencerAssistant) -> None:
...
async def test_ssdp_reject_no_udn(hass: spencerAssistant) -> None:
...
async def test_ssdp_reject_non_keenetic(hass: spencerAssistant) -> None:
