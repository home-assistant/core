...
from . import HTPWX_SERVICE_INFO, HTW_SERVICE_INFO, NOT_GOVEE_SERVICE_INFO
...
async def test_async_step_bluetooth_not_govee_ble(hass):
    """Test discovery via bluetooth not govee_ble."""
    result = await hass.config_entries.flow.async_init(
        DOMAIN,
        context={"source": config_entries.SOURCE_BLUETOOTH},
