...
from pure_energie import PureEnergieMeterConnectionError
...
@patch(
    "homeassistant.components.pure_energie.PureEnergie.request",
    side_effect=PureEnergieMeterConnectionError,
)
