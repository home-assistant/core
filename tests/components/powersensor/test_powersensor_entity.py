...
from homeassistant.components.powersensor.sensor.powersensor_entity import (
    PowersensorEntity,
    PowersensorSensorEntityDescription,
)
from homeassistant.components.powersensor.sensor.powersensor_household_entity import (
    HouseholdMeasurements,
    PowersensorHouseholdEntity,
)
from homeassistant.components.powersensor.sensor.powersensor_sensor_entity import (
    PowersensorSensorEntity,
)
from homeassistant.components.powersensor.sensor.sensor_measurements import (
    SensorMeasurements,
)
...
async def test_powersensor_sensor_handle_role_update(
    ...
    powersensor_entity_module = importlib.import_module(
        "homeassistant.components.powersensor.sensor.powersensor_entity"
    )
    er = Mock()
    dr = Mock()
    ...
    powersensor_sensor_entity_module = importlib.import_module(
        "homeassistant.components.powersensor.sensor.powersensor_sensor_entity"
    )
