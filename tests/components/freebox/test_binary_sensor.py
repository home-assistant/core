...
async def test_home(
    ...
    assert (
        hass.states.get("binary_sensor.ouverture_porte_cover_removed").attributes[
            ATTR_DEVICE_CLASS
        ]
    ...
    assert hass.states.get("binary_sensor.detecteur_cover_removed").state == "off"
    assert hass.states.get("binary_sensor.ouverture_porte").state == "unknown"
    assert hass.states.get("binary_sensor.ouverture_porte_cover_removed").state == "off"
    ...
    assert hass.states.get("binary_sensor.detecteur_cover_removed").state == "on"
    assert hass.states.get("binary_sensor.ouverture_porte").state == "off"
    assert hass.states.get("binary_sensor.ouverture_porte_cover_removed").state == "on"
