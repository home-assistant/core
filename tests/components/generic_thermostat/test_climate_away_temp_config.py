...
@pytest.fixture
async def setup_comp_away_1(hass):
...
async def test_default_setup_params(hass, setup_comp_away_1):
...
async def test_get_hvac_modes(hass, setup_comp_away_1):
...
async def test_set_target_temp(hass, setup_comp_away_1):
...
async def test_set_away_mode(hass, setup_comp_away_1):
...
async def test_set_away_mode_and_restore_prev_temp(hass, setup_comp_away_1):
...
async def test_set_away_mode_twice_and_restore_prev_temp(hass, setup_comp_away_1):
...
async def test_sensor_bad_value(hass, setup_comp_away_1):
...
async def test_set_target_temp_heater_on(hass, setup_comp_away_1):
...
async def test_set_target_temp_heater_off(hass, setup_comp_away_1):
...
async def test_temp_change_heater_on_within_tolerance(hass, setup_comp_away_1):
...
async def test_temp_change_heater_on_outside_tolerance(hass, setup_comp_away_1):
...
async def test_temp_change_heater_off_within_tolerance(hass, setup_comp_away_1):
...
async def test_temp_change_heater_off_outside_tolerance(hass, setup_comp_away_1):
...
async def test_running_when_hvac_mode_is_off(hass, setup_comp_away_1):
...
async def test_no_state_change_when_hvac_mode_off(hass, setup_comp_away_1):
...
async def test_hvac_mode_heat(hass, setup_comp_away_1):
...
@pytest.fixture
async def setup_comp_away_2(hass):
    """Initialize components."""
...
async def test_set_target_temp_ac_off(hass, setup_comp_away_2):
...
async def test_turn_away_mode_on_cooling(hass, setup_comp_away_2):
...
async def test_hvac_mode_cool(hass, setup_comp_away_2):
...
async def test_set_target_temp_ac_on(hass, setup_comp_away_2):
...
async def test_temp_change_ac_off_within_tolerance(hass, setup_comp_away_2):
...
async def test_set_temp_change_ac_off_outside_tolerance(hass, setup_comp_away_2):
...
async def test_temp_change_ac_on_within_tolerance(hass, setup_comp_away_2):
...
async def test_temp_change_ac_on_outside_tolerance(hass, setup_comp_away_2):
...
async def test_running_when_operating_mode_is_off_2(hass, setup_comp_away_2):
    """Test that the switch turns off when enabled is set False."""
    calls = _setup_switch(hass, True)
    await common.async_set_temperature(hass, 30)
    await common.async_set_hvac_mode(hass, HVAC_MODE_OFF)
...
async def test_no_state_change_when_operation_mode_off_2(hass, setup_comp_away_2):
    """Test that the switch doesn't turn on when enabled is False."""
    calls = _setup_switch(hass, False)
    await common.async_set_temperature(hass, 30)
    await common.async_set_hvac_mode(hass, HVAC_MODE_OFF)
...
@pytest.fixture
async def setup_comp_away_3(hass):
    """Initialize components."""
