...
@pytest.mark.parametrize(
    ...
    [
        ("motion.detected", {}, True, True),
        ("motion.cleared", {}, True, True),
    ],
)
async def test_motion_trigger_options_validation(
    hass: HomeAssistant,
    trigger_key: str,
    ...
    """Test that motion triggers support the expected options."""
