...
async def test_pool_sensors(hass: HomeAssistant) -> None:
    ...
    # Salt concentration
    state = hass.states.get("sensor.home_salt_concentration")
    assert state
