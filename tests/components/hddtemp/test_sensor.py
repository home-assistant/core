...
@patch("telnetlib.Telnet", new=TelnetMock)
async def test_hddtemp_rename_config(hass):
...
@patch("telnetlib.Telnet", new=TelnetMock)
async def test_hddtemp_one_disk(hass):
