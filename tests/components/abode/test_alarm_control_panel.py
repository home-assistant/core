...
async def test_set_alarm_away(hass: HomeAssistant):
...
async def test_set_alarm_home(hass: HomeAssistant):
...
async def test_set_alarm_standby(hass: HomeAssistant):
...
async def test_state_unknown(hass: HomeAssistant):
