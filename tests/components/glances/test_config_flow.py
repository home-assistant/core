...
from spencerassistant.components import glances
...
def glances_setup_fixture():
    ...
    with patch("spencerassistant.components.glances.async_setup_entry", return_value=True):
        yield
...
async def test_form_cannot_connect(hass: spencerAssistant, mock_api: MagicMock) -> None:
