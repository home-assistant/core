...
@pytest.mark.asyncio
@mock.patch("openaq.__new__", OpenAQMock("location_bad.json", "measurements_good.json"))
...
@pytest.mark.asyncio
@mock.patch(
    "openaq.__new__", OpenAQMock("location_no_devices.json", "measurements_good.json")
)
...
@mock.patch(
    "openaq.__new__",
    OpenAQMock("location_wrong_location_id.json", "measurements_good.json"),
)
