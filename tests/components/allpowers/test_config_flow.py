...
async def test_user_step_success(hass: HomeAssistant) -> None:
    ...
    with patch(
        "homeassistant.components.allpowers._ble.config_flow.async_discovered_service_info",
    ...
    with patch(
        "homeassistant.components.allpowers._ble.config_flow.AllpowersBLE.initialise",
    ), patch(
        "homeassistant.components.allpowers._ble.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
