...
async def test_v4_new_sensors_imperial(hass: HomeAssistant) -> None:
    ...
    check_sensor_state(hass, RAIN_INTENSITY, "0.1")
    check_sensor_state(hass, SNOW_INTENSITY, "0.0")
    check_sensor_state(hass, SLEET_INTENSITY, "0.0")
    check_sensor_state(hass, FREEZING_RAIN_INTENSITY, "0.0")
    check_sensor_state(hass, PRECIPITATION_INTENSITY, "0.1")
    check_sensor_state(hass, PRECIPITATION_PROBABILITY, "45")
