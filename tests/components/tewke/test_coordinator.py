...
from pytewke.error import PyTewkeCoapError, PyTewkeInvalidResponseError, PyTewkeUnknownError
...
from homeassistant.components.tewke.coordinator import TewkeCoordinator, _OBSERVATION_TIMEOUT_SECS
import logging
import asyncio
