...
def test_get_power_state_heater():
    ...
    device_data_on = {"isEnabled": True, "deviceType": {"childType": {"name": EDeviceType.PANEL_HEATER_GEN3.value}}}
    device_data_off = {"isEnabled": False, "deviceType": {"childType": {"name": EDeviceType.PANEL_HEATER_GEN3.value}}}
...
def test_get_target_temperature():
    ...
    assert DeviceMetric.get_capability_value(device_data, EDeviceCapability.TARGET_TEMPERATURE) == 22.5

# Add more tests for various capabilities and device types