...
@pytest.mark.parametrize(
    ("entity_name", "method_name", "args1", "args2"),
    [
        ("", "set_power", (False, None), (True, None)),
        ("_auto_on_off", "set_auto_on_off_global", (False,), (True,)),
        ("_steam_boiler", "set_steam", (False, None), (True, None)),
    ],
)
async def test_switches(
    ...
    control_fn.assert_called_once_with(*args1)
    ...
    control_fn.assert_called_with(*args2)
