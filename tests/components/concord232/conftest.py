...
def mock_concord232_client() -> Generator[MagicMock]:
    ...
    with (patch(
        "homeassistant.components.concord232.alarm_control_panel.concord232_client.Client", autospec=True
    ) as mock_client_class, patch(
        "homeassistant.components.concord232.binary_sensor.concord232_client.Client", new=mock_client_class
    )):
