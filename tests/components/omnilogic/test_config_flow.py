...
from homeassistant.components.omnilogic.config_flow import CannotConnect, InvalidAuth
...
async def test_form(hass):
    ...
    with patch(
        "homeassistant.components.omnilogic.config_flow.PlaceholderHub.authenticate",
        return_value=True,
    ), patch(
