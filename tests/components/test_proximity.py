...
class TestProximity:
    ...
    def test_proximity_device_no_device(self):
    ...
    def test_proximity_device_no_zones(self):
        assert not proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'type' : 'device',
    ...
    def test_proximity_device_no_initial_state(self):
        self.hass.states.set(
            'device_tracker.test1', 'not_home',
            {
                'friendly_name': 'test1'
    ...
    def test_proximity_device_no_new_state(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_proximity_device_arrived_in_zone(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_proximity_device_moving(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_proximity_device_moving_further(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_proximity_device_moving_closer(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_proximity_device_moving_a_bit(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'test1': {
                    'zones': {
    ...
    def test_all_device_trackers_in_ignored_zones_zone(self):
        assert proximity.setup(self.hass, {
            'proximity': {
                'home': {
                    'zone': 'home',
    ...
    def test_all_device_trackers_in_ignored_zones_zone_at_start(self):
        self.hass.states.set(
            'device_tracker.test1', 'work',
            {
                'friendly_name': 'test1',
