...
async def test_temperature_sensor_f(hass: HomeAssistant) -> None:
    """Test function."""
...
async def test_temperature_sensor_c(hass: HomeAssistant) -> None:
    """Test function."""
    await run_sensor_test(
        hass=hass,
        category=CATEGORY_TEMPERATURE_SENSOR,
...
async def test_light_sensor(hass: HomeAssistant) -> None:
    """Test function."""
    await run_sensor_test(
        hass=hass,
...
async def test_uv_sensor(hass: HomeAssistant) -> None:
    """Test function."""
    await run_sensor_test(
        hass=hass,
...
async def test_power_meter_sensor(hass: HomeAssistant) -> None:
    """Test function."""
    await run_sensor_test(
        hass=hass,
...
async def test_trippable_sensor(hass: HomeAssistant) -> None:
    """Test function."""
...
async def test_scene_controller_sensor(hass: HomeAssistant) -> None:
    """Test function."""
    vera_device = MagicMock(spec=VeraSensor)  # type: VeraSensor
    vera_device.device_id = 1
    vera_device.name = "dev1"
