...
@pytest.fixture
def mock_omie_results_oct15() -> OMIEResults:
    """Return mock OMIEResults for 2025-10-15."""
    test_date = dt.date(2025, 10, 15)
    spot_data = SpotData(
        url="https://example.com?date=2025-10-15",
        market_date=test_date.isoformat(),
        header="Test Data Oct 15",
        es_pt_total_power=[],
        es_purchases_power=[],
        pt_purchases_power=[],
        es_sales_power=[],
