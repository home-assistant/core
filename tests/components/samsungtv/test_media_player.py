...
<<<<<<< HEAD
=======
async def test_update_autodetect_websocket(hass, remote, mock_now):
    """Testing update with autodetection of protocol."""
    with patch(
        "homeassistant.components.samsungtv.media_player.SamsungRemote"
...
async def test_update_autodetect_websocket_exception(hass, remote, mock_now, caplog):
    """Testing update with autodetection of protocol."""
...
async def test_update_autodetect_legacy(hass, remote, mock_now):
    """Testing update with autodetection of protocol."""
    with patch(
        "homeassistant.components.samsungtv.media_player.SamsungRemote",
        side_effect=[OSError("Boom"), mock.DEFAULT],
...
async def test_update_autodetect_none(hass, remote, mock_now):
    """Testing update with autodetection of protocol."""
    with patch(
        "homeassistant.components.samsungtv.media_player.SamsungRemote",
