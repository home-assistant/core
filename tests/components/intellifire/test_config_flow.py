...
async def test_options_flow(
    ...
    with patch(
        "homeassistant.components.intellifire.__init__.UnifiedFireplace._switch_read_mode"
    ), patch(
        "homeassistant.components.intellifire.__init__.UnifiedFireplace.set_control_mode"
    ), patch("homeassistant.components.intellifire._async_wait_for_initialization"):
        mock_config_entry_current.add_to_hass(hass)
        ...
        assert mock_config_entry_current.options[CONF_READ_MODE] == API_MODE_CLOUD
        assert mock_config_entry_current.options[CONF_CONTROL_MODE] == API_MODE_LOCAL
        await hass.async_block_till_done()
