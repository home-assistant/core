...
async def test_uptime_sensor_hours_output():
    """Test uptime sensor output data."""
...
async def test_uptime_sensor_minutes_output():
    """Test uptime sensor output data."""
