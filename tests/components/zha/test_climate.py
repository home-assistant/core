...
async def device_climate_tsinop(device_climate_mock):
    """Sinope thermostat."""
...
async def test_sinop(hass, device_climate_tsinop):
    """Test preset setting."""

    entity_id = await find_entity_id(DOMAIN, device_climate_tsinop, hass)
    thrm_cluster = device_climate_tsinop.device.endpoints[1].thermostat
