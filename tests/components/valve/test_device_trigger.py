"""The tests for Valve device triggers."""
...
@pytest.mark.parametrize(
    ...
    [
        (False, ValveEntityFeature.OPEN, 0, ["opened", "closed", "opening", "closing"]),
        (
            False,
            ValveEntityFeature.OPEN | ValveEntityFeature.SET_POSITION,
            0,
        ...
        (True, 0, ValveEntityFeature.OPEN, ["opened", "closed", "opening", "closing"]),
        (
            True,
            0,
            ValveEntityFeature.OPEN | ValveEntityFeature.SET_POSITION,
...
async def test_get_triggers(
    ...
    """Test we get the expected triggers from a valve."""
...
async def test_get_trigger_capabilities(
    ...
    """Test we get the expected capabilities from a valve trigger."""
...
async def test_if_fires_on_position(
    ...
    assert sorted(
        ...
        [
            (
                "is_pos_gt_45_lt_90 - device - valve.set_position_valve - closed - open"
                " - None"
            ),
            "is_pos_lt_90 - device - valve.set_position_valve - closed - open - None",
            "is_pos_gt_45 - device - valve.set_position_valve - open - closed - None",
        ]
    )
    ...
    assert (
        calls[3].data["some"]
        == "is_pos_lt_90 - device - valve.set_position_valve - closed - closed - None"
    )
    ...
    assert (
        calls[4].data["some"]
        == "is_pos_gt_45 - device - valve.set_position_valve - closed - closed - None"
    )
