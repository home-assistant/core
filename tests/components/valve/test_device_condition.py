"""The tests for Valve device conditions."""
import pytest
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (False, ValveEntityFeature.SET_POSITION, 0, ["is_position"]),
        (True, 0, 0, []),
        (
            True,
            0,
        ...
        (True, 0, ValveEntityFeature.SET_POSITION, ["is_position"]),
    ],
)
async def test_get_conditions(
    ...
    """Test we get the expected conditions from a valve."""
...
async def test_get_condition_capabilities(
    ...
    """Test we get the expected capabilities from a valve condition."""
