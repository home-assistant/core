...
class TestSoundtouchMediaPlayer(unittest.TestCase):
    ...
    @mock.patch("homeassistant.components.soundtouch.media_player.soundtouch_device", side_effect=None)
    ...
    @mock.patch("homeassistant.components.soundtouch.media_player.soundtouch_device", side_effect=_mock_soundtouch_device)
