...
@pytest.mark.parametrize(
    ...
    [
        {},
        {
            ...
            "backup_retention": {"copies": 3, "days": 7},
        ...
        },
        {
            ...
            "backup_retention": {"copies": 3, "days": None},
        ...
        },
        {
            ...
            "backup_retention": {"copies": None, "days": 7},
            "last_automatic_backup": datetime.fromisoformat(
                "2024-10-26T04:45:00+01:00"
            ),
            "schedule": "never",
        },
        {
            ...
            "backup_retention": {"copies": None, "days": None},
            "last_automatic_backup": None,
            "schedule": "mon",
        },
        {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        },
        {
            "type": "backup/config/update",
            "create_backup": {"agent_ids": ["test-agent"]},
            "backup_retention": {"copies": 3},
            "schedule": "daily",
        },
        {
            "type": "backup/config/update",
            "create_backup": {"agent_ids": ["test-agent"]},
            "backup_retention": {"days": 7},
            "schedule": "daily",
        },
    ],
)
        ...
        (
            {
                "type": "backup/config/update",
                "create_backup": {"agent_ids": ["test-agent"]},
                "backup_retention": {"copies": 2, "days": None},
                "schedule": "daily",
            },
            {
                "backup-1": MagicMock(date="2024-11-09T04:45:00+01:00"),
        ...
        (
            {
                "type": "backup/config/update",
                "create_backup": {"agent_ids": ["test-agent"]},
                "backup_retention": {"copies": 0, "days": None},
                "schedule": "daily",
            },
            {
                "backup-1": MagicMock(date="2024-11-09T04:45:00+01:00"),
...
async def test_config_backup_retention_copies_logic(
    hass: HomeAssistant,
    hass_ws_client: WebSocketGenerator,
    freezer: FrozenDateTimeFactory,
    hass_storage: dict[str, Any],
        ...
        (
            {
                "type": "backup/config/update",
                "create_backup": {"agent_ids": ["test-agent"]},
                "backup_retention": {"copies": None, "days": 2},
                "schedule": "never",
            },
            {
                "backup-1": MagicMock(date="2024-11-10T04:45:00+01:00"),
        ...
        (
            {
                "type": "backup/config/update",
                "create_backup": {"agent_ids": ["test-agent"]},
                "backup_retention": {"copies": None, "days": 3},
                "schedule": "never",
            },
            {
                "backup-1": MagicMock(date="2024-11-10T04:45:00+01:00"),
        ...
        (
            {
                "type": "backup/config/update",
                "create_backup": {"agent_ids": ["test-agent"]},
                "backup_retention": {"copies": None, "days": 0},
                "schedule": "never",
            },
            {
                "backup-1": MagicMock(date="2024-11-09T04:45:00+01:00"),
...
async def test_config_backup_retention_days_logic(
    hass: HomeAssistant,
    hass_ws_client: WebSocketGenerator,
    freezer: FrozenDateTimeFactory,
    hass_storage: dict[str, Any],
