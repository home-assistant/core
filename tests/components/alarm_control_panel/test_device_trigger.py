...
async def test_if_fires_on_state_change(
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.PENDING)
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.TRIGGERED)
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.DISARMED)
    await hass.async_block_till_done()
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.ARMED_HOME)
    await hass.async_block_till_done()
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.ARMED_AWAY)
    await hass.async_block_till_done()
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.ARMED_NIGHT)
    await hass.async_block_till_done()
    ...
    hass.states.async_set(entry.entity_id, AlarmControlPanelEntityState.ARMED_VACATION)
    await hass.async_block_till_done()
