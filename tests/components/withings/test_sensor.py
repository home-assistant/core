...
class TestWithingsHealthSensor:
    ...
    async def test_async_update(self):
        ...
        await self.assert_sensor_equals(0.79, const.MEAS_FAT_MASS_STONE)
        ...
        await self.assert_sensor_equals(9.45, const.MEAS_FAT_FREE_MASS_STONE)
        ...
        await self.assert_sensor_equals(7.87, const.MEAS_MUSCLE_MASS_STONE)
        await self.assert_sensor_equals(10, const.MEAS_BONE_MASS_KG)
        await self.assert_sensor_equals(22.05, const.MEAS_BONE_MASS_LB)
        await self.assert_sensor_equals(1.57, const.MEAS_BONE_MASS_STONE)
