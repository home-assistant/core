...
async def test_dispatcher_cleanup_on_unload(
    ...
    # Register a binary sensor via webhook when config entry is loaded
    reg_resp = await webhook_client.post(
        webhook_url,
        json={
            "type": "register_sensor",
    ...
    # Try to register another binary sensor after unload - webhook still exists but dispatcher is disconnected
    ...
    # Register a new binary sensor after reload - this should work
