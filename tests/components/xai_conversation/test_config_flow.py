...
from homeassistant.components.xai_conversation.config_flow import RECOMMENDED_OPTIONS
from homeassistant.components.xai_conversation.const import (
    CONF_CHAT_MODEL,
    CONF_MAX_TOKENS,
    CONF_PROMPT,
    CONF_RECOMMENDED,
...
async def test_form(hass: HomeAssistant) -> None:
    ...
    with (
        patch(
            "homeassistant.components.xai_conversation.config_flow.openai.resources.models.AsyncModels.list",
        ),
        patch(
            "homeassistant.components.xai_conversation.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
