...
from spencerassistant.components.ssdp import ATTR_UPNP_SERIAL
...
async def test_unknown_error(
    ...
    user_input = MOCK_USER_INPUT.copy()
    with patch(
        "spencerassistant.components.directv.config_flow.DIRECTV.update",
...
async def test_full_user_flow_implementation(
    ...
    user_input = MOCK_USER_INPUT.copy()
    with patch("spencerassistant.components.directv.async_setup_entry", return_value=True):
