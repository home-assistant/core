...
async def test_v3_load_and_unload(
    ...
    assert weather_state.attributes == {
        ...
        ATTR_FRIENDLY_NAME: "ClimaCell - Daily",
        ATTR_WEATHER_HUMIDITY: 24,
        ATTR_WEATHER_OZONE: 51.4375,
        ATTR_WEATHER_PRESSURE: 1028.6258179170002,
        ATTR_WEATHER_TEMPERATURE: 7,
        ATTR_WEATHER_VISIBILITY: 9.994026240000002,
        ATTR_WEATHER_WIND_BEARING: 315.81,
        ATTR_WEATHER_WIND_SPEED: 11.24931456,
    }
...
async def test_v4_load_and_unload(
    ...
    assert weather_state.attributes == {
        ...
        ATTR_FRIENDLY_NAME: "ClimaCell - Daily",
        ATTR_WEATHER_HUMIDITY: 23,
        ATTR_WEATHER_OZONE: 46.53,
        ATTR_WEATHER_PRESSURE: 1027.7690615000001,
        ATTR_WEATHER_TEMPERATURE: 7,
        ATTR_WEATHER_VISIBILITY: 13.116153600000002,
        ATTR_WEATHER_WIND_BEARING: 315.14,
        ATTR_WEATHER_WIND_SPEED: 15.01517952,
    }
