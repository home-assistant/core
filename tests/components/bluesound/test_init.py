...
from homeassistant.components import bluesound, zeroconf
...
# ) -> None:
#     """Test setting up Bluesound loads the media player."""
...
#     with patch(
#         "homeassistant.components.bluesound.media_player.async_setup_entry",
#     ) as mock_setup:
#         result = await hass.config_entries.flow.async_init(
#             bluesound.DOMAIN, context={"source": config_entries.SOURCE_USER}
#         )
...
# async def test_configuring_bluesound_creates_entry(hass: HomeAssistant) -> None:
...
#             hass,
#             bluesound.DOMAIN,
#             {"bluesound": {"media_player": {"interface_addr": "127.0.0.1"}}},
#         )
#         await hass.async_block_till_done()
...
async def test_not_configuring_bluesound_not_creates_entry(hass: HomeAssistant) -> None:
    """Test that no config will not create an entry."""
    with patch(
        "homeassistant.components.bluesound.async_setup_entry",
        return_value=True,
    ) as mock_setup:
        await async_setup_component(hass, bluesound.DOMAIN, {})
        await hass.async_block_till_done()
...
#         "homeassistant.components.bluesound.async_call_later"
#     ) as mock_async_call_later, patch(
#         "homeassistant.components.bluesound.async_dispatcher_send"
#     ), patch(
#         "homeassistant.components.bluesound.sync_get_visible_zones",
#         side_effect=[
#             OSError(),
#             OSError(),
#             [],
...
#     with patch(
#         "homeassistant.components.bluesound.DISCOVERY_INTERVAL"
