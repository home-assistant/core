...
class BluesoundMockEventListener:
    ...
    def __init__(self, ip_address: str) -> None:
        ...
        self.address = [ip_address, "11000"]


class BluesoundMockSubscribe:
    """Mock the subscription."""

    def __init__(self, ip_address: str, *args, **kwargs) -> None:
        """Initialize the mock subscriber."""
        self.event_listener = BluesoundMockEventListener(ip_address)
        self.service = Mock()
...
class BluesoundMockService:
    """Mock a Bluesound Service used in callbacks."""

    def __init__(self, service_type, ip_address="192.168.42.2") -> None:
        """Initialize the instance."""
        self.service_type = service_type
        self.subscribe = AsyncMock(return_value=BluesoundMockSubscribe(ip_address))


class BluesoundMockEvent:
...
@pytest.fixture
async def async_autosetup_bluesound(async_setup_bluesound):
    """Set up a Bluesound integration instance on test run."""
    await async_setup_bluesound()
