...
from homeassistant.components.time import ATTR_HOUR, ATTR_MINUTE, ATTR_SECOND
...
async def test_exclude_attributes(recorder_mock: Recorder, hass: HomeAssistant) -> None:
    ...
    await async_setup_component(hass, time.DOMAIN, {time.DOMAIN: {"platform": "demo"}})
