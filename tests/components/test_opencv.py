"""The tests for the opencv platform."""
import asyncio
from unittest.mock import patch

import homeassistant.components.opencv as ocv
...
class TestOpenCVSetup(object):
    """Test the OpenCV component."""
    ...
    def test_setup_component(self):
        """Setup component."""
        self.config[ocv.DOMAIN][ocv.CONF_GROUPS].append({
            'entity_id': 'camera.test',
        })
        with assert_setup_component(2, ocv.DOMAIN):
            setup_component(self.hass, ocv.DOMAIN, self.config)
    #
