...
from spencerassistant.components.lookin.const import DOMAIN
...
async def test_manual_setup(hass: spencerAssistant):
...
async def test_manual_setup_already_exists(hass: spencerAssistant):
...
async def test_manual_setup_device_offline(hass: spencerAssistant):
...
async def test_manual_setup_unknown_exception(hass: spencerAssistant):
