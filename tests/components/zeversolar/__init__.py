...
async def init_integration(
    ...
    with (
        ...
        patch(
            "homeassistant.components.zeversolar.coordinator.ZeversolarCoordinator.async_probe_power_limit_api",
            return_value=power_limit_supported,
        ),
        patch("homeassistant.components.zeversolar.ir.async_create_issue"),
        patch("homeassistant.components.zeversolar.ir.async_delete_issue"),
    ):
