...
LATEST_DEVICES_STATUS = {
    "Tomato": DeviceStatus.new_from_json_dict(
        json.loads(
            '{"device":"Tomato","uploader":{"battery":70, "batteryVoltage": 2.5,"type":"BRIDGE"},"created_at":"2021-12-04T20:46:58.246Z","utcOffset":-180,"_id":"61abd3c225cca301857efcc4","mills":1638650818246}'
        )
    ),
    "samsung SM-N986B": DeviceStatus.new_from_json_dict(
        json.loads(
            '{"device":"samsung SM-N986B","uploader":{"battery":68,"type":"PHONE"},"created_at":"2021-12-04T20:46:58.160Z","utcOffset":-180,"_id":"61abd3c225cca301857efcc3","mills":1638650818160}'
        )
    ),
}
...
async def init_integration(hass) -> MockConfigEntry:
    ...
    with patch(
        ...
        return_value=LATEST_DEVICES_STATUS,
    ):
