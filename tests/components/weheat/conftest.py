...
def mock_weheat_heat_pump_instance() -> MagicMock:
    ...
    mock_heat_pump_instance.inside_unit_water_pump_state = False
    mock_heat_pump_instance.inside_unit_auxilary_pump_state = False
    mock_heat_pump_instance.inside_unit_dhw_valve_or_pump_state = False
    mock_heat_pump_instance.inside_unit_gas_boiler_state = None
    mock_heat_pump_instance.inside_unit_gas_electric_heater = True
