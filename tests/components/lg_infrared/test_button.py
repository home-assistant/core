...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("button.lg_tv_0", LGTVCode.NUM_0),
        ("button.lg_tv_1", LGTVCode.NUM_1),
        ("button.lg_tv_2", LGTVCode.NUM_2),
        ("button.lg_tv_3", LGTVCode.NUM_3),
        ("button.lg_tv_4", LGTVCode.NUM_4),
        ("button.lg_tv_5", LGTVCode.NUM_5),
        ("button.lg_tv_6", LGTVCode.NUM_6),
        ("button.lg_tv_7", LGTVCode.NUM_7),
        ("button.lg_tv_8", LGTVCode.NUM_8),
        ("button.lg_tv_9", LGTVCode.NUM_9),
    ],
)
@pytest.mark.usefixtures("init_integration")
