...
async def test_user_flow_with_custom_path(hass: HomeAssistant) -> None:
...
async def test_user_flow_with_invalid_path(hass: HomeAssistant) -> None:
    """Test the user flow with an invalid path selected."""
