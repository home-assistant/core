...
def test_setup_audio_pipeline_wake_word(
    ...
    from homeassistant.components.assist_pipeline.websocket_api import (
    ...
    result_args, handler_id, unregister_handler, wake_word_settings, audio_settings = (
        _setup_audio_pipeline(
    ...
    assert audio_settings.auto_gain_dbfs == 15
