...
def fritz_fixture():
    ...
    with patch("homeassistant.components.fritzbox.config_flow.socket") as socket, patch(
...
async def test_user(hass, fritz):
...
async def test_user_auth_failed(hass, fritz):
...
async def test_user_not_successful(hass, fritz):
...
async def test_user_already_configured(hass, fritz):
...
async def test_import(hass, fritz):
...
async def test_ssdp(hass, fritz):
...
async def test_ssdp_auth_failed(hass, fritz):
...
async def test_ssdp_not_successful(hass, fritz):
...
async def test_ssdp_already_in_progress(hass, fritz):
...
async def test_ssdp_already_configured(hass, fritz):
