...
from homeassistant.components.azure_openai_conversation.config_flow import (
    RECOMMENDED_OPTIONS,
)
...
async def test_form(hass: HomeAssistant) -> None:
    ...
    with (
        patch(
            "homeassistant.components.azure_openai_conversation.config_flow.openai.resources.models.AsyncModels.list",
        ),
        patch(
            "homeassistant.components.azure_openai_conversation.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
...
async def test_already_configured(hass: HomeAssistant, mock_config_entry) -> None:
    """Test we can't add the same OpenAI resource twice."""
