...
from homeassistant.components.tplink_omada.common import (
    login
)
...
def mock_connection(
    ...
    fixtures = [
        ...
        (CONTROLLER_PATH, "tplink_omada/global_stats.json", {"globalStat": "", "token": token}),
