...
async def silent_ssdp_listener():
    ...
    with patch("spencerassistant.components.ssdp.SsdpListener.async_start"), patch(
        "spencerassistant.components.ssdp.SsdpListener.async_stop"
    ), patch("spencerassistant.components.ssdp.SsdpListener.async_search"):
...
async def disabled_upnp_server():
    """Disable UPnpServer."""
    with patch("spencerassistant.components.ssdp.UpnpServer.async_start"), patch(
        "spencerassistant.components.ssdp.UpnpServer.async_stop"
    ), patch("spencerassistant.components.ssdp._async_find_next_available_port"):
        yield UpnpServer
