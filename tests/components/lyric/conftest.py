...
def mock_lyric_api() -> Generator[MagicMock]:
    ...
    the actual field names Resideo returns. get_thermostat_rooms is left
    as an autospec'd no-op: this test only covers device-level sensors,
    not the room/priority data it would otherwise populate.
    """
