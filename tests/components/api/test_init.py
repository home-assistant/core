...
async def test_api_list_state_entities(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_get_state(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_get_non_existing_state(hass: HomeAssistant, mock_api_client) -> None:
    """Test if the debug interface allows us to get a state."""
    resp = await mock_api_client.get("/api/states/does_not_exist")
    assert resp.status == HTTPStatus.NOT_FOUND


async def test_api_state_change(hass: HomeAssistant, mock_api_client) -> None:
...
# pylint: disable=invalid-name
async def test_api_state_change_push(hass: HomeAssistant, mock_api_client) -> None:
...
# pylint: disable=invalid-name
async def test_api_fire_event_with_data(hass: HomeAssistant, mock_api_client) -> None:
    """Test if the API allows us to fire an event."""
    test_value = []
...
async def test_api_get_config(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_get_components(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_get_event_listeners(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_get_services(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_call_service_no_data(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_call_service_with_data(hass: HomeAssistant, mock_api_client) -> None:
    """Test if the API allows us to call a service."""
...
async def test_api_template(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_template_error(hass: HomeAssistant, mock_api_client) -> None:
    """Test the template API."""
    hass.states.async_set("sensor.temperature", 10)
...
async def test_stream(hass: HomeAssistant, mock_api_client) -> None:
    """Test the stream."""
...
async def test_stream_with_restricted(hass: HomeAssistant, mock_api_client) -> None:
...
async def test_api_fire_event_context(
    hass: HomeAssistant, mock_api_client, hass_access_token
) -> None:
...
async def test_event_stream_requires_admin(
    hass: HomeAssistant, mock_api_client, hass_admin_user
) -> None:
...
async def test_api_call_service_not_found(hass: HomeAssistant, mock_api_client) -> None:
    """Test if the API fails 400 if unknown service."""
    resp = await mock_api_client.post("/api/services/test_domain/test_service")
    assert resp.status == HTTPStatus.BAD_REQUEST


async def test_api_call_service_bad_data(hass: HomeAssistant, mock_api_client) -> None:
    """Test if the API fails 400 if unknown service."""
    test_value = []
