...
async def test_unload_entry(mock_meter_service: Mock, hass: HomeAssistant) -> None:
...
async def test_migrate_entry(
    mock_meter_service: Mock, hass: HomeAssistant, entity_registry: er.EntityRegistry
) -> None:
