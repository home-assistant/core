...
async def test_hold_switch(hass: HomeAssistant, mock_nexia_home: NexiaHome, patch_nexia_home) -> None:
...
async def test_nexia_sensor_switch(
    hass: HomeAssistant, mock_nexia_home: NexiaHome, patch_nexia_home, freezer: FrozenDateTimeFactory
) -> None:
