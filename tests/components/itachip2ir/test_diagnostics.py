...
async def test_diagnostics_includes_infrared_entity_remote_options(
    hass: HomeAssistant,
) -> None:
    """Test diagnostics includes remote options with infrared entity ids."""
    entry = _make_entry(
        options={
            "virtual_remotes": [
                {
                    "id": "tv",
                    "name": "TV",
                    "infrared_entity_id": "infrared.port_1",
                    "commands": {"power": "100,200"},
                }
            ]
        }
    )
    ...
    assert diagnostics["entry"]["options"]["virtual_remotes"] == [
        {
            "id": "tv",
            "name": "TV",
            "infrared_entity_id": "infrared.port_1",
