...
async def test_full_user_flow(hass: HomeAssistant, mock_lastfm_network: AsyncMock, mock_setup_entry: AsyncMock) -> None:
...
async def test_flow_fails(
    hass: HomeAssistant, error: Exception, message: str, mock_lastfm_network: AsyncMock, mock_setup_entry: AsyncMock
) -> None:
