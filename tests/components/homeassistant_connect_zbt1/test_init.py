"""Test the Home Assistant Connect ZBT-1 integration."""
...
CONFIG_ENTRY_DATA = {
    "device": "/dev/serial/by-id/usb-Nabu_Casa_Connect ZBT-1_v1.0_9e2adbd75b8beb119fe564a0f320645d-if00-port0",
    "vid": "10C4",
    "pid": "EA60",
    "serial_number": "3c0ed67c628beb11b1cd64a0f320645d",
    "manufacturer": "Nabu Casa",
    "description": "Connect ZBT-1 v1.0",
}
...
async def test_setup_zha_multipan(
    ...
    assert config_entry.options == {}
    assert config_entry.title == "Connect ZBT-1 Multiprotocol"
...
async def test_setup_zha_multipan_other_device(
    ...
    addon_info.return_value["options"]["device"] = "/dev/not_our_connect_zbt1"
