"""Test the Home Assistant Connect ZBT-1 config flow."""
...
from homeassistant.components import homeassistant_connect_zbt1, usb
from homeassistant.components.homeassistant_connect_zbt1.const import DOMAIN
...
async def test_config_flow(hass: HomeAssistant) -> None:
    ...
    with patch(
        "homeassistant.components.homeassistant_connect_zbt1.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
async def test_config_flow_update_device(hass: HomeAssistant) -> None:
    ...
    with (
        ...
        patch(
            "homeassistant.components.homeassistant_connect_zbt1.async_unload_entry",
            wraps=homeassistant_connect_zbt1.async_unload_entry,
