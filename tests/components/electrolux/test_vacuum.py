...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {},
            SERVICE_SET_FAN_SPEED,
            {ATTR_FAN_SPEED: "Max power"},
            [{"vacuumMode": "maxPower"}],
        ),
        # cybele RVC command tests
        (
            "cybele_vacuum",
            "vacuum.cybele_vacuum_rvc",
            {},
            SERVICE_START,
            {},
            [{"cleaningCommand": "startGlobalClean"}],
        ...
        (
            ...
            SERVICE_SEND_COMMAND,
            {
                ATTR_COMMAND: "clean_cybele_rooms",
                ATTR_PARAMS: {
        ...
        (
            ...
            SERVICE_SEND_COMMAND,
            {
                ATTR_COMMAND: "clean_gordias_rooms",
                ATTR_PARAMS: {
                    "map_id": "mocked-map-id",
                },
            },
