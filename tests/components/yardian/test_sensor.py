...
async def test_diagnostic_sensors(
    ...
    for uid in ("yid123_zone_delay", "yid123_water_hammer_duration"):
...
async def test_rain_delay_sensor_handles_invalid_data(
    hass: HomeAssistant,
    mock_config_entry: MockConfigEntry,
