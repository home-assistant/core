"""Test the Anova Sous Vide Cooker config flow."""
...
async def test_form(hass):
    ...
    with patch(
        ...
        "homeassistant.components.anova_cooker.async_setup", return_value=True
    ) as mock_setup, patch(
        "homeassistant.components.anova_cooker.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
