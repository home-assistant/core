...
async def test_actuators(
    ...
    state = hass.states.get(f"number.{BED_NAME_LOWER}_sleepnumber_{BED_NAME_LOWER}_right_head_position")
    ...
    state = hass.states.get(f"number.{BED_NAME_LOWER}_sleepnumber_{BED_NAME_LOWER}_left_head_position")
    ...
    state = hass.states.get(f"number.{BED_NAME_LOWER}_sleepnumber_{BED_NAME_LOWER}_foot_position")
