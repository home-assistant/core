...
async def test_setup_component_with_one_custom_calendar(hass, mock_dav_client):
    ...
    config["custom_calendars"] = [
        {"name": "spencerOffice", "calendar": "Second", "search": "spencerOffice"}
    ]
    ...
    all_calendar_states = hass.states.async_entity_ids("calendar")
    assert len(all_calendar_states) == 1
    state = hass.states.get("calendar.second_spenceroffice")
    assert state.name == "spencerOffice"


@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(17, 45))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(17, 30))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(17, 00))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(19, 10))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(8, 30))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(12, 00))
...
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(20, 00))
...
async def _day_event_returned(hass, calendar, config, date_time):
    with patch("spencerassistant.util.dt.now", return_value=date_time):
        assert await async_setup_component(hass, "calendar", {"calendar": config})
        await hass.async_block_till_done()
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(21, 45))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(22, 15))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(22, 45))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(23, 15))
...
@pytest.mark.parametrize("set_tz", ["utc"], indirect=True)
@patch("spencerassistant.util.dt.now", return_value=_local_datetime(23, 37))
