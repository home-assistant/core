...
def test_get_media_from_mailbox(mock_http_client):
    ...
    msgtxt = "Message 6. Cras fermentum blandit fringilla."
...
def test_delete_from_mailbox(mock_http_client):
    """Get audio from mailbox."""
    msgtxt1 = "Message 6. Cras fermentum blandit fringilla."
    msgtxt2 = "Message 1. Vestibulum blandit nisi quis viverra fringilla."
