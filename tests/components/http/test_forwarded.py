...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "123.123.123.123:1234, 2.2.2.2, 1.1.1.1",
            "2.2.2.2",
        ),
        (
            ["127.0.0.0/24", "1.1.1.1"],
            "123.123.123.123,2.2.2.2:8080,1.1.1.1",
            "2.2.2.2",
        ),
        (["127.0.0.0/24"], "123.123.123.123, 2.2.2.2, 1.1.1.1", "1.1.1.1"),
        (["127.0.0.0/24"], "127.0.0.1:80", "127.0.0.1"),
        (["127.0.0.1", "1.1.1.1"], "123.123.123.123, 1.1.1.1:8080", "123.123.123.123"),
        (["127.0.0.1", "1.1.1.1"], "123.123.123.123, 2.2.2.2, 1.1.1.1", "2.2.2.2"),
        (["127.0.0.1"], "255.255.255.255:443", "255.255.255.255"),
    ],
)
