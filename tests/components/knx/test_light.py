...
async def test_light_simple(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state("light.test", ToggleState.OFF)
    # turn on light
    ...
    knx.assert_state("light.test", ToggleState.ON)
...
async def test_light_brightness(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state("light.test", ToggleState.ON, brightness=255)
    await knx.receive_write(test_brightness, (128,))
    knx.assert_state("light.test", ToggleState.ON, brightness=128)
...
async def test_light_color_temp_absolute(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state("light.test", ToggleState.ON, color_temp=250)
...
async def test_light_hs_color(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state("light.test", ToggleState.ON, brightness=255, hs_color=(240, 100))
    ...
    knx.assert_state("light.test", ToggleState.ON, brightness=255, hs_color=(240, 50))
    ...
    knx.assert_state("light.test", ToggleState.ON, brightness=255, hs_color=(330, 59))

    # change color and brightness from KNX
    await knx.receive_write(test_brightness, (0xB2,))
    knx.assert_state("light.test", ToggleState.ON, brightness=178, hs_color=(330, 59))
    await knx.receive_write(test_hue, (0x7D,))
    knx.assert_state("light.test", ToggleState.ON, brightness=178, hs_color=(176, 59))
    await knx.receive_write(test_sat, (0xD1,))
    knx.assert_state("light.test", ToggleState.ON, brightness=178, hs_color=(176, 82))
...
async def test_light_xyy_color(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=139, xy_color=(0.701, 0.299)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, xy_color=(0.701, 0.299)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, xy_color=(0.469, 0.247)
    )

    # change color and brightness from KNX
    await knx.receive_write(test_xyy, (0x85, 0x1E, 0x4F, 0x5C, 0x19, 0x03))
    knx.assert_state("light.test", ToggleState.ON, brightness=25, xy_color=(0.52, 0.31))
    # change brightness from KNX
    await knx.receive_write(test_xyy, (0x00, 0x00, 0x00, 0x00, 0x80, 0x01))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=128, xy_color=(0.52, 0.31)
    )
    # change color from KNX
    await knx.receive_write(test_xyy, (0x2E, 0x14, 0x40, 0x00, 0x00, 0x02))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=128, xy_color=(0.18, 0.25)
    )
...
async def test_light_xyy_color_with_brightness(
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, xy_color=(0.52, 0.31)
    )
    await knx.receive_write(test_brightness, (21,))
    knx.assert_state("light.test", ToggleState.ON, brightness=21, xy_color=(0.52, 0.31))
...
async def test_light_rgb_individual(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, rgb_color=(255, 0, 0)
    )
    ...
    await knx.assert_write(test_blue, (0,))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=200, rgb_color=(255, 0, 0)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=200, rgb_color=(255, 105, 180)
    )
    ...
    await knx.assert_write(test_blue, (0,))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=100, rgb_color=(255, 255, 0)
    )
    ...
    await knx.receive_write(test_blue, (0,))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=180, rgb_color=(0, 255, 0)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, rgb_color=(255, 255, 255)
    )
...
async def test_light_rgbw_individual(
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, rgbw_color=(255, 0, 0, 0)
    )
    ...
    await knx.assert_write(test_white, (0,))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=200, rgbw_color=(255, 0, 0, 0)
    )
    ...
    await knx.assert_write(test_white, (0,))
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=100, rgbw_color=(255, 255, 0, 0)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=180, rgbw_color=(0, 255, 0, 0)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=255, rgbw_color=(255, 255, 255, 255)
    )
...
async def test_light_rgbw_brightness(hass: HomeAssistant, knx: KNXTestKit) -> None:
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=240, rgbw_color=(255, 0, 0, 0)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=128, rgbw_color=(255, 0, 0, 0)
    )
    # # change color and brightness from HA
    await hass.services.async_call(
        "light",
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=128, rgbw_color=(200, 0, 0, 0)
    )
    # # from HA - only color
    await hass.services.async_call(
        "light",
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=128, rgbw_color=(20, 30, 40, 50)
    )
    ...
    knx.assert_state(
        "light.test", ToggleState.ON, brightness=50, rgbw_color=(100, 200, 55, 12)
    )
