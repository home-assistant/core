...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("temperature_delta", "°C", "°C", "°C", "temperature_delta", 13.050847, -10, 30),
        ("temperature_delta", "°F", "°F", "°F", "temperature_delta", 13.050847, -10, 30),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("temperature", "°C", 30),
        ("temperature", "°F", 30),
        ("temperature_delta", "°C", 30),
        ("temperature_delta", "°F", 30),
        ("volume", "m³", 30),
        ("volume", "ft³", 30),
        ("weight", "g", 30),
        ("weight", "oz", 30),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("measurement", "temperature_delta", "°C", "°C", "°C", "temperature_delta", "mean"),
        ("measurement", "temperature_delta", "°F", "°F", "°F", "temperature_delta", "mean"),
