...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("mass", "g", "g", "g", "temperature", 13.050847, -10, 30),
        ("mass", "oz", "oz", "g", "temperature", 13.050847, -10, 30),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (IMPERIAL_SYSTEM, "mass", "g", "g", "g", "mass", 1),
        (IMPERIAL_SYSTEM, "mass", "oz", "oz", "g", "mass", 1),
        ...
        (METRIC_SYSTEM, "mass", "g", "g", "g", "mass", 1),
        (METRIC_SYSTEM, "mass", "oz", "oz", "g", "mass", 1),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("measurement", "mass", "g", "g", "g", "mass", "mean"),
        ("measurement", "mass", "oz", "oz", "g", "mass", "mean"),
        ("total", "mass", "g", "g", "g", "mass", "sum"),
        ("total", "mass", "oz", "oz", "g", "mass", "sum"),
