...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("pressure", "Pa", "hPa", 0.13050847, -0.1, 0.3),
        ("pressure", "hPa", "hPa", 13.050847, -10, 30),
        ("pressure", "mbar", "hPa", 13.050847, -10, 30),
        ("pressure", "inHg", "hPa", 441.9525, -338.6389, 1015.9167),
        ("pressure", "psi", "hPa", 899.8242, -689.4757, 2068.4271),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("pressure", "hPa", 30),
        ("pressure", "mbar", 30),
        ("pressure", "inHg", 1015.9167),
        ("pressure", "psi", 2068.4271),
        ("temperature", "°C", 30),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("gas", "m³", "m³", "sum"),
        ("gas", "ft³", "m³", "sum"),
        ("pressure", "Pa", "hPa", "mean"),
        ("pressure", "hPa", "hPa", "mean"),
        ("pressure", "mbar", "hPa", "mean"),
        ("pressure", "inHg", "hPa", "mean"),
        ("pressure", "psi", "hPa", "mean"),
