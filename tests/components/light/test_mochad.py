...
class TestMochadLight(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.light = mochad.MochadLight(self.hass, controller_mock,
                                        dev_dict)
        self.light.send_cmd = mock.MagicMock()
    ...
    def test_turn_on_with_no_brightness(self):
        """Test turn_on."""
        self.light.turn_on()
        self.light.send_cmd.assert_called_once_with('on')

    def test_turn_on_with_brightness(self):
        """Test turn_on."""
        self.light.turn_on(brightness=45)
        self.light.send_cmd.assert_has_calls(
            [mock.call('on'), mock.call('dim 25')])

    def test_turn_off(self):
        """Test turn_off."""
        self.light.turn_off()
        self.light.send_cmd.assert_called_once_with('off')
...
class TestMochadLight256Levels(unittest.TestCase):
    ...
    def test_turn_on_with_no_brightness(self):
        """Test turn_on."""
        self.light.turn_on()
        self.light.send_cmd.assert_called_once_with('xdim 255')

    def test_turn_on_with_brightness(self):
        """Test turn_on."""
        self.light.turn_on(brightness=45)
        self.light.send_cmd.assert_called_once_with('xdim 45')
...
class TestMochadLight64Levels(unittest.TestCase):
    ...
    def test_turn_on_with_no_brightness(self):
        """Test turn_on."""
        self.light.turn_on()
        self.light.send_cmd.assert_called_once_with('xdim 63')

    def test_turn_on_with_brightness(self):
        """Test turn_on."""
        self.light.turn_on(brightness=45)
        self.light.send_cmd.assert_called_once_with('xdim 11')
