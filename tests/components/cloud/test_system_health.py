...
async def test_cloud_system_health(
    ...
    assert info == {
        ...
        "remote_instance_domain": "my-home.ui.nabu.casa",
        "remote_alias": [],
        "alexa_enabled": True,
        "google_enabled": False,
        "cloud_ice_servers_enabled": True,
...
async def test_cloud_system_health_with_cert_and_disconnect(
    ...
    cloud.remote.instance_domain = "my-home.ui.nabu.casa"
    cloud.remote.alias = ["custom.example.com"]
    ...
    cloud.client.cloudhooks = {"hook1": {}, "hook2": {}}
    ...
    assert info["cloudhooks_count"] == 2
