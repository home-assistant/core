...
Q10_STATUS_DATA = {
    B01_Q10_DP.STATUS: YXDeviceState.STANDBY_STATE.code,
    B01_Q10_DP.BATTERY: 100,
    B01_Q10_DP.FAN_LEVEL: YXFanLevel.NORMAL.code,
    B01_Q10_DP.WATER_LEVEL: YXWaterLevel.MIDDLE.code,
    B01_Q10_DP.MAIN_BRUSH_LIFE: 5000,
