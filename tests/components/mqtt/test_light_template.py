...
async def test_state_change_via_topic(hass, mqtt_mock_entry):
...
async def test_flash(hass, mqtt_mock_entry):
...
async def test_entity_debug_info_message(hass, mqtt_mock_entry):
    ...
    await help_test_entity_debug_info_message(
        hass, mqtt_mock_entry, light.DOMAIN, config, light.SERVICE_TURN_ON
    )
