...
async def test_run_camera_setup(hass, hass_client_no_auth, mqtt_mock_entry):
...
async def test_run_camera_b64_encoded(hass, hass_client_no_auth, mqtt_mock_entry):
...
async def test_unique_id(hass, mqtt_mock_entry):
    ...
    await help_test_unique_id(hass, mqtt_mock_entry, camera.DOMAIN, config)


async def test_discovery_removal_camera(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_camera(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_unchanged_camera(hass, mqtt_mock_entry, caplog):
    """Test update of discovered camera."""
    ...
    with patch(
        ...
        await help_test_discovery_update_unchanged(
            hass, mqtt_mock_entry, caplog, camera.DOMAIN, data1, discovery_update
        )
