...
async def test_run_select_setup(hass, mqtt_mock_entry):
...
async def test_run_select_service_optimistic(hass, mqtt_mock_entry):
...
async def test_run_select_service(hass, mqtt_mock_entry):
...
async def test_run_select_service_with_command_template(hass, mqtt_mock_entry):
...
async def test_unique_id(hass, mqtt_mock_entry):
    ...
    await help_test_unique_id(hass, mqtt_mock_entry, select.DOMAIN, config)


async def test_discovery_removal_select(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_select(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_unchanged_select(hass, mqtt_mock_entry, caplog):
    """Test update of discovered select."""
    ...
    with patch(
        ...
        await help_test_discovery_update_unchanged(
            hass, mqtt_mock_entry, caplog, select.DOMAIN, data1, discovery_update
        )
...
async def test_options_attributes(hass, mqtt_mock_entry, options):
...
async def test_mqtt_payload_not_an_option_warning(hass, caplog, mqtt_mock_entry):
