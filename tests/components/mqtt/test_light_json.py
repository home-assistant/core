...
async def test_sending_mqtt_commands_and_optimistic(hass, mqtt_mock):
    ...
    mqtt_mock.async_publish.assert_has_calls([
        mock.call(
            'test_light_rgb/set',
            '{"state": "ON", "color": {"r": 0, "g": 123, "b": 255, "x": 0.14,'
            ' "y": 0.131, "h": 210.824, "s": 100.0}, "brightness": 50}',
            2, False),
        mock.call(
            'test_light_rgb/set',
            '{"state": "ON", "color": {"r": 255, "g": 56, "b": 59, "x": 0.654,'
            ' "y": 0.301, "h": 359.0, "s": 78.0}, "brightness": 50}',
            2, False),
        mock.call(
            'test_light_rgb/set',
            '{"state": "ON", "color": {"r": 255, "g": 128, "b": 0, "x": 0.611,'
            ' "y": 0.375, "h": 30.118, "s": 100.0}, "white_value": 80}',
            2, False),
    ], any_order=True)
