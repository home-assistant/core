...
async def test_fail_setup_if_color_mode_deprecated(hass, mqtt_mock_entry, deprecated):
...
async def test_fail_setup_if_color_modes_invalid(
    hass, mqtt_mock_entry, supported_color_modes
):
...
async def test_rgb_light(hass, mqtt_mock_entry):
...
async def test_controlling_state_via_topic2(hass, mqtt_mock_entry, caplog):
...
async def test_sending_mqtt_commands_and_optimistic2(hass, mqtt_mock_entry):
...
async def test_sending_hs_color(hass, mqtt_mock_entry):
...
async def test_sending_rgb_color_no_brightness(hass, mqtt_mock_entry):
...
async def test_sending_rgb_color_no_brightness2(hass, mqtt_mock_entry):
    """Test light.turn_on with hs color sends rgb color parameters."""
...
async def test_sending_rgb_color_with_brightness(hass, mqtt_mock_entry):
    """Test light.turn_on with hs color sends rgb color parameters."""
    assert await async_setup_component(
        hass,
        light.DOMAIN,
...
async def test_sending_rgb_color_with_scaled_brightness(hass, mqtt_mock_entry):
    """Test light.turn_on with hs color sends rgb color parameters."""
    assert await async_setup_component(
        hass,
        light.DOMAIN,
...
async def test_sending_xy_color(hass, mqtt_mock_entry):
...
async def test_effect(hass, mqtt_mock_entry):
...
async def test_flash_short_and_long(hass, mqtt_mock_entry):
...
async def test_transition(hass, mqtt_mock_entry):
...
async def test_brightness_scale(hass, mqtt_mock_entry):
...
async def test_invalid_values(hass, mqtt_mock_entry):
...
async def test_unique_id(hass, mqtt_mock_entry):
    ...
    await help_test_unique_id(hass, mqtt_mock_entry, light.DOMAIN, config)


async def test_discovery_removal(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_light(hass, mqtt_mock_entry, caplog):
...
async def test_discovery_update_unchanged_light(hass, mqtt_mock_entry, caplog):
    """Test update of discovered light."""
    data1 = (
        '{ "name": "Beer",'
        '  "schema": "json",'
    ...
    with patch(
        ...
        await help_test_discovery_update_unchanged(
            hass, mqtt_mock_entry, caplog, light.DOMAIN, data1, discovery_update
        )
...
async def test_max_mireds(hass, mqtt_mock_entry):
