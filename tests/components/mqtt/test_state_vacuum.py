...
async def test_all_commands(hass, mqtt_mock):
    ...
    await hass.services.async_call(
        DOMAIN, SERVICE_RETURN_TO_BASE, {"entity_id": "all"}, blocking=True
    )
    mqtt_mock.async_publish.assert_called_once_with(
