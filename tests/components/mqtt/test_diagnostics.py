...
async def test_entry_diagnostics(hass, device_reg, hass_client, mqtt_mock_entry):
...
async def test_redact_diagnostics(hass, device_reg, hass_client, mqtt_mock_entry):
