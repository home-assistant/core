...
async def test_select_update_doorbell_settings(
    ...
    new_nvr.model_fields["update_all_messages"] = Mock(final=False)
...
async def test_select_set_option_light_motion(
    ...
    light.model_fields["set_light_settings"] = Mock(final=False)
...
async def test_select_set_option_light_camera(
    ...
    light.model_fields["set_paired_camera"] = Mock(final=False)
...
async def test_select_set_option_camera_recording(
    ...
    doorbell.model_fields["set_recording_mode"] = Mock(final=False)
...
async def test_select_set_option_camera_ir(
    ...
    doorbell.model_fields["set_ir_led_model"] = Mock(final=False)
...
async def test_select_set_option_viewer(
    ...
    viewer.model_fields["set_liveview"] = Mock(final=False)
