...
async def test_media_player_set_volume(
    ...
    doorbell.model_fields["set_speaker_volume"] = Mock(final=False)
...
async def test_media_player_play(
    ...
    doorbell.model_fields["stop_audio"] = Mock(final=False)
    doorbell.model_fields["play_audio"] = Mock(final=False)
    doorbell.model_fields["wait_until_audio_completes"] = Mock(final=False)
