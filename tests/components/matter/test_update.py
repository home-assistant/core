...
async def test_update_entity(
    ...
    state = hass.states.get("update.mock_dimmable_light_firmware_north")
    assert state
...
async def test_update_check_service(
    ...
    await hass.services.async_call(
        ...
        SERVICE_UPDATE_ENTITY,
        {
            ATTR_ENTITY_ID: "update.mock_dimmable_light_firmware_north",
        },
        blocking=True,
    )
...
async def test_update_state_save_and_restore(
    ...
    assert state["entity_id"] == "update.mock_dimmable_light_firmware_north"
...
async def test_update_state_restore(
    ...
    mock_restore_cache_with_extra_data(
        ...
        (
            (
                State(
                    "update.mock_dimmable_light_firmware_north",
                    STATE_ON,
                    {
                        "auto_update": False,
