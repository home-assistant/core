...
async def test_owserver_connect_failure(hass):
    ...
    assert config_entry_owserver.state is EntryState.SETUP_RETRY
...
async def test_unload_entry(hass):
    ...
    assert config_entry_owserver.state is EntryState.LOADED
    assert config_entry_sysbus.state is EntryState.LOADED
    ...
    assert config_entry_owserver.state is EntryState.NOT_LOADED
    assert config_entry_sysbus.state is EntryState.NOT_LOADED
    assert not hass.data.get(DOMAIN)
