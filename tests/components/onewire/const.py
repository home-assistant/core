...
ATTR_STATE_CLONE = "raw_value_clone"
        ...
        Platform.SENSOR: [
            {
                ...
                ATTR_STATE_CLASS: SensorStateClass.MEASUREMENT,
                ATTR_STATE_CLONE: STATE_UNKNOWN,
        ...
        Platform.SENSOR: [
            {
                ...
                ATTR_INJECT_READS: [UnsupportResponseException] * 10,
                ATTR_STATE: STATE_UNKNOWN,
                ATTR_STATE_CLASS: SensorStateClass.MEASUREMENT,
