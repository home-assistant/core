...
async def test_media_player_join(
    ...
    # Mock the join method to set the event when called
    # This is needed as the join method is called in a different thread
    # and we need to wait for it to be called before firing the ZGS event
...
async def test_media_player_join_timeout(
    ...
    # Call the join service and do not block
    with (
        patch(
