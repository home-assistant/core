...
async def test_qnap_qsw_backup_error(hass: HomeAssistant) -> None:
    """Test error on backup creation."""
    ...
    with patch(
    ...
    ) as mock_firmware_update_live, pytest.raises(
        HomeAssistantError
    ):
        ...
        mock_system_config.assert_called_once()
