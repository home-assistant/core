...
from homeassistant.components.devolo_home_network.config_flow import (
    CannotConnect,
    InvalidAuth,
)
...
async def test_form(hass):
    ...
    with patch(
        "homeassistant.components.devolo_home_network.config_flow.PlaceholderHub.authenticate",
        return_value=True,
    ), patch(
