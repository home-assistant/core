...
async def test_sensors(hass):
    ...
    assert entry.unique_id == "Octoprint Job Percentage-uuid"
    ...
    assert entry.unique_id == "Octoprint Current State-uuid"
    ...
    assert entry.unique_id == "Octoprint actual tool1 temp-uuid"
    ...
    assert entry.unique_id == "Octoprint target tool1 temp-uuid"
    ...
    assert entry.unique_id == "Octoprint Start Time-uuid"
    ...
    assert entry.unique_id == "Octoprint Estimated Finish Time-uuid"
