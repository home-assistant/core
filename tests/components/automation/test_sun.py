...
async def test_sunset_trigger(hass, calls, patchable_time):
...
async def test_sunrise_trigger(hass, calls, patchable_time):
...
async def test_sunset_trigger_with_offset(hass, calls, patchable_time):
...
async def test_sunrise_trigger_with_offset(hass, calls, patchable_time):
