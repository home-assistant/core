...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("AirQualitySensor", "sensor.air_quality", "40", {ATTR_DEVICE_CLASS: ""}),
        ("AirQualitySensor", "sensor.air_quality_pm10", "10", {}),
        ("AirQualitySensor", "sensor.air_quality", "10", {ATTR_DEVICE_CLASS: "pm10"}),
        ("AirQualitySensor", "sensor.air_quality_pm25", "25", {}),
        ("AirQualitySensor", "sensor.air_quality", "25", {ATTR_DEVICE_CLASS: "pm25"}),
