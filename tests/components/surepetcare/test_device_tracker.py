...
async def test_device_tracker(
    ...
    expected_attributes = {
        "device_tracker.pet": {"since": "2020-08-23T23:10:50", "where": 1},
        "device_tracker.pet_outdoor": {"since": "2020-08-23T23:15:30", "where": 2},
        "device_tracker.pet_unknown": {"since": "2020-08-23T23:20:45", "where": -1},
    }
    ...
    for entity_id, unique_id in EXPECTED_ENTITY_IDS.items():
        ...
        assert state.attributes["where"] == expected_attrs["where"]
