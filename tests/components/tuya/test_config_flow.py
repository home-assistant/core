...
from homeassistant.components.tuya.const import (
    ...
    CONF_USERNAME,
    DOMAIN,
    TUYA_PROJECT_TYPE_INDUSTY_SOLUTIONS,
...
MOCK_COUNTRY_CODE = "1"
MOCK_APP_TYPE = "Smart Life"
MOCK_ENDPOINT = "Eastern America"

TUYA_SMART_HOME_PROJECT_DATA = {
    CONF_PROJECT_TYPE: TUYA_PROJECT_TYPE_SMART_HOME,
}
TUYA_INDUSTRY_PROJECT_DATA = {
    CONF_PROJECT_TYPE: TUYA_PROJECT_TYPE_INDUSTY_SOLUTIONS,
}
