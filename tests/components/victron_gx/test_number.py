...
async def test_victron_number_with_step(
    ...
    # MaxChargeVoltage has step=0.1, covering the _attr_native_step assignment
...
async def test_victron_number_actions(
    ...
    """Test number same-value skip and set_value service call."""
    victron_hub, mock_config_entry = init_integration
    ...
    # Call set_value service to cover set_native_value()
