...
async def test_climate(hass: HomeAssistant, snapshot: SnapshotAssertion) -> None:
    ...
    assert hass.states.get(entity_id) == snapshot(name="turn-on")
    ...
    with patch(
        ...
        mock_set.assert_called_once()
    assert hass.states.get(entity_id) == snapshot(name="set-temp")
    ...
    with patch(
        ...
        mock_set.assert_called_once()
    assert hass.states.get(entity_id) == snapshot(name="set-preset")
    ...
    with patch(
        ...
        mock_set.assert_called_once()
    assert hass.states.get(entity_id) == snapshot(name="turn-off")
