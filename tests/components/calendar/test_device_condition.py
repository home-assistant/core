"""The tests for Calendar device conditions."""
...
async def test_get_conditions(
    ...
    """Test we get the expected conditions from a calendar."""
...
async def test_if_state(hass: HomeAssistant, calls: list[ServiceCall]) -> None:
    ...
    hass.states.async_set("calendar.entity", STATE_ON)
    ...
    hass.states.async_set("calendar.entity", STATE_OFF)
    hass.bus.async_fire("test_event1")
    hass.bus.async_fire("test_event2")
    await hass.async_block_till_done()
    assert len(calls) == 2
