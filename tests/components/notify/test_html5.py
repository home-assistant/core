...
class TestHtml5Notify(object):
    ...
    @patch('pywebpush.WebPusher')
    def test_jwt_decode_found_target_in_loop(self, mock_wp):
        """Test finding a auth key by looping over registrations."""
        hass = MagicMock()
        ...
        with tempfile.NamedTemporaryFile() as fp:
            ...
            service.send_message('Hello', target=['unnamed device'],
                                 data={'icon': 'beer.png'})

            print("mock_wp.mock_calls", mock_wp.mock_calls)
