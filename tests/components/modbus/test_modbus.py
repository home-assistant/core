...
async def test_class_ModbusHub_logger(hass, caplog):
...
async def test_pb_create_exception(hass):
    """Run general test of class modbusHub."""
...
async def test_pb_connect(hass):
    """Run general test of class modbusHub."""
...
async def test_pb_read_coils(hass):
    ...
    with mock.patch(
        ...
        result = hub.read_coils(None, 17, 1)
        assert result.registers == data

        data = [0x15, 0x16]
        mock_pb.read_coils.return_value = ReadResult(data)
        result = hub.read_coils(None, 17, 2)
        assert result.registers == data
...
async def test_pb_read_discrete_inputs(hass):
    """Run test for pymodbus read_coils calls."""
    ...
    with mock.patch(
        ...
        result = hub.read_discrete_inputs(None, 17, 1)
        assert result.registers == data

        data = [0x15, 0x16]
        mock_pb.read_discrete_inputs.return_value = ReadResult(data)
        result = hub.read_discrete_inputs(None, 17, 2)
        assert result.registers == data
...
async def test_pb_read_input_registers(hass):
    ...
    with mock.patch(
        ...
        result = hub.read_input_registers(None, 17, 1)
        assert result.registers == data

        data = [0x15, 0x16]
        mock_pb.read_input_registers.return_value = ReadResult(data)
        result = hub.read_input_registers(None, 17, 2)
        assert result.registers == data
...
async def test_pb_read_holding_registers(hass):
    ...
    with mock.patch(
        ...
        result = hub.read_holding_registers(None, 17, 1)
        assert result.registers == data

        data = [0x15, 0x16]
        mock_pb.read_holding_registers.return_value = ReadResult(data)
        result = hub.read_holding_registers(None, 17, 2)
        assert result.registers == data
...
async def test_pb_write_coil(hass):
    ...
    with mock.patch(
        ...
        addr = 17
        data = 16
        assert hub.write_coil(None, addr, data)
        ...
        assert not hub.write_coil(None, addr, data)


async def test_pb_write_coils(hass):
    ...
    with mock.patch(
        ...
        addr = 17
        data = 16
        assert hub.write_coils(None, addr, data)
        ...
        assert not hub.write_coils(None, addr, data)


async def test_pb_write_register(hass):
    ...
    with mock.patch(
        ...
        addr = 17
        data = 16
        assert hub.write_register(None, addr, data)
        ...
        assert not hub.write_register(None, addr, data)


async def test_pb_write_registers(hass):
    ...
    with mock.patch(
        ...
        addr = 17
        data = 16
        assert hub.write_registers(None, addr, data)
        ...
        assert not hub.write_registers(None, addr, data)
