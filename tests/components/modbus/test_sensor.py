...
@pytest.mark.parametrize(
    ...
    [
        (
            {
                ...
                CONF_REGISTER_SIZE_BYTES: RegisterBytes.ONE,
            },
            1,
        ),
        (
            {
                CONF_DATA_TYPE: DataType.UINT16,
                CONF_REGISTER_SIZE_BYTES: RegisterBytes.TWO,
            },
            1,
        ),
        (
        ...
        (
            {
                CONF_DATA_TYPE: DataType.UINT32,
                CONF_REGISTER_SIZE_BYTES: RegisterBytes.FOUR,
            },
            1,
        ),
        (
        ...
        (
            {
                CONF_DATA_TYPE: DataType.FLOAT64,
                CONF_REGISTER_SIZE_BYTES: RegisterBytes.EIGHT,
            },
            1,
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "test entity: `register_size_bytes:RegisterBytes.TWO` cannot be combined with `data_type: DataType.STRING`",
        ),
    ],
)
