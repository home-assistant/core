...
_BUTTON_PRESSES: dict[LEDIrDeviceType, list[tuple[str, list[BaseGenericLEDCode]]]] = {
    LEDIrDeviceType.GENERIC_10_KEY: [
        ...
        ("brightness_down", [Generic10KeyCode.BRIGHTNESS_DOWN]),
        ("timer_2h", [Generic10KeyCode.TIMER_2H]),
        ("timer_4h", [Generic10KeyCode.TIMER_4H]),
        ("timer_6h", [Generic10KeyCode.TIMER_6H]),
        ("timer_8h", [Generic10KeyCode.TIMER_8H]),
    ],
    LEDIrDeviceType.GENERIC_13_KEY: [
