...
from . import EVENT_ENTITY_ID, LIGHT_ENTITY_ID
...
_RECEIVED_COMMANDS: dict[
    ...
    LEDIrDeviceType.GENERIC_10_KEY: [
        (Generic10KeyCode.BRIGHTNESS_UP, STATE_UNKNOWN, None),
        (Generic10KeyCode.BRIGHTNESS_DOWN, STATE_UNKNOWN, None),
        (Generic10KeyCode.TIMER_2H, STATE_UNKNOWN, None),
        (Generic10KeyCode.TIMER_4H, STATE_UNKNOWN, None),
        (Generic10KeyCode.TIMER_6H, STATE_UNKNOWN, None),
        (Generic10KeyCode.TIMER_8H, STATE_UNKNOWN, None),
        (Generic10KeyCode.ON, "on", None),
        (Generic10KeyCode.OFF, "off", None),
        (Generic10KeyCode.CANDLE, "on", "candle"),
        (Generic10KeyCode.LIGHT, "on", "light"),
    ],
    LEDIrDeviceType.GENERIC_13_KEY: [
