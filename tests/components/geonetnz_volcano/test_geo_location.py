...
from homeassistant.components.geonetnz_volcano.geo_location import (
    ATTR_ACTIVITY,
    ATTR_ALERT_LEVEL,
    ATTR_EXTERNAL_ID,
    ATTR_HAZARDS,
...
async def test_setup(hass):
    ...
    with patch("homeassistant.util.dt.utcnow", return_value=utcnow), patch(
        ...
        assert state.attributes == {
            ...
            ATTR_ACTIVITY: "Activity 1",
            ATTR_ALERT_LEVEL: "Alert Level 1",
            ATTR_HAZARDS: "Hazards 1",
            ATTR_UNIT_OF_MEASUREMENT: "km",
            ATTR_SOURCE: "geonetnz_volcano",
            ATTR_ICON: "mdi:mountain",
        }
