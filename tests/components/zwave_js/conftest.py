...
def qubino_shutter_state_firmware_14_2_0_fixture() -> dict[str, Any]:
    ...
    return load_json_object_fixture("cover_qubino_shutter_state_firmware_14_2_0.json", DOMAIN)
...
def qubino_shutter_firmware_14_2_0_cover_fixture(client, qubino_shutter_state_firmware_14_2_0) -> Node:
