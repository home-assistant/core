...
@pytest.fixture(name="multisensor_6_state")
...
@pytest.fixture(name="ecolink_door_sensor_state")
...
@pytest.fixture(name="hank_binary_switch_state")
...
@pytest.fixture(name="bulb_6_multi_color_state")
...
@pytest.fixture(name="light_color_null_values_state")
...
@pytest.fixture(name="eaton_rf9640_dimmer_state")
...
@pytest.fixture(name="lock_august_asl03_state")
...
@pytest.fixture(name="climate_adc_t3000_state")
...
@pytest.fixture(name="climate_airzone_aidoo_control_hvac_unit_state")
...
@pytest.fixture(name="climate_danfoss_lc_13_state")
...
@pytest.fixture(name="climate_eurotronic_spirit_z_state")
...
@pytest.fixture(name="climate_heatit_z_trm3_state")
...
@pytest.fixture(name="climate_heatit_z_trm2fx_state")
...
@pytest.fixture(name="climate_heatit_z_trm3_no_value_state")
...
@pytest.fixture(name="nortek_thermostat_state")
...
@pytest.fixture(name="srt321_hrt4_zw_state")
...
@pytest.fixture(name="chain_actuator_zws12_state")
...
@pytest.fixture(name="fan_generic_state")
...
@pytest.fixture(name="hs_fc200_state")
...
@pytest.fixture(name="leviton_zw4sf_state")
...
@pytest.fixture(name="iblinds_v2_state")
...
@pytest.fixture(name="iblinds_v3_state")
...
@pytest.fixture(name="qubino_shutter_state")
...
@pytest.fixture(name="aeotec_nano_shutter_state")
...
@pytest.fixture(name="fibaro_fgr222_shutter_state")
...
@pytest.fixture(name="merten_507801_state")
...
@pytest.fixture(name="aeon_smart_switch_6_state")
...
@pytest.fixture(name="ge_12730_state")
...
@pytest.fixture(name="aeotec_radiator_thermostat_state")
...
@pytest.fixture(name="inovelli_lzw36_state")
...
@pytest.fixture(name="null_name_check_state")
...
@pytest.fixture(name="lock_id_lock_as_id150_state")
...
@pytest.fixture(name="climate_radio_thermostat_ct101_multiple_temp_units_state")
...
@pytest.fixture(name="vision_security_zl7432_state")
...
@pytest.fixture(name="ge_in_wall_dimmer_switch_state")
...
@pytest.fixture(name="aeotec_zw164_siren_state")
...
@pytest.fixture(name="lock_popp_electric_strike_lock_control_state")
...
@pytest.fixture(name="fortrezz_ssa1_siren_state")
...
@pytest.fixture(name="fortrezz_ssa3_siren_state")
...
@pytest.fixture(name="zp3111_not_ready_state")
...
@pytest.fixture(name="zp3111_state")
...
@pytest.fixture(name="express_controls_ezmultipli_state")
...
@pytest.fixture(name="lock_home_connect_620_state")
...
@pytest.fixture(name="switch_zooz_zen72_state")
...
@pytest.fixture(name="indicator_test_state")
...
@pytest.fixture(name="energy_production_state")
...
@pytest.fixture(name="nice_ibt4zwave_state")
