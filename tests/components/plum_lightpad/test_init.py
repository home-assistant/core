...
async def test_async_setup_no_domain_config(hass):
...
async def test_async_setup_imports_from_config(hass):
...
async def test_async_setup_entry_sets_up_light(hass):
