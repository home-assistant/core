...
async def test_binary_sensors_without_corona_filter(
    ...
    state_w1 = hass.states.get("binary_sensor.aach_warning_1")
    ...
    state_w2 = hass.states.get("binary_sensor.aach_warning_2")

    assert state_w2.state == STATE_ON
    assert state_w2.attributes.get(ATTR_HEADLINE) == "Ausfall Notruf 112"

    state_w3 = hass.states.get("binary_sensor.aach_warning_3")

    assert state_w3.state == STATE_OFF  # Warning expired

    state_w4 = hass.states.get("binary_sensor.aach_warning_4")

    assert state_w4.state == STATE_OFF

    state_w5 = hass.states.get("binary_sensor.aach_warning_5")
