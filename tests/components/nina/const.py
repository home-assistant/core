...
DUMMY_OPTIONS_INPUT: dict[str, Any] = {
...
DUMMY_CONFIG_ENTRY_OPTIONS: dict[str, Any] = {
    CONF_MESSAGE_SLOTS: 5,
    CONF_FILTERS: {
        CONF_HEADLINE_FILTER: ".*corona.*",
        CONF_AREA_FILTER: ".*",
...
DUMMY_CONFIG_ENTRY_DEFAULT_FILTERS_OPTIONS: dict[str, Any] = {
    CONF_MESSAGE_SLOTS: 5,
    CONF_FILTERS: {
        CONF_HEADLINE_FILTER: "/(?!)/",
        CONF_AREA_FILTER: ".*",
...
DUMMY_CONFIG_ENTRY_AREA_FILTERS_OPTIONS: dict[str, Any] = {
    CONF_MESSAGE_SLOTS: 5,
    CONF_FILTERS: {
        CONF_HEADLINE_FILTER: "/(?!)/",
