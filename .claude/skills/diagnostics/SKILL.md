...
This skill covers implementing diagnostics data collection and repair issues.

## When to Use

- Adding diagnostic data collection to an integration
- Creating repair issues for user-actionable problems
- Implementing issue resolution flows
...
- `entity` - Entity categories for diagnostics
- `write-tests` - Testing diagnostic output
