...
Implement appropriate `async_step_*` method:
...
Use discovery to update dynamic IP addresses with the `updates` parameter.
...
Set `"connectable": true` for connection-required devices.
