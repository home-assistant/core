...
TODO = {
    ...
    "PyNINA": AwesomeVersion("0.3.4"),  # MIT
    ...
    "aioairq": AwesomeVersion("0.4.3"),  # Apache License, Version 2.0
    "aioaquacell": AwesomeVersion("0.2.0"),  # Apache License 2.0
    "aioeagle": AwesomeVersion("1.1.0"),  # Apache License 2.0
    "aioshelly": AwesomeVersion("12.1.0"),  # Apache License 2.0
    ...
    "freebox-api": AwesomeVersion("1.2.1"),  # GNU GPL v3
    "gpiod": AwesomeVersion("2.2.3"),  # LGPLv2.1
    "insteon-frontend-home-assistant": AwesomeVersion("0.5.0"),  # MIT License
    "knx_frontend": AwesomeVersion("2024.11.16.205004"),  # MIT License
    "lcn-frontend": AwesomeVersion("0.2.2"),  # MIT License
    ...
    "peblar": AwesomeVersion("0.2.1"),  # MIT License
