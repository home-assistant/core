...
from .const import CONF_CHAT_MODEL, CONF_PROVIDER, CONF_WEB_SEARCH, DOMAIN
...
class OpenRouterEntity(Entity):
    ...
    async def _async_handle_chat_log(
        ...
        # Get model with optional web search suffix
        model = self.model
        ...
        for _iteration in range(MAX_TOOL_ITERATIONS):
            try:
                ...
                _LOGGER.error("Error talking to API: %s", err)
