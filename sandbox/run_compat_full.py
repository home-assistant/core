"""Run the full sandbox_v2 compat sweep across every routable integration.
...
# Paths are relative to this script (sandbox_v2/run_compat_full.py).
...
# Mirrors homeassistant/components/sandbox_v2/const.py. Duplicated here
...
def write_report(
    ...
    *,
    ...
    lines: list[str] = [
        "# Sandbox v2 — full compat sweep (Phase 16)",
        "",
    ...
    lines.append("Per-failure tracebacks are dumped under "
                 "`${SANDBOX_V2_ERRORS_DIR:-/tmp/sandbox_v2_errors}/<integration>/`.")
    path.write_text("\n".join(lines) + "\n")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="Per-test error dump root (default: $SANDBOX_V2_ERRORS_DIR or /tmp/sandbox_v2_errors).",
    )
    parser.add_argument(
