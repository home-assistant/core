...
- Run `script/setup` to set up the virtual environment with all development dependencies (pylint, pre-commit hooks, etc.). This is required before committing, especially in worktrees where the venv starts minimal.
